...
/** Interface of <a href="http://schema.org/DrugClass">http://schema.org/DrugClass</a>. */
public interface DrugClass extends MedicalTherapy {

  /**
   * Builder interface of <a href="http://schema.org/DrugClass">http://schema.org/DrugClass</a>.
   */
  public interface Builder extends MedicalTherapy.Builder {
    ...
    /** Add a value to property drug. */
    Builder addDrug(Drug value);

    /** Add a value to property drug. */
    Builder addDrug(Drug.Builder value);

    /** Add a value to property drug. */
    Builder addDrug(String value);
    ...
    /** Build a {@link DrugClass} object. */
    DrugClass build();
  }

  /**
   * Returns the value list of property drug. Empty list is returned if the property not set in
   * current object.
   */
  ImmutableList<SchemaOrgType> getDrugList();
}
