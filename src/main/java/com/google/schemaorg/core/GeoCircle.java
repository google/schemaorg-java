...
/** Interface of <a href="http://schema.org/GeoCircle">http://schema.org/GeoCircle</a>. */
public interface GeoCircle extends GeoShape {

  /**
   * Builder interface of <a href="http://schema.org/GeoCircle">http://schema.org/GeoCircle</a>.
   */
  public interface Builder extends GeoShape.Builder {
    ...
    /** Add a value to property geoMidpoint. */
    Builder addGeoMidpoint(GeoCoordinates value);

    /** Add a value to property geoMidpoint. */
    Builder addGeoMidpoint(GeoCoordinates.Builder value);

    /** Add a value to property geoMidpoint. */
    Builder addGeoMidpoint(String value);

    /** Add a value to property geoRadius. */
    Builder addGeoRadius(Distance value);

    /** Add a value to property geoRadius. */
    Builder addGeoRadius(Distance.Builder value);

    /** Add a value to property geoRadius. */
    Builder addGeoRadius(Number value);

    /** Add a value to property geoRadius. */
    Builder addGeoRadius(Text value);

    /** Add a value to property geoRadius. */
    Builder addGeoRadius(String value);
    ...
    /** Build a {@link GeoCircle} object. */
    GeoCircle build();
  }

  /**
   * Returns the value list of property geoMidpoint. Empty list is returned if the property not set
   * in current object.
   */
  ImmutableList<SchemaOrgType> getGeoMidpointList();

  /**
   * Returns the value list of property geoRadius. Empty list is returned if the property not set in
   * current object.
   */
  ImmutableList<SchemaOrgType> getGeoRadiusList();
}
