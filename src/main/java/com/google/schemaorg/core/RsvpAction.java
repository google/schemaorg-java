...
/** Interface of <a href="http://schema.org/RsvpAction">http://schema.org/RsvpAction</a>. */
public interface RsvpAction extends InformAction {

  /**
   * Builder interface of <a href="http://schema.org/RsvpAction">http://schema.org/RsvpAction</a>.
   */
  public interface Builder extends InformAction.Builder {
    ...
    /** Add a value to property additionalNumberOfGuests. */
    Builder addAdditionalNumberOfGuests(Number value);

    /** Add a value to property additionalNumberOfGuests. */
    Builder addAdditionalNumberOfGuests(String value);
    ...
    /** Add a value to property language. */
    Builder addLanguage(Language value);

    /** Add a value to property language. */
    Builder addLanguage(Language.Builder value);

    /** Add a value to property language. */
    Builder addLanguage(String value);
    ...
    /** Add a value to property recipient. */
    Builder addRecipient(Audience value);

    /** Add a value to property recipient. */
    Builder addRecipient(Audience.Builder value);

    /** Add a value to property recipient. */
    Builder addRecipient(Organization value);

    /** Add a value to property recipient. */
    Builder addRecipient(Organization.Builder value);

    /** Add a value to property recipient. */
    Builder addRecipient(Person value);

    /** Add a value to property recipient. */
    Builder addRecipient(Person.Builder value);

    /** Add a value to property recipient. */
    Builder addRecipient(String value);
    ...
    /** Add a value to property rsvpResponse. */
    Builder addRsvpResponse(RsvpResponseType value);

    /** Add a value to property rsvpResponse. */
    Builder addRsvpResponse(String value);
    ...
    /** Build a {@link RsvpAction} object. */
    RsvpAction build();
  }

  /**
   * Returns the value list of property additionalNumberOfGuests. Empty list is returned if the
   * property not set in current object.
   */
  ImmutableList<SchemaOrgType> getAdditionalNumberOfGuestsList();
  ...
  /**
   * Returns the value list of property rsvpResponse. Empty list is returned if the property not set
   * in current object.
   */
  ImmutableList<SchemaOrgType> getRsvpResponseList();
}
