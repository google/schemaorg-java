...
/*
 * Enum values of <a href="http://schema.org/DrugCostCategory">http://schema.org/DrugCostCategory</a>.
 */
public enum DrugCostCategoryEnum implements DrugCostCategory {
  REIMBURSEMENT_CAP(CoreConstants.NAMESPACE + "ReimbursementCap"),

  RETAIL(CoreConstants.NAMESPACE + "Retail"),

  WHOLESALE(CoreConstants.NAMESPACE + "Wholesale");
  ...
  public String getFullTypeName() {
    return CoreConstants.TYPE_DRUG_COST_CATEGORY;
  }
