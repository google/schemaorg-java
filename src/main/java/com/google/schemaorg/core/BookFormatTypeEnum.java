...
/*
 * Enum values of <a href="http://schema.org/BookFormatType">http://schema.org/BookFormatType</a>.
 */
public enum BookFormatTypeEnum implements BookFormatType {
  E_BOOK(CoreConstants.NAMESPACE + "EBook"),

  HARDCOVER(CoreConstants.NAMESPACE + "Hardcover"),

  PAPERBACK(CoreConstants.NAMESPACE + "Paperback");
  ...
  public String getFullTypeName() {
    return CoreConstants.TYPE_BOOK_FORMAT_TYPE;
  }
