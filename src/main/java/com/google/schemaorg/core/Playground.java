...
/** Interface of <a href="http://schema.org/Playground">http://schema.org/Playground</a>. */
public interface Playground extends CivicStructure {

  /**
   * Builder interface of <a href="http://schema.org/Playground">http://schema.org/Playground</a>.
   */
  public interface Builder extends CivicStructure.Builder {
    ...
    /** Build a {@link Playground} object. */
    Playground build();
  }
}
