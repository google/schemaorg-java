...
public interface SocialMediaPosting extends Article {
  ...
  public interface Builder extends Article.Builder {
    ...
    /** Build a {@link SocialMediaPosting} object. */
    SocialMediaPosting build();
  }

  /**
   * Returns the value list of property sharedContent. Empty list is returned if the property not
   * set in current object.
   */
  ImmutableList<SchemaOrgType> getSharedContentList();
}
