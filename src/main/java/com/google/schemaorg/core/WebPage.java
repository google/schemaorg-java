...
/** Interface of <a href="http://schema.org/WebPage">http://schema.org/WebPage</a>. */
public interface WebPage extends CreativeWork {

  /** Builder interface of <a href="http://schema.org/WebPage">http://schema.org/WebPage</a>. */
  public interface Builder extends CreativeWork.Builder {
    ...
    /** Add a value to property relatedLink. */
    Builder addRelatedLink(URL value);

    /** Add a value to property relatedLink. */
    Builder addRelatedLink(String value);
    ...
    /** Build a {@link WebPage} object. */
    WebPage build();
  }

  /**
   * Returns the value list of property breadcrumb. Empty list is returned if the property not set
   * in current object.
   */
  ImmutableList<SchemaOrgType> getBreadcrumbList();

  /**
   * Returns the value list of property lastReviewed. Empty list is returned if the property not set
   * in current object.
   */
  ImmutableList<SchemaOrgType> getLastReviewedList();

  /**
   * Returns the value list of property mainContentOfPage. Empty list is returned if the property
   * not set in current object.
   */
  ImmutableList<SchemaOrgType> getMainContentOfPageList();

  /**
   * Returns the value list of property primaryImageOfPage. Empty list is returned if the property
   * not set in current object.
   */
  ImmutableList<SchemaOrgType> getPrimaryImageOfPageList();

  /**
   * Returns the value list of property relatedLink. Empty list is returned if the property not set
   * in current object.
   */
  ImmutableList<SchemaOrgType> getRelatedLinkList();

  /**
   * Returns the value list of property reviewedBy. Empty list is returned if the property not set
   * in current object.
   */
  ImmutableList<SchemaOrgType> getReviewedByList();

  /**
   * Returns the value list of property significantLink. Empty list is returned if the property not
   * set in current object.
   */
  ImmutableList<SchemaOrgType> getSignificantLinkList();

  /**
   * Returns the value list of property significantLinks. Empty list is returned if the property not
   * set in current object.
   */
  ImmutableList<SchemaOrgType> getSignificantLinksList();

  /**
   * Returns the value list of property specialty. Empty list is returned if the property not set in
   * current object.
   */
  ImmutableList<SchemaOrgType> getSpecialtyList();
}
