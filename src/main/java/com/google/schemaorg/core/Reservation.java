...
/** Interface of <a href="http://schema.org/Reservation">http://schema.org/Reservation</a>. */
public interface Reservation extends Intangible {

  /**
   * Builder interface of <a
   * href="http://schema.org/Reservation">http://schema.org/Reservation</a>.
   */
  public interface Builder extends Intangible.Builder {
    ...
    /** Build a {@link Reservation} object. */
    Reservation build();
  }

  /**
   * Returns the value list of property bookingAgent. Empty list is returned if the property not set
   * in current object.
   */
  ImmutableList<SchemaOrgType> getBookingAgentList();

  /**
   * Returns the value list of property bookingTime. Empty list is returned if the property not set
   * in current object.
   */
  ImmutableList<SchemaOrgType> getBookingTimeList();
  ...
  /**
   * Returns the value list of property modifiedTime. Empty list is returned if the property not set
   * in current object.
   */
  ImmutableList<SchemaOrgType> getModifiedTimeList();
  ...
  /**
   * Returns the value list of property programMembershipUsed. Empty list is returned if the
   * property not set in current object.
   */
  ImmutableList<SchemaOrgType> getProgramMembershipUsedList();
  ...
  /**
   * Returns the value list of property reservationFor. Empty list is returned if the property not
   * set in current object.
   */
  ImmutableList<SchemaOrgType> getReservationForList();

  /**
   * Returns the value list of property reservationId. Empty list is returned if the property not
   * set in current object.
   */
  ImmutableList<SchemaOrgType> getReservationIdList();

  /**
   * Returns the value list of property reservationStatus. Empty list is returned if the property
   * not set in current object.
   */
  ImmutableList<SchemaOrgType> getReservationStatusList();

  /**
   * Returns the value list of property reservedTicket. Empty list is returned if the property not
   * set in current object.
   */
  ImmutableList<SchemaOrgType> getReservedTicketList();
