...
public interface MedicalTherapy extends MedicalEntity {
  ...
  public interface Builder extends MedicalEntity.Builder {
    ...
    /** Build a {@link MedicalTherapy} object. */
    MedicalTherapy build();
  }
  ...
  /**
   * Returns the value list of property duplicateTherapy. Empty list is returned if the property not
   * set in current object.
   */
  ImmutableList<SchemaOrgType> getDuplicateTherapyList();
