...
public interface WebApplication extends SoftwareApplication {
  ...
  public interface Builder extends SoftwareApplication.Builder {
    ...
    /** Add a value to property browserRequirements. */
    Builder addBrowserRequirements(Text value);

    /** Add a value to property browserRequirements. */
    Builder addBrowserRequirements(String value);
    ...
    /** Build a {@link WebApplication} object. */
    WebApplication build();
  }

  /**
   * Returns the value list of property browserRequirements. Empty list is returned if the property
   * not set in current object.
   */
  ImmutableList<SchemaOrgType> getBrowserRequirementsList();
}
