...
/** Interface of <a href="http://schema.org/AutoRental">http://schema.org/AutoRental</a>. */
public interface AutoRental extends AutomotiveBusiness {

  /**
   * Builder interface of <a href="http://schema.org/AutoRental">http://schema.org/AutoRental</a>.
   */
  public interface Builder extends AutomotiveBusiness.Builder {
    ...
    /** Build a {@link AutoRental} object. */
    AutoRental build();
  }
}
