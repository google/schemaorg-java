...
/** Interface of <a href="http://schema.org/MusicRelease">http://schema.org/MusicRelease</a>. */
public interface MusicRelease extends MusicPlaylist {

  /**
   * Builder interface of <a
   * href="http://schema.org/MusicRelease">http://schema.org/MusicRelease</a>.
   */
  public interface Builder extends MusicPlaylist.Builder {
    ...
    /** Add a value to property catalogNumber. */
    Builder addCatalogNumber(Text value);

    /** Add a value to property catalogNumber. */
    Builder addCatalogNumber(String value);
    ...
    /** Add a value to property creditedTo. */
    Builder addCreditedTo(Organization value);

    /** Add a value to property creditedTo. */
    Builder addCreditedTo(Organization.Builder value);

    /** Add a value to property creditedTo. */
    Builder addCreditedTo(Person value);

    /** Add a value to property creditedTo. */
    Builder addCreditedTo(Person.Builder value);

    /** Add a value to property creditedTo. */
    Builder addCreditedTo(String value);
    ...
    /** Add a value to property musicReleaseFormat. */
    Builder addMusicReleaseFormat(MusicReleaseFormatType value);

    /** Add a value to property musicReleaseFormat. */
    Builder addMusicReleaseFormat(String value);
    ...
    /** Add a value to property numTracks. */
    Builder addNumTracks(Integer value);

    /** Add a value to property numTracks. */
    Builder addNumTracks(String value);
    ...
    /** Add a value to property recordLabel. */
    Builder addRecordLabel(Organization value);

    /** Add a value to property recordLabel. */
    Builder addRecordLabel(Organization.Builder value);

    /** Add a value to property recordLabel. */
    Builder addRecordLabel(String value);
    ...
    /** Add a value to property releaseOf. */
    Builder addReleaseOf(MusicAlbum value);

    /** Add a value to property releaseOf. */
    Builder addReleaseOf(MusicAlbum.Builder value);

    /** Add a value to property releaseOf. */
    Builder addReleaseOf(String value);
    ...
    /** Add a value to property track. */
    Builder addTrack(ItemList value);

    /** Add a value to property track. */
    Builder addTrack(ItemList.Builder value);

    /** Add a value to property track. */
    Builder addTrack(MusicRecording value);

    /** Add a value to property track. */
    Builder addTrack(MusicRecording.Builder value);

    /** Add a value to property track. */
    Builder addTrack(String value);

    /** Add a value to property tracks. */
    Builder addTracks(MusicRecording value);

    /** Add a value to property tracks. */
    Builder addTracks(MusicRecording.Builder value);

    /** Add a value to property tracks. */
    Builder addTracks(String value);
    ...
    /** Build a {@link MusicRelease} object. */
    MusicRelease build();
  }

  /**
   * Returns the value list of property catalogNumber. Empty list is returned if the property not
   * set in current object.
   */
  ImmutableList<SchemaOrgType> getCatalogNumberList();

  /**
   * Returns the value list of property creditedTo. Empty list is returned if the property not set
   * in current object.
   */
  ImmutableList<SchemaOrgType> getCreditedToList();
  ...
  /**
   * Returns the value list of property musicReleaseFormat. Empty list is returned if the property
   * not set in current object.
   */
  ImmutableList<SchemaOrgType> getMusicReleaseFormatList();

  /**
   * Returns the value list of property recordLabel. Empty list is returned if the property not set
   * in current object.
   */
  ImmutableList<SchemaOrgType> getRecordLabelList();

  /**
   * Returns the value list of property releaseOf. Empty list is returned if the property not set in
   * current object.
   */
  ImmutableList<SchemaOrgType> getReleaseOfList();
}
