...
/**
 * Interface of <a
 * href="http://schema.org/PlaceOrganizationCommon">http://schema.org/PlaceOrganizationCommon</a>.
 */
public interface PlaceOrganizationCommon extends Thing {
  ...
  public interface Builder extends Thing.Builder {
    ...
    /** Build a {@link PlaceOrganizationCommon} object. */
    PlaceOrganizationCommon build();
  }
  ...
  /**
   * Returns the value list of property events. Empty list is returned if the property not set in
   * current object.
   */
  ImmutableList<SchemaOrgType> getEventsList();
