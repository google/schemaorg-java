...
public interface MedicalTestPanel extends MedicalTest {
  ...
  public interface Builder extends MedicalTest.Builder {
    ...
    /** Add a value to property subTest. */
    Builder addSubTest(MedicalTest value);

    /** Add a value to property subTest. */
    Builder addSubTest(MedicalTest.Builder value);

    /** Add a value to property subTest. */
    Builder addSubTest(String value);
    ...
    /** Build a {@link MedicalTestPanel} object. */
    MedicalTestPanel build();
  }

  /**
   * Returns the value list of property subTest. Empty list is returned if the property not set in
   * current object.
   */
  ImmutableList<SchemaOrgType> getSubTestList();
}
