...
public interface GeoCoordinates extends StructuredValue {
  ...
  public interface Builder extends StructuredValue.Builder {
    ...
    /** Add a value to property latitude. */
    Builder addLatitude(Number value);

    /** Add a value to property latitude. */
    Builder addLatitude(Text value);

    /** Add a value to property latitude. */
    Builder addLatitude(String value);

    /** Add a value to property longitude. */
    Builder addLongitude(Number value);

    /** Add a value to property longitude. */
    Builder addLongitude(Text value);

    /** Add a value to property longitude. */
    Builder addLongitude(String value);
    ...
    /** Build a {@link GeoCoordinates} object. */
  ...
  /**
   * Returns the value list of property latitude. Empty list is returned if the property not set in
   * current object.
   */
  ImmutableList<SchemaOrgType> getLatitudeList();

  /**
   * Returns the value list of property longitude. Empty list is returned if the property not set in
   * current object.
   */
  ImmutableList<SchemaOrgType> getLongitudeList();
