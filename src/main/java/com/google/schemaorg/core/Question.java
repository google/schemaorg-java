...
public interface Question extends CreativeWork {
  ...
  public interface Builder extends CreativeWork.Builder {
    ...
    /** Add a value to property acceptedAnswer. */
    Builder addAcceptedAnswer(Answer value);

    /** Add a value to property acceptedAnswer. */
    Builder addAcceptedAnswer(Answer.Builder value);

    /** Add a value to property acceptedAnswer. */
    Builder addAcceptedAnswer(String value);
    ...
    /** Add a value to property answerCount. */
    Builder addAnswerCount(Integer value);

    /** Add a value to property answerCount. */
    Builder addAnswerCount(String value);
    ...
    /** Add a value to property downvoteCount. */
    Builder addDownvoteCount(Integer value);

    /** Add a value to property downvoteCount. */
    Builder addDownvoteCount(String value);
    ...
    /** Add a value to property suggestedAnswer. */
    Builder addSuggestedAnswer(Answer value);

    /** Add a value to property suggestedAnswer. */
    Builder addSuggestedAnswer(Answer.Builder value);

    /** Add a value to property suggestedAnswer. */
    Builder addSuggestedAnswer(String value);
    ...
    /** Add a value to property upvoteCount. */
    Builder addUpvoteCount(Integer value);

    /** Add a value to property upvoteCount. */
    Builder addUpvoteCount(String value);
    ...
    /** Build a {@link Question} object. */
    Question build();
  }

  /**
   * Returns the value list of property acceptedAnswer. Empty list is returned if the property not
   * set in current object.
   */
  ImmutableList<SchemaOrgType> getAcceptedAnswerList();

  /**
   * Returns the value list of property answerCount. Empty list is returned if the property not set
   * in current object.
   */
  ImmutableList<SchemaOrgType> getAnswerCountList();

  /**
   * Returns the value list of property downvoteCount. Empty list is returned if the property not
   * set in current object.
   */
  ImmutableList<SchemaOrgType> getDownvoteCountList();

  /**
   * Returns the value list of property suggestedAnswer. Empty list is returned if the property not
   * set in current object.
   */
  ImmutableList<SchemaOrgType> getSuggestedAnswerList();

  /**
   * Returns the value list of property upvoteCount. Empty list is returned if the property not set
   * in current object.
   */
  ImmutableList<SchemaOrgType> getUpvoteCountList();
}
