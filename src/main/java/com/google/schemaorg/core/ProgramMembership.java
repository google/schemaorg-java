...
public interface ProgramMembership extends Intangible {
  ...
  public interface Builder extends Intangible.Builder {
    ...
    /** Add a value to property hostingOrganization. */
    Builder addHostingOrganization(Organization value);

    /** Add a value to property hostingOrganization. */
    Builder addHostingOrganization(Organization.Builder value);

    /** Add a value to property hostingOrganization. */
    Builder addHostingOrganization(String value);
    ...
    /** Add a value to property membershipNumber. */
    Builder addMembershipNumber(Text value);

    /** Add a value to property membershipNumber. */
    Builder addMembershipNumber(String value);
    ...
    /** Add a value to property programName. */
    Builder addProgramName(Text value);

    /** Add a value to property programName. */
    Builder addProgramName(String value);
    ...
    /** Build a {@link ProgramMembership} object. */
    ProgramMembership build();
  }

  /**
   * Returns the value list of property hostingOrganization. Empty list is returned if the property
   * not set in current object.
   */
  ImmutableList<SchemaOrgType> getHostingOrganizationList();
  ...
  /**
   * Returns the value list of property membershipNumber. Empty list is returned if the property not
   * set in current object.
   */
  ImmutableList<SchemaOrgType> getMembershipNumberList();

  /**
   * Returns the value list of property programName. Empty list is returned if the property not set
   * in current object.
   */
  ImmutableList<SchemaOrgType> getProgramNameList();
}
