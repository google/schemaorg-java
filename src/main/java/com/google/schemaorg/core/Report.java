...
/** Interface of <a href="http://schema.org/Report">http://schema.org/Report</a>. */
public interface Report extends Article {

  /** Builder interface of <a href="http://schema.org/Report">http://schema.org/Report</a>. */
  public interface Builder extends Article.Builder {
    ...
    /** Add a value to property reportNumber. */
    Builder addReportNumber(Text value);

    /** Add a value to property reportNumber. */
    Builder addReportNumber(String value);
    ...
    /** Build a {@link Report} object. */
    Report build();
  }

  /**
   * Returns the value list of property reportNumber. Empty list is returned if the property not set
   * in current object.
   */
  ImmutableList<SchemaOrgType> getReportNumberList();
}
