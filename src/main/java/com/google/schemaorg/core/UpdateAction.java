...
/** Interface of <a href="http://schema.org/UpdateAction">http://schema.org/UpdateAction</a>. */
public interface UpdateAction extends Action {

  /**
   * Builder interface of <a
   * href="http://schema.org/UpdateAction">http://schema.org/UpdateAction</a>.
   */
  public interface Builder extends Action.Builder {
    ...
    /** Build a {@link UpdateAction} object. */
    UpdateAction build();
  }

  /**
   * Returns the value list of property collection. Empty list is returned if the property not set
   * in current object.
   */
  ImmutableList<SchemaOrgType> getCollectionList();

  /**
   * Returns the value list of property targetCollection. Empty list is returned if the property not
