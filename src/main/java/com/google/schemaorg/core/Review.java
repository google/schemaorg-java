...
/** Interface of <a href="http://schema.org/Review">http://schema.org/Review</a>. */
public interface Review extends CreativeWork {

  /** Builder interface of <a href="http://schema.org/Review">http://schema.org/Review</a>. */
  public interface Builder extends CreativeWork.Builder {
    ...
    /** Add a value to property itemReviewed. */
    Builder addItemReviewed(Thing value);

    /** Add a value to property itemReviewed. */
    Builder addItemReviewed(Thing.Builder value);

    /** Add a value to property itemReviewed. */
    Builder addItemReviewed(String value);
    ...
    /** Add a value to property reviewBody. */
    Builder addReviewBody(Text value);

    /** Add a value to property reviewBody. */
    Builder addReviewBody(String value);

    /** Add a value to property reviewRating. */
    Builder addReviewRating(Rating value);

    /** Add a value to property reviewRating. */
    Builder addReviewRating(Rating.Builder value);

    /** Add a value to property reviewRating. */
    Builder addReviewRating(String value);
    ...
    /** Build a {@link Review} object. */
    Review build();
  }

  /**
   * Returns the value list of property itemReviewed. Empty list is returned if the property not set
   * in current object.
   */
  ImmutableList<SchemaOrgType> getItemReviewedList();

  /**
   * Returns the value list of property reviewBody. Empty list is returned if the property not set
   * in current object.
   */
  ImmutableList<SchemaOrgType> getReviewBodyList();

  /**
   * Returns the value list of property reviewRating. Empty list is returned if the property not set
   * in current object.
   */
  ImmutableList<SchemaOrgType> getReviewRatingList();
}
