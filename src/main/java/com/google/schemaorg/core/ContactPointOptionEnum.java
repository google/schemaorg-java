...
/*
 * Enum values of <a href="http://schema.org/ContactPointOption">http://schema.org/ContactPointOption</a>.
 */
public enum ContactPointOptionEnum implements ContactPointOption {
  HEARING_IMPAIRED_SUPPORTED(CoreConstants.NAMESPACE + "HearingImpairedSupported"),

  TOLL_FREE(CoreConstants.NAMESPACE + "TollFree");
  ...
  public String getFullTypeName() {
    return CoreConstants.TYPE_CONTACT_POINT_OPTION;
  }
