...
public interface Vein extends Vessel {
  ...
  public interface Builder extends Vessel.Builder {
    ...
    /** Add a value to property drainsTo. */
    Builder addDrainsTo(Vessel value);

    /** Add a value to property drainsTo. */
    Builder addDrainsTo(Vessel.Builder value);

    /** Add a value to property drainsTo. */
    Builder addDrainsTo(String value);
    ...
    /** Add a value to property regionDrained. */
    Builder addRegionDrained(AnatomicalStructure value);

    /** Add a value to property regionDrained. */
    Builder addRegionDrained(AnatomicalStructure.Builder value);

    /** Add a value to property regionDrained. */
    Builder addRegionDrained(AnatomicalSystem value);

    /** Add a value to property regionDrained. */
    Builder addRegionDrained(AnatomicalSystem.Builder value);

    /** Add a value to property regionDrained. */
    Builder addRegionDrained(String value);
    ...
    /** Add a value to property tributary. */
    Builder addTributary(AnatomicalStructure value);

    /** Add a value to property tributary. */
    Builder addTributary(AnatomicalStructure.Builder value);

    /** Add a value to property tributary. */
    Builder addTributary(String value);
    ...
    /** Build a {@link Vein} object. */
    Vein build();
  }

  /**
   * Returns the value list of property drainsTo. Empty list is returned if the property not set in
   * current object.
   */
  ImmutableList<SchemaOrgType> getDrainsToList();

  /**
   * Returns the value list of property regionDrained. Empty list is returned if the property not
   * set in current object.
   */
  ImmutableList<SchemaOrgType> getRegionDrainedList();

  /**
   * Returns the value list of property tributary. Empty list is returned if the property not set in
   * current object.
   */
  ImmutableList<SchemaOrgType> getTributaryList();
}
