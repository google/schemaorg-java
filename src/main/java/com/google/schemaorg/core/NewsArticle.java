...
public interface NewsArticle extends Article {
  ...
  public interface Builder extends Article.Builder {
    ...
    /** Add a value to property dateline. */
    Builder addDateline(Text value);

    /** Add a value to property dateline. */
    Builder addDateline(String value);
    ...
    /** Add a value to property printColumn. */
    Builder addPrintColumn(Text value);

    /** Add a value to property printColumn. */
    Builder addPrintColumn(String value);

    /** Add a value to property printEdition. */
    Builder addPrintEdition(Text value);

    /** Add a value to property printEdition. */
    Builder addPrintEdition(String value);

    /** Add a value to property printPage. */
    Builder addPrintPage(Text value);

    /** Add a value to property printPage. */
    Builder addPrintPage(String value);

    /** Add a value to property printSection. */
    Builder addPrintSection(Text value);

    /** Add a value to property printSection. */
    Builder addPrintSection(String value);
    ...
    /** Build a {@link NewsArticle} object. */
    NewsArticle build();
  }

  /**
   * Returns the value list of property dateline. Empty list is returned if the property not set in
   * current object.
   */
  ImmutableList<SchemaOrgType> getDatelineList();

  /**
   * Returns the value list of property printColumn. Empty list is returned if the property not set
   * in current object.
   */
  ImmutableList<SchemaOrgType> getPrintColumnList();

  /**
   * Returns the value list of property printEdition. Empty list is returned if the property not set
   * in current object.
   */
  ImmutableList<SchemaOrgType> getPrintEditionList();

  /**
   * Returns the value list of property printPage. Empty list is returned if the property not set in
   * current object.
   */
  ImmutableList<SchemaOrgType> getPrintPageList();

  /**
   * Returns the value list of property printSection. Empty list is returned if the property not set
   * in current object.
   */
  ImmutableList<SchemaOrgType> getPrintSectionList();
}
