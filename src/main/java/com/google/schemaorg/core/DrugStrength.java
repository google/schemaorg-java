...
/** Interface of <a href="http://schema.org/DrugStrength">http://schema.org/DrugStrength</a>. */
public interface DrugStrength extends MedicalIntangible {

  /**
   * Builder interface of <a
   * href="http://schema.org/DrugStrength">http://schema.org/DrugStrength</a>.
   */
  public interface Builder extends MedicalIntangible.Builder {
    ...
    /** Add a value to property availableIn. */
    Builder addAvailableIn(AdministrativeArea value);

    /** Add a value to property availableIn. */
    Builder addAvailableIn(AdministrativeArea.Builder value);

    /** Add a value to property availableIn. */
    Builder addAvailableIn(String value);
    ...
    /** Add a value to property strengthUnit. */
    Builder addStrengthUnit(Text value);

    /** Add a value to property strengthUnit. */
    Builder addStrengthUnit(String value);

    /** Add a value to property strengthValue. */
    Builder addStrengthValue(Number value);

    /** Add a value to property strengthValue. */
    Builder addStrengthValue(String value);
    ...
    /** Build a {@link DrugStrength} object. */
    DrugStrength build();
  }
  ...
  /**
   * Returns the value list of property availableIn. Empty list is returned if the property not set
   * in current object.
   */
  ImmutableList<SchemaOrgType> getAvailableInList();

  /**
   * Returns the value list of property strengthUnit. Empty list is returned if the property not set
   * in current object.
   */
  ImmutableList<SchemaOrgType> getStrengthUnitList();

  /**
   * Returns the value list of property strengthValue. Empty list is returned if the property not
   * set in current object.
   */
  ImmutableList<SchemaOrgType> getStrengthValueList();
}
