...
/** Interface of <a href="http://schema.org/MedicalCause">http://schema.org/MedicalCause</a>. */
public interface MedicalCause extends MedicalEntity {

  /**
   * Builder interface of <a
   * href="http://schema.org/MedicalCause">http://schema.org/MedicalCause</a>.
   */
  public interface Builder extends MedicalEntity.Builder {
    ...
    /** Add a value to property causeOf. */
    Builder addCauseOf(MedicalEntity value);

    /** Add a value to property causeOf. */
    Builder addCauseOf(MedicalEntity.Builder value);

    /** Add a value to property causeOf. */
    Builder addCauseOf(String value);
    ...
    /** Build a {@link MedicalCause} object. */
    MedicalCause build();
  }

  /**
   * Returns the value list of property causeOf. Empty list is returned if the property not set in
   * current object.
   */
  ImmutableList<SchemaOrgType> getCauseOfList();
}
