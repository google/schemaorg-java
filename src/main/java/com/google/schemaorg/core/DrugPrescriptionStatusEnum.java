...
/*
 * Enum values of <a href="http://schema.org/DrugPrescriptionStatus">http://schema.org/DrugPrescriptionStatus</a>.
 */
public enum DrugPrescriptionStatusEnum implements DrugPrescriptionStatus {
  OTC(CoreConstants.NAMESPACE + "OTC"),

  PRESCRIPTION_ONLY(CoreConstants.NAMESPACE + "PrescriptionOnly");
  ...
  public String getFullTypeName() {
    return CoreConstants.TYPE_DRUG_PRESCRIPTION_STATUS;
  }
