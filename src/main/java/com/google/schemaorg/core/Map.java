...
/** Interface of <a href="http://schema.org/Map">http://schema.org/Map</a>. */
public interface Map extends CreativeWork {

  /** Builder interface of <a href="http://schema.org/Map">http://schema.org/Map</a>. */
  public interface Builder extends CreativeWork.Builder {
    ...
    /** Add a value to property mapType. */
    Builder addMapType(MapCategoryType value);

    /** Add a value to property mapType. */
    Builder addMapType(String value);
    ...
    /** Build a {@link Map} object. */
    Map build();
  }

  /**
   * Returns the value list of property mapType. Empty list is returned if the property not set in
   * current object.
   */
  ImmutableList<SchemaOrgType> getMapTypeList();
}
