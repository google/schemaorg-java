...
/*
 * Enum values of <a href="http://schema.org/GameServerStatus">http://schema.org/GameServerStatus</a>.
 */
public enum GameServerStatusEnum implements GameServerStatus {
  OFFLINE_PERMANENTLY(CoreConstants.NAMESPACE + "OfflinePermanently"),

  OFFLINE_TEMPORARILY(CoreConstants.NAMESPACE + "OfflineTemporarily"),

  ONLINE(CoreConstants.NAMESPACE + "Online"),

  ONLINE_FULL(CoreConstants.NAMESPACE + "OnlineFull");
  ...
  public String getFullTypeName() {
    return CoreConstants.TYPE_GAME_SERVER_STATUS;
  }
