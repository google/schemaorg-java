...
public interface VoteAction extends ChooseAction {
  ...
  public interface Builder extends ChooseAction.Builder {
    ...
    /** Add a value to property actionOption. */
    Builder addActionOption(Text value);

    /** Add a value to property actionOption. */
    Builder addActionOption(Thing value);

    /** Add a value to property actionOption. */
    Builder addActionOption(Thing.Builder value);

    /** Add a value to property actionOption. */
    Builder addActionOption(String value);
    ...
    /** Add a value to property candidate. */
    Builder addCandidate(Person value);

    /** Add a value to property candidate. */
    Builder addCandidate(Person.Builder value);

    /** Add a value to property candidate. */
    Builder addCandidate(String value);
    ...
    /** Add a value to property option. */
    Builder addOption(Text value);

    /** Add a value to property option. */
    Builder addOption(Thing value);

    /** Add a value to property option. */
    Builder addOption(Thing.Builder value);

    /** Add a value to property option. */
    Builder addOption(String value);
    ...
    /** Build a {@link VoteAction} object. */
    VoteAction build();
  }

  /**
   * Returns the value list of property candidate. Empty list is returned if the property not set in
   * current object.
   */
  ImmutableList<SchemaOrgType> getCandidateList();
}
