...
/*
 * Enum values of <a href="http://schema.org/MusicAlbumProductionType">http://schema.org/MusicAlbumProductionType</a>.
 */
public enum MusicAlbumProductionTypeEnum implements MusicAlbumProductionType {
  COMPILATION_ALBUM(CoreConstants.NAMESPACE + "CompilationAlbum"),

  DJ_MIX_ALBUM(CoreConstants.NAMESPACE + "DJMixAlbum"),

  DEMO_ALBUM(CoreConstants.NAMESPACE + "DemoAlbum"),

  LIVE_ALBUM(CoreConstants.NAMESPACE + "LiveAlbum"),

  MIXTAPE_ALBUM(CoreConstants.NAMESPACE + "MixtapeAlbum"),

  REMIX_ALBUM(CoreConstants.NAMESPACE + "RemixAlbum"),

  SOUNDTRACK_ALBUM(CoreConstants.NAMESPACE + "SoundtrackAlbum"),

  SPOKEN_WORD_ALBUM(CoreConstants.NAMESPACE + "SpokenWordAlbum"),

  STUDIO_ALBUM(CoreConstants.NAMESPACE + "StudioAlbum");
  ...
  public String getFullTypeName() {
    return CoreConstants.TYPE_MUSIC_ALBUM_PRODUCTION_TYPE;
  }
