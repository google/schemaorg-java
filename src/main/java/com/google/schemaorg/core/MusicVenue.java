...
/** Interface of <a href="http://schema.org/MusicVenue">http://schema.org/MusicVenue</a>. */
public interface MusicVenue extends CivicStructure {

  /**
   * Builder interface of <a href="http://schema.org/MusicVenue">http://schema.org/MusicVenue</a>.
   */
  public interface Builder extends CivicStructure.Builder {
    ...
    /** Build a {@link MusicVenue} object. */
    MusicVenue build();
  }
}
