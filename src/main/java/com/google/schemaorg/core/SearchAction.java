...
/** Interface of <a href="http://schema.org/SearchAction">http://schema.org/SearchAction</a>. */
public interface SearchAction extends Action {

  /**
   * Builder interface of <a
   * href="http://schema.org/SearchAction">http://schema.org/SearchAction</a>.
   */
  public interface Builder extends Action.Builder {
    ...
    /** Add a value to property query. */
    Builder addQuery(Text value);

    /** Add a value to property query. */
    Builder addQuery(String value);
    ...
    /** Build a {@link SearchAction} object. */
    SearchAction build();
  }

  /**
   * Returns the value list of property query. Empty list is returned if the property not set in
   * current object.
   */
  ImmutableList<SchemaOrgType> getQueryList();
}
