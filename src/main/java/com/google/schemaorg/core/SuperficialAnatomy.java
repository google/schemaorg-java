...
public interface SuperficialAnatomy extends MedicalEntity {
  ...
  public interface Builder extends MedicalEntity.Builder {
    ...
    /** Add a value to property relatedAnatomy. */
    Builder addRelatedAnatomy(AnatomicalStructure value);

    /** Add a value to property relatedAnatomy. */
    Builder addRelatedAnatomy(AnatomicalStructure.Builder value);

    /** Add a value to property relatedAnatomy. */
    Builder addRelatedAnatomy(AnatomicalSystem value);

    /** Add a value to property relatedAnatomy. */
    Builder addRelatedAnatomy(AnatomicalSystem.Builder value);

    /** Add a value to property relatedAnatomy. */
    Builder addRelatedAnatomy(String value);
    ...
    /** Add a value to property significance. */
    Builder addSignificance(Text value);

    /** Add a value to property significance. */
    Builder addSignificance(String value);
    ...
    /** Build a {@link SuperficialAnatomy} object. */
    SuperficialAnatomy build();
  }
  ...
  /**
   * Returns the value list of property relatedAnatomy. Empty list is returned if the property not
   * set in current object.
   */
  ImmutableList<SchemaOrgType> getRelatedAnatomyList();
  ...
  /**
   * Returns the value list of property significance. Empty list is returned if the property not set
   * in current object.
   */
  ImmutableList<SchemaOrgType> getSignificanceList();
}
