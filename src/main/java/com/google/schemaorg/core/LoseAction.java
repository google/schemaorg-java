...
public interface LoseAction extends AchieveAction {
  ...
  public interface Builder extends AchieveAction.Builder {
    ...
    /** Add a value to property winner. */
    Builder addWinner(Person value);

    /** Add a value to property winner. */
    Builder addWinner(Person.Builder value);

    /** Add a value to property winner. */
    Builder addWinner(String value);
    ...
    /** Build a {@link LoseAction} object. */
    LoseAction build();
  }

  /**
   * Returns the value list of property winner. Empty list is returned if the property not set in
   * current object.
   */
  ImmutableList<SchemaOrgType> getWinnerList();
}
