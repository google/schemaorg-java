...
/** Interface of <a href="http://schema.org/Nerve">http://schema.org/Nerve</a>. */
public interface Nerve extends AnatomicalStructure {

  /** Builder interface of <a href="http://schema.org/Nerve">http://schema.org/Nerve</a>. */
  public interface Builder extends AnatomicalStructure.Builder {
    ...
    /** Add a value to property branch. */
    Builder addBranch(AnatomicalStructure value);

    /** Add a value to property branch. */
    Builder addBranch(AnatomicalStructure.Builder value);

    /** Add a value to property branch. */
    Builder addBranch(String value);
    ...
    /** Add a value to property nerveMotor. */
    Builder addNerveMotor(Muscle value);

    /** Add a value to property nerveMotor. */
    Builder addNerveMotor(Muscle.Builder value);

    /** Add a value to property nerveMotor. */
    Builder addNerveMotor(String value);
    ...
    /** Add a value to property sensoryUnit. */
    Builder addSensoryUnit(AnatomicalStructure value);

    /** Add a value to property sensoryUnit. */
    Builder addSensoryUnit(AnatomicalStructure.Builder value);

    /** Add a value to property sensoryUnit. */
    Builder addSensoryUnit(SuperficialAnatomy value);

    /** Add a value to property sensoryUnit. */
    Builder addSensoryUnit(SuperficialAnatomy.Builder value);

    /** Add a value to property sensoryUnit. */
    Builder addSensoryUnit(String value);

    /** Add a value to property sourcedFrom. */
    Builder addSourcedFrom(BrainStructure value);

    /** Add a value to property sourcedFrom. */
    Builder addSourcedFrom(BrainStructure.Builder value);

    /** Add a value to property sourcedFrom. */
    Builder addSourcedFrom(String value);
    ...
    /** Build a {@link Nerve} object. */
    Nerve build();
  }

  /**
   * Returns the value list of property branch. Empty list is returned if the property not set in
   * current object.
   */
  ImmutableList<SchemaOrgType> getBranchList();

  /**
   * Returns the value list of property nerveMotor. Empty list is returned if the property not set
   * in current object.
   */
  ImmutableList<SchemaOrgType> getNerveMotorList();

  /**
   * Returns the value list of property sensoryUnit. Empty list is returned if the property not set
   * in current object.
   */
  ImmutableList<SchemaOrgType> getSensoryUnitList();

  /**
   * Returns the value list of property sourcedFrom. Empty list is returned if the property not set
   * in current object.
   */
  ImmutableList<SchemaOrgType> getSourcedFromList();
}
