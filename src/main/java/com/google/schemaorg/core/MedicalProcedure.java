...
/**
 * Interface of <a
 * href="http://schema.org/MedicalProcedure">http://schema.org/MedicalProcedure</a>.
 */
public interface MedicalProcedure extends MedicalEntity {
  ...
  public interface Builder extends MedicalEntity.Builder {
    ...
    /** Build a {@link MedicalProcedure} object. */
    MedicalProcedure build();
  }

  /**
   * Returns the value list of property followup. Empty list is returned if the property not set in
   * current object.
   */
  ImmutableList<SchemaOrgType> getFollowupList();

  /**
   * Returns the value list of property howPerformed. Empty list is returned if the property not set
   * in current object.
   */
  ImmutableList<SchemaOrgType> getHowPerformedList();

  /**
   * Returns the value list of property preparation. Empty list is returned if the property not set
   * in current object.
   */
  ImmutableList<SchemaOrgType> getPreparationList();

  /**
   * Returns the value list of property procedureType. Empty list is returned if the property not
   * set in current object.
   */
  ImmutableList<SchemaOrgType> getProcedureTypeList();
}
