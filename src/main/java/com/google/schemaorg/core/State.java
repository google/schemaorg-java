...
/** Interface of <a href="http://schema.org/State">http://schema.org/State</a>. */
public interface State extends AdministrativeArea {

  /** Builder interface of <a href="http://schema.org/State">http://schema.org/State</a>. */
