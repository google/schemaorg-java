...
/** Interface of <a href="http://schema.org/MedicalDevice">http://schema.org/MedicalDevice</a>. */
public interface MedicalDevice extends MedicalEntity {

  /**
   * Builder interface of <a
   * href="http://schema.org/MedicalDevice">http://schema.org/MedicalDevice</a>.
   */
  public interface Builder extends MedicalEntity.Builder {
    ...
    /** Add a value to property postOp. */
    Builder addPostOp(Text value);

    /** Add a value to property postOp. */
    Builder addPostOp(String value);
    ...
    /** Add a value to property preOp. */
    Builder addPreOp(Text value);

    /** Add a value to property preOp. */
    Builder addPreOp(String value);

    /** Add a value to property procedure. */
    Builder addProcedure(Text value);

    /** Add a value to property procedure. */
    Builder addProcedure(String value);
    ...
    /** Build a {@link MedicalDevice} object. */
    MedicalDevice build();
  }

  /**
   * Returns the value list of property adverseOutcome. Empty list is returned if the property not
   * set in current object.
   */
  ImmutableList<SchemaOrgType> getAdverseOutcomeList();

  /**
   * Returns the value list of property contraindication. Empty list is returned if the property not
   * set in current object.
   */
  ImmutableList<SchemaOrgType> getContraindicationList();

  /**
   * Returns the value list of property indication. Empty list is returned if the property not set
   * in current object.
   */
  ImmutableList<SchemaOrgType> getIndicationList();

  /**
   * Returns the value list of property postOp. Empty list is returned if the property not set in
   * current object.
   */
  ImmutableList<SchemaOrgType> getPostOpList();

  /**
   * Returns the value list of property preOp. Empty list is returned if the property not set in
   * current object.
   */
  ImmutableList<SchemaOrgType> getPreOpList();

  /**
   * Returns the value list of property procedure. Empty list is returned if the property not set in
   * current object.
   */
  ImmutableList<SchemaOrgType> getProcedureList();

  /**
   * Returns the value list of property purpose. Empty list is returned if the property not set in
   * current object.
   */
  ImmutableList<SchemaOrgType> getPurposeList();

  /**
   * Returns the value list of property seriousAdverseOutcome. Empty list is returned if the
   * property not set in current object.
   */
  ImmutableList<SchemaOrgType> getSeriousAdverseOutcomeList();
}
