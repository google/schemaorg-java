...
/** Interface of <a href="http://schema.org/ConsumeAction">http://schema.org/ConsumeAction</a>. */
public interface ConsumeAction extends Action {

  /**
   * Builder interface of <a
   * href="http://schema.org/ConsumeAction">http://schema.org/ConsumeAction</a>.
   */
  public interface Builder extends Action.Builder {
    ...
    /** Add a value to property expectsAcceptanceOf. */
    Builder addExpectsAcceptanceOf(Offer value);

    /** Add a value to property expectsAcceptanceOf. */
    Builder addExpectsAcceptanceOf(Offer.Builder value);

    /** Add a value to property expectsAcceptanceOf. */
    Builder addExpectsAcceptanceOf(String value);
    ...
    /** Build a {@link ConsumeAction} object. */
    ConsumeAction build();
  }

  /**
   * Returns the value list of property expectsAcceptanceOf. Empty list is returned if the property
   * not set in current object.
   */
  ImmutableList<SchemaOrgType> getExpectsAcceptanceOfList();
}
