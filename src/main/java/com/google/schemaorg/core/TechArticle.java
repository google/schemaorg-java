...
/** Interface of <a href="http://schema.org/TechArticle">http://schema.org/TechArticle</a>. */
public interface TechArticle extends Article {

  /**
   * Builder interface of <a
   * href="http://schema.org/TechArticle">http://schema.org/TechArticle</a>.
   */
  public interface Builder extends Article.Builder {
    ...
    /** Build a {@link TechArticle} object. */
    TechArticle build();
  }

  /**
   * Returns the value list of property dependencies. Empty list is returned if the property not set
   * in current object.
   */
  ImmutableList<SchemaOrgType> getDependenciesList();

  /**
   * Returns the value list of property proficiencyLevel. Empty list is returned if the property not
   * set in current object.
   */
  ImmutableList<SchemaOrgType> getProficiencyLevelList();
}
