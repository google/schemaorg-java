...
/**
 * Interface of <a
 * href="http://schema.org/MedicalRiskScore">http://schema.org/MedicalRiskScore</a>.
 */
public interface MedicalRiskScore extends MedicalRiskEstimator {
  ...
  public interface Builder extends MedicalRiskEstimator.Builder {
    ...
    /** Add a value to property algorithm. */
    Builder addAlgorithm(Text value);

    /** Add a value to property algorithm. */
    Builder addAlgorithm(String value);
    ...
    /** Build a {@link MedicalRiskScore} object. */
    MedicalRiskScore build();
  }

  /**
   * Returns the value list of property algorithm. Empty list is returned if the property not set in
   * current object.
   */
  ImmutableList<SchemaOrgType> getAlgorithmList();
}
