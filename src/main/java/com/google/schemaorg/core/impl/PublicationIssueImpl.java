...
/** Implementation of {@link PublicationIssue}. */
public class PublicationIssueImpl extends CreativeWorkImpl implements PublicationIssue {
  ...
  private static ImmutableSet<String> initializePropertySet() {
    ...
    builder.add(CoreConstants.PROPERTY_ISSUE_NUMBER);
  ...
  static final class BuilderImpl extends SchemaOrgTypeImpl.BuilderImpl<PublicationIssue.Builder>
    ...
    public PublicationIssue.Builder addIssueNumber(Integer value) {
      return addProperty(CoreConstants.PROPERTY_ISSUE_NUMBER, value);
    }
    ...
    public PublicationIssue.Builder addIssueNumber(String value) {
      return addProperty(CoreConstants.PROPERTY_ISSUE_NUMBER, Text.of(value));
    }
    ...
    public PublicationIssue build() {
      return new PublicationIssueImpl(properties, reverseMap);
    }
  }

  public PublicationIssueImpl(
  ...
  public String getFullTypeName() {
    return CoreConstants.TYPE_PUBLICATION_ISSUE;
  }
  ...
  public ImmutableList<SchemaOrgType> getIssueNumberList() {
    return getProperty(CoreConstants.PROPERTY_ISSUE_NUMBER);
  }
