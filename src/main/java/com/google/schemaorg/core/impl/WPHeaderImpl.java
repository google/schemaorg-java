...
/** Implementation of {@link WPHeader}. */
public class WPHeaderImpl extends WebPageElementImpl implements WPHeader {
  ...
  static final class BuilderImpl extends SchemaOrgTypeImpl.BuilderImpl<WPHeader.Builder>
    ...
    public WPHeader build() {
      return new WPHeaderImpl(properties, reverseMap);
    }
  }
  ...
  public String getFullTypeName() {
    return CoreConstants.TYPE_WP_HEADER;
  }
