...
public class CommentImpl extends CreativeWorkImpl implements Comment {
  ...
  private static ImmutableSet<String> initializePropertySet() {
    ...
    builder.add(CoreConstants.PROPERTY_PARENT_ITEM);
  ...
  static final class BuilderImpl extends SchemaOrgTypeImpl.BuilderImpl<Comment.Builder>
    ...
    public Comment.Builder addParentItem(Question value) {
      return addProperty(CoreConstants.PROPERTY_PARENT_ITEM, value);
    }

    @Override
    public Comment.Builder addParentItem(Question.Builder value) {
      return addProperty(CoreConstants.PROPERTY_PARENT_ITEM, value.build());
    }

    @Override
    public Comment.Builder addParentItem(String value) {
      return addProperty(CoreConstants.PROPERTY_PARENT_ITEM, Text.of(value));
    }
    ...
    public Comment build() {
      return new CommentImpl(properties, reverseMap);
    }
  }
  ...
  public String getFullTypeName() {
    return CoreConstants.TYPE_COMMENT;
  }
  ...
  public ImmutableList<SchemaOrgType> getParentItemList() {
    return getProperty(CoreConstants.PROPERTY_PARENT_ITEM);
  }
