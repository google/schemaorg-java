...
/** Implementation of {@link Season}. */
public class SeasonImpl extends CreativeWorkImpl implements Season {
  ...
  static final class BuilderImpl extends SchemaOrgTypeImpl.BuilderImpl<Season.Builder>
    ...
    @Override
    public Season build() {
      return new SeasonImpl(properties, reverseMap);
    }
  }
  ...
  public String getFullTypeName() {
    return CoreConstants.TYPE_SEASON;
  }
