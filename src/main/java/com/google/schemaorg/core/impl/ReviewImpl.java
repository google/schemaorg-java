...
/** Implementation of {@link Review}. */
public class ReviewImpl extends CreativeWorkImpl implements Review {
  ...
  private static ImmutableSet<String> initializePropertySet() {
    ...
    builder.add(CoreConstants.PROPERTY_REVIEW_BODY);

    builder.add(CoreConstants.PROPERTY_REVIEW_RATING);
  ...
  static final class BuilderImpl extends SchemaOrgTypeImpl.BuilderImpl<Review.Builder>
    ...
    public Review.Builder addReviewBody(Text value) {
      return addProperty(CoreConstants.PROPERTY_REVIEW_BODY, value);
    }

    @Override
    public Review.Builder addReviewBody(String value) {
      return addProperty(CoreConstants.PROPERTY_REVIEW_BODY, Text.of(value));
    }

    @Override
    public Review.Builder addReviewRating(Rating value) {
      return addProperty(CoreConstants.PROPERTY_REVIEW_RATING, value);
    }

    @Override
    public Review.Builder addReviewRating(Rating.Builder value) {
      return addProperty(CoreConstants.PROPERTY_REVIEW_RATING, value.build());
    }

    @Override
    public Review.Builder addReviewRating(String value) {
      return addProperty(CoreConstants.PROPERTY_REVIEW_RATING, Text.of(value));
    }
    ...
    @Override
    public Review build() {
      return new ReviewImpl(properties, reverseMap);
    }
  }
  ...
  public String getFullTypeName() {
    return CoreConstants.TYPE_REVIEW;
  }
  ...
  public ImmutableList<SchemaOrgType> getReviewBodyList() {
    return getProperty(CoreConstants.PROPERTY_REVIEW_BODY);
  }

  @Override
  public ImmutableList<SchemaOrgType> getReviewRatingList() {
    return getProperty(CoreConstants.PROPERTY_REVIEW_RATING);
  }
}
