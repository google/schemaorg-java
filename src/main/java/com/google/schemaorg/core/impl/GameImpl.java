...
public class GameImpl extends CreativeWorkImpl implements Game {
  ...
  static final class BuilderImpl extends SchemaOrgTypeImpl.BuilderImpl<Game.Builder>
    ...
    @Override
    public Game build() {
      return new GameImpl(properties, reverseMap);
    }
  }
  ...
  public String getFullTypeName() {
    return CoreConstants.TYPE_GAME;
  }
