...
/** Implementation of {@link Code}. */
public class CodeImpl extends CreativeWorkImpl implements Code {
  ...
  static final class BuilderImpl extends SchemaOrgTypeImpl.BuilderImpl<Code.Builder>
    ...
    @Override
    public Code build() {
      return new CodeImpl(properties, reverseMap);
    }
  }
  ...
  public String getFullTypeName() {
    return CoreConstants.TYPE_CODE;
  }
