...
/** Implementation of {@link PathologyTest}. */
public class PathologyTestImpl extends MedicalTestImpl implements PathologyTest {
  ...
  private static ImmutableSet<String> initializePropertySet() {
    ...
    builder.add(CoreConstants.PROPERTY_TISSUE_SAMPLE);
  ...
  static final class BuilderImpl extends SchemaOrgTypeImpl.BuilderImpl<PathologyTest.Builder>
    ...
    public PathologyTest.Builder addTissueSample(Text value) {
      return addProperty(CoreConstants.PROPERTY_TISSUE_SAMPLE, value);
    }

    @Override
    public PathologyTest.Builder addTissueSample(String value) {
      return addProperty(CoreConstants.PROPERTY_TISSUE_SAMPLE, Text.of(value));
    }
    ...
    public PathologyTest build() {
      return new PathologyTestImpl(properties, reverseMap);
    }
  }

  public PathologyTestImpl(
  ...
  public String getFullTypeName() {
    return CoreConstants.TYPE_PATHOLOGY_TEST;
  }
  ...
  public ImmutableList<SchemaOrgType> getTissueSampleList() {
    return getProperty(CoreConstants.PROPERTY_TISSUE_SAMPLE);
  }
}
