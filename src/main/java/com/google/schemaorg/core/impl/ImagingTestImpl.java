...
/** Implementation of {@link ImagingTest}. */
public class ImagingTestImpl extends MedicalTestImpl implements ImagingTest {
  ...
  private static ImmutableSet<String> initializePropertySet() {
    ...
    builder.add(CoreConstants.PROPERTY_IMAGING_TECHNIQUE);
  ...
  static final class BuilderImpl extends SchemaOrgTypeImpl.BuilderImpl<ImagingTest.Builder>
    ...
    public ImagingTest.Builder addImagingTechnique(MedicalImagingTechnique value) {
      return addProperty(CoreConstants.PROPERTY_IMAGING_TECHNIQUE, value);
    }

    @Override
    public ImagingTest.Builder addImagingTechnique(String value) {
      return addProperty(CoreConstants.PROPERTY_IMAGING_TECHNIQUE, Text.of(value));
    }
    ...
    public ImagingTest build() {
      return new ImagingTestImpl(properties, reverseMap);
    }
  }

  public ImagingTestImpl(
  ...
  public String getFullTypeName() {
    return CoreConstants.TYPE_IMAGING_TEST;
  }
  ...
  public ImmutableList<SchemaOrgType> getImagingTechniqueList() {
    return getProperty(CoreConstants.PROPERTY_IMAGING_TECHNIQUE);
  }
}
