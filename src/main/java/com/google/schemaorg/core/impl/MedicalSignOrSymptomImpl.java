...
/** Implementation of {@link MedicalSignOrSymptom}. */
public class MedicalSignOrSymptomImpl extends MedicalEntityImpl implements MedicalSignOrSymptom {
  ...
  static final class BuilderImpl extends SchemaOrgTypeImpl.BuilderImpl<MedicalSignOrSymptom.Builder>
    ...
    @Override
    public MedicalSignOrSymptom.Builder addPopularityScore(
    ...
    public MedicalSignOrSymptom build() {
      return new MedicalSignOrSymptomImpl(properties, reverseMap);
    }
  }

  public MedicalSignOrSymptomImpl(
  ...
  public String getFullTypeName() {
    return CoreConstants.TYPE_MEDICAL_SIGN_OR_SYMPTOM;
  }
