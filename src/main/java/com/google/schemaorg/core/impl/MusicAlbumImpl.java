...
/** Implementation of {@link MusicAlbum}. */
public class MusicAlbumImpl extends MusicPlaylistImpl implements MusicAlbum {
  ...
  private static ImmutableSet<String> initializePropertySet() {
    ...
    builder.add(CoreConstants.PROPERTY_ALBUM_PRODUCTION_TYPE);

    builder.add(CoreConstants.PROPERTY_ALBUM_RELEASE);

    builder.add(CoreConstants.PROPERTY_ALBUM_RELEASE_TYPE);
  ...
  static final class BuilderImpl extends SchemaOrgTypeImpl.BuilderImpl<MusicAlbum.Builder>
    ...
    public MusicAlbum.Builder addAlbumProductionType(MusicAlbumProductionType value) {
      return addProperty(CoreConstants.PROPERTY_ALBUM_PRODUCTION_TYPE, value);
    }

    @Override
    public MusicAlbum.Builder addAlbumProductionType(String value) {
      return addProperty(CoreConstants.PROPERTY_ALBUM_PRODUCTION_TYPE, Text.of(value));
    }

    @Override
    public MusicAlbum.Builder addAlbumRelease(MusicRelease value) {
      return addProperty(CoreConstants.PROPERTY_ALBUM_RELEASE, value);
    }

    @Override
    public MusicAlbum.Builder addAlbumRelease(MusicRelease.Builder value) {
      return addProperty(CoreConstants.PROPERTY_ALBUM_RELEASE, value.build());
    }

    @Override
    public MusicAlbum.Builder addAlbumRelease(String value) {
      return addProperty(CoreConstants.PROPERTY_ALBUM_RELEASE, Text.of(value));
    }

    @Override
    public MusicAlbum.Builder addAlbumReleaseType(MusicAlbumReleaseType value) {
      return addProperty(CoreConstants.PROPERTY_ALBUM_RELEASE_TYPE, value);
    }

    @Override
    public MusicAlbum.Builder addAlbumReleaseType(String value) {
      return addProperty(CoreConstants.PROPERTY_ALBUM_RELEASE_TYPE, Text.of(value));
    }
    ...
    public MusicAlbum build() {
      return new MusicAlbumImpl(properties, reverseMap);
    }
  }

  public MusicAlbumImpl(
  ...
  public String getFullTypeName() {
    return CoreConstants.TYPE_MUSIC_ALBUM;
  }
  ...
  public ImmutableList<SchemaOrgType> getAlbumProductionTypeList() {
    return getProperty(CoreConstants.PROPERTY_ALBUM_PRODUCTION_TYPE);
  }

  @Override
  public ImmutableList<SchemaOrgType> getAlbumReleaseList() {
    return getProperty(CoreConstants.PROPERTY_ALBUM_RELEASE);
  }

  @Override
  public ImmutableList<SchemaOrgType> getAlbumReleaseTypeList() {
    return getProperty(CoreConstants.PROPERTY_ALBUM_RELEASE_TYPE);
  }
