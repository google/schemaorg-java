...
public class DatasetImpl extends CreativeWorkImpl implements Dataset {
  ...
  static final class BuilderImpl extends SchemaOrgTypeImpl.BuilderImpl<Dataset.Builder>
    ...
    public Dataset build() {
      return new DatasetImpl(properties, reverseMap);
    }
  }
  ...
  public String getFullTypeName() {
    return CoreConstants.TYPE_DATASET;
  }
  ...
  public ImmutableList<SchemaOrgType> getCatalogList() {
    return getProperty(CoreConstants.PROPERTY_CATALOG);
  }

  @Override
  public ImmutableList<SchemaOrgType> getDatasetTimeIntervalList() {
    return getProperty(CoreConstants.PROPERTY_DATASET_TIME_INTERVAL);
  }

  @Override
  public ImmutableList<SchemaOrgType> getDistributionList() {
    return getProperty(CoreConstants.PROPERTY_DISTRIBUTION);
  }

  @Override
  public ImmutableList<SchemaOrgType> getIncludedDataCatalogList() {
    return getProperty(CoreConstants.PROPERTY_INCLUDED_DATA_CATALOG);
  }

  @Override
  public ImmutableList<SchemaOrgType> getSpatialList() {
    return getProperty(CoreConstants.PROPERTY_SPATIAL);
  }

  @Override
  public ImmutableList<SchemaOrgType> getTemporalList() {
    return getProperty(CoreConstants.PROPERTY_TEMPORAL);
  }
}
