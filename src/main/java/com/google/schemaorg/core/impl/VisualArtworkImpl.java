...
/** Implementation of {@link VisualArtwork}. */
public class VisualArtworkImpl extends CreativeWorkImpl implements VisualArtwork {
  ...
  private static ImmutableSet<String> initializePropertySet() {
    ...
    builder.add(CoreConstants.PROPERTY_ART_EDITION);

    builder.add(CoreConstants.PROPERTY_ARTFORM);

    builder.add(CoreConstants.PROPERTY_ART_MEDIUM);

    builder.add(CoreConstants.PROPERTY_ARTWORK_SURFACE);
    ...
    builder.add(CoreConstants.PROPERTY_MATERIAL);
    ...
    builder.add(CoreConstants.PROPERTY_SURFACE);
  ...
  static final class BuilderImpl extends SchemaOrgTypeImpl.BuilderImpl<VisualArtwork.Builder>
    ...
    public VisualArtwork.Builder addArtEdition(Integer value) {
      return addProperty(CoreConstants.PROPERTY_ART_EDITION, value);
    }
    ...
    public VisualArtwork.Builder addArtEdition(String value) {
      return addProperty(CoreConstants.PROPERTY_ART_EDITION, Text.of(value));
    }

    @Override
    public VisualArtwork.Builder addArtform(Text value) {
      return addProperty(CoreConstants.PROPERTY_ARTFORM, value);
    }
    ...
    public VisualArtwork.Builder addArtform(String value) {
      return addProperty(CoreConstants.PROPERTY_ARTFORM, Text.of(value));
    }

    @Override
    public VisualArtwork.Builder addArtMedium(Text value) {
      return addProperty(CoreConstants.PROPERTY_ART_MEDIUM, value);
    }
    ...
    public VisualArtwork.Builder addArtMedium(String value) {
      return addProperty(CoreConstants.PROPERTY_ART_MEDIUM, Text.of(value));
    }

    @Override
    public VisualArtwork.Builder addArtworkSurface(Text value) {
      return addProperty(CoreConstants.PROPERTY_ARTWORK_SURFACE, value);
    }
    ...
    public VisualArtwork.Builder addArtworkSurface(String value) {
      return addProperty(CoreConstants.PROPERTY_ARTWORK_SURFACE, Text.of(value));
    }
    ...
    public VisualArtwork.Builder addMaterial(Text value) {
      return addProperty(CoreConstants.PROPERTY_MATERIAL, value);
    }
    ...
    public VisualArtwork.Builder addMaterial(String value) {
      return addProperty(CoreConstants.PROPERTY_MATERIAL, Text.of(value));
    }
    ...
    public VisualArtwork.Builder addSurface(Text value) {
      return addProperty(CoreConstants.PROPERTY_SURFACE, value);
    }
    ...
    public VisualArtwork.Builder addSurface(String value) {
      return addProperty(CoreConstants.PROPERTY_SURFACE, Text.of(value));
    }
    ...
    public VisualArtwork build() {
      return new VisualArtworkImpl(properties, reverseMap);
    }
  }

  public VisualArtworkImpl(
  ...
  public String getFullTypeName() {
    return CoreConstants.TYPE_VISUAL_ARTWORK;
  }
  ...
  public ImmutableList<SchemaOrgType> getArtEditionList() {
    return getProperty(CoreConstants.PROPERTY_ART_EDITION);
  }

  @Override
  public ImmutableList<SchemaOrgType> getArtformList() {
    return getProperty(CoreConstants.PROPERTY_ARTFORM);
  }

  @Override
  public ImmutableList<SchemaOrgType> getArtMediumList() {
    return getProperty(CoreConstants.PROPERTY_ART_MEDIUM);
  }

  @Override
  public ImmutableList<SchemaOrgType> getArtworkSurfaceList() {
    return getProperty(CoreConstants.PROPERTY_ARTWORK_SURFACE);
  }
  ...
  public ImmutableList<SchemaOrgType> getMaterialList() {
    return getProperty(CoreConstants.PROPERTY_MATERIAL);
  }

  @Override
  public ImmutableList<SchemaOrgType> getSurfaceList() {
    return getProperty(CoreConstants.PROPERTY_SURFACE);
  }
