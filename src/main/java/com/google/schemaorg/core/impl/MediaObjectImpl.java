...
/** Implementation of {@link MediaObject}. */
public class MediaObjectImpl extends CreativeWorkImpl implements MediaObject {
  ...
  static final class BuilderImpl extends SchemaOrgTypeImpl.BuilderImpl<MediaObject.Builder>
  ...
  public String getFullTypeName() {
    return CoreConstants.TYPE_MEDIA_OBJECT;
  }
  ...
  public ImmutableList<SchemaOrgType> getAssociatedArticleList() {
    return getProperty(CoreConstants.PROPERTY_ASSOCIATED_ARTICLE);
  }

  @Override
  public ImmutableList<SchemaOrgType> getBitrateList() {
    return getProperty(CoreConstants.PROPERTY_BITRATE);
  }

  @Override
  public ImmutableList<SchemaOrgType> getContentSizeList() {
    return getProperty(CoreConstants.PROPERTY_CONTENT_SIZE);
  }

  @Override
  public ImmutableList<SchemaOrgType> getContentUrlList() {
    return getProperty(CoreConstants.PROPERTY_CONTENT_URL);
  }
  ...
  public ImmutableList<SchemaOrgType> getEmbedUrlList() {
    return getProperty(CoreConstants.PROPERTY_EMBED_URL);
  }

  @Override
  public ImmutableList<SchemaOrgType> getEncodesCreativeWorkList() {
    return getProperty(CoreConstants.PROPERTY_ENCODES_CREATIVE_WORK);
  }

  @Override
  public ImmutableList<SchemaOrgType> getEncodingFormatList() {
    return getProperty(CoreConstants.PROPERTY_ENCODING_FORMAT);
  }

  @Override
  public ImmutableList<SchemaOrgType> getExpiresList() {
    return getProperty(CoreConstants.PROPERTY_EXPIRES);
  }
  ...
  public ImmutableList<SchemaOrgType> getPlayerTypeList() {
    return getProperty(CoreConstants.PROPERTY_PLAYER_TYPE);
  }
  ...
  public ImmutableList<SchemaOrgType> getRegionsAllowedList() {
    return getProperty(CoreConstants.PROPERTY_REGIONS_ALLOWED);
  }

  @Override
  public ImmutableList<SchemaOrgType> getRequiresSubscriptionList() {
    return getProperty(CoreConstants.PROPERTY_REQUIRES_SUBSCRIPTION);
  }

  @Override
  public ImmutableList<SchemaOrgType> getUploadDateList() {
    return getProperty(CoreConstants.PROPERTY_UPLOAD_DATE);
  }
