...
public class TableImpl extends WebPageElementImpl implements Table {
  ...
  static final class BuilderImpl extends SchemaOrgTypeImpl.BuilderImpl<Table.Builder>
    ...
    @Override
    public Table build() {
      return new TableImpl(properties, reverseMap);
    }
  }
  ...
  public String getFullTypeName() {
    return CoreConstants.TYPE_TABLE;
  }
