...
public class AnswerImpl extends CommentImpl implements Answer {
  ...
  static final class BuilderImpl extends SchemaOrgTypeImpl.BuilderImpl<Answer.Builder>
    ...
    @Override
    public Answer build() {
      return new AnswerImpl(properties, reverseMap);
    }
  }
  ...
  public String getFullTypeName() {
    return CoreConstants.TYPE_ANSWER;
  }
