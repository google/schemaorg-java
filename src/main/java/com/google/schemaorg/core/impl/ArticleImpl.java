...
/** Implementation of {@link Article}. */
public class ArticleImpl extends CreativeWorkImpl implements Article {
  ...
  static final class BuilderImpl extends SchemaOrgTypeImpl.BuilderImpl<Article.Builder>
    ...
    public Article build() {
      return new ArticleImpl(properties, reverseMap);
    }
  }
  ...
  public String getFullTypeName() {
    return CoreConstants.TYPE_ARTICLE;
  }
  ...
  public ImmutableList<SchemaOrgType> getArticleBodyList() {
    return getProperty(CoreConstants.PROPERTY_ARTICLE_BODY);
  }

  @Override
  public ImmutableList<SchemaOrgType> getArticleSectionList() {
    return getProperty(CoreConstants.PROPERTY_ARTICLE_SECTION);
  }
  ...
  public ImmutableList<SchemaOrgType> getWordCountList() {
    return getProperty(CoreConstants.PROPERTY_WORD_COUNT);
  }
}
