...
/** Implementation of {@link Clip}. */
public class ClipImpl extends CreativeWorkImpl implements Clip {
  ...
  static final class BuilderImpl extends SchemaOrgTypeImpl.BuilderImpl<Clip.Builder>
    ...
    @Override
    public Clip build() {
      return new ClipImpl(properties, reverseMap);
    }
  }
  ...
  public String getFullTypeName() {
    return CoreConstants.TYPE_CLIP;
  }
  ...
  public ImmutableList<SchemaOrgType> getClipNumberList() {
    return getProperty(CoreConstants.PROPERTY_CLIP_NUMBER);
  }
  ...
  public ImmutableList<SchemaOrgType> getPartOfEpisodeList() {
    return getProperty(CoreConstants.PROPERTY_PART_OF_EPISODE);
  }
