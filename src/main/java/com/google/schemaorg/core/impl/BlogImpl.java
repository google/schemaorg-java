...
/** Implementation of {@link Blog}. */
public class BlogImpl extends CreativeWorkImpl implements Blog {
  ...
  private static ImmutableSet<String> initializePropertySet() {
    ...
    builder.add(CoreConstants.PROPERTY_BLOG_POST);

    builder.add(CoreConstants.PROPERTY_BLOG_POSTS);
  ...
  static final class BuilderImpl extends SchemaOrgTypeImpl.BuilderImpl<Blog.Builder>
    ...
    public Blog.Builder addBlogPost(BlogPosting value) {
      return addProperty(CoreConstants.PROPERTY_BLOG_POST, value);
    }

    @Override
    public Blog.Builder addBlogPost(BlogPosting.Builder value) {
      return addProperty(CoreConstants.PROPERTY_BLOG_POST, value.build());
    }

    @Override
    public Blog.Builder addBlogPost(String value) {
      return addProperty(CoreConstants.PROPERTY_BLOG_POST, Text.of(value));
    }

    @Override
    public Blog.Builder addBlogPosts(BlogPosting value) {
      return addProperty(CoreConstants.PROPERTY_BLOG_POSTS, value);
    }

    @Override
    public Blog.Builder addBlogPosts(BlogPosting.Builder value) {
      return addProperty(CoreConstants.PROPERTY_BLOG_POSTS, value.build());
    }

    @Override
    public Blog.Builder addBlogPosts(String value) {
      return addProperty(CoreConstants.PROPERTY_BLOG_POSTS, Text.of(value));
    }
    ...
    @Override
    public Blog build() {
      return new BlogImpl(properties, reverseMap);
    }
  }
  ...
  public String getFullTypeName() {
    return CoreConstants.TYPE_BLOG;
  }
  ...
  public ImmutableList<SchemaOrgType> getBlogPostList() {
    return getProperty(CoreConstants.PROPERTY_BLOG_POST);
  }

  @Override
  public ImmutableList<SchemaOrgType> getBlogPostsList() {
    return getProperty(CoreConstants.PROPERTY_BLOG_POSTS);
  }
}
