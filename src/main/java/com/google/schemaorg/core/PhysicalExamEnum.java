...
/*
 * Enum values of <a href="http://schema.org/PhysicalExam">http://schema.org/PhysicalExam</a>.
 */
public enum PhysicalExamEnum implements PhysicalExam {
  ABDOMEN(CoreConstants.NAMESPACE + "Abdomen"),

  APPEARANCE(CoreConstants.NAMESPACE + "Appearance"),

  CARDIOVASCULAR_EXAM(CoreConstants.NAMESPACE + "CardiovascularExam"),

  EAR(CoreConstants.NAMESPACE + "Ear"),

  EYE(CoreConstants.NAMESPACE + "Eye"),

  GENITOURINARY(CoreConstants.NAMESPACE + "Genitourinary"),

  HEAD(CoreConstants.NAMESPACE + "Head"),

  LUNG(CoreConstants.NAMESPACE + "Lung"),

  MUSCULOSKELETAL_EXAM(CoreConstants.NAMESPACE + "MusculoskeletalExam"),

  NECK(CoreConstants.NAMESPACE + "Neck"),

  NEURO(CoreConstants.NAMESPACE + "Neuro"),

  NOSE(CoreConstants.NAMESPACE + "Nose"),

  SKIN(CoreConstants.NAMESPACE + "Skin"),

  THROAT(CoreConstants.NAMESPACE + "Throat"),

  VITAL_SIGN(CoreConstants.NAMESPACE + "VitalSign");
  ...
  public String getFullTypeName() {
    return CoreConstants.TYPE_PHYSICAL_EXAM;
  }
