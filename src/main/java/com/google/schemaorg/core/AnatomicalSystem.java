...
/**
 * Interface of <a
 * href="http://schema.org/AnatomicalSystem">http://schema.org/AnatomicalSystem</a>.
 */
public interface AnatomicalSystem extends MedicalEntity {
  ...
  public interface Builder extends MedicalEntity.Builder {
    ...
    /** Add a value to property comprisedOf. */
    Builder addComprisedOf(AnatomicalStructure value);

    /** Add a value to property comprisedOf. */
    Builder addComprisedOf(AnatomicalStructure.Builder value);

    /** Add a value to property comprisedOf. */
    Builder addComprisedOf(AnatomicalSystem value);

    /** Add a value to property comprisedOf. */
    Builder addComprisedOf(AnatomicalSystem.Builder value);

    /** Add a value to property comprisedOf. */
    Builder addComprisedOf(String value);
    ...
    /** Add a value to property relatedStructure. */
    Builder addRelatedStructure(AnatomicalStructure value);

    /** Add a value to property relatedStructure. */
    Builder addRelatedStructure(AnatomicalStructure.Builder value);

    /** Add a value to property relatedStructure. */
    Builder addRelatedStructure(String value);
    ...
    /** Build a {@link AnatomicalSystem} object. */
    AnatomicalSystem build();
  }
  ...
  /**
   * Returns the value list of property comprisedOf. Empty list is returned if the property not set
   * in current object.
   */
  ImmutableList<SchemaOrgType> getComprisedOfList();
  ...
  /**
   * Returns the value list of property relatedStructure. Empty list is returned if the property not
   * set in current object.
   */
  ImmutableList<SchemaOrgType> getRelatedStructureList();
