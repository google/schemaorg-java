...
public interface Joint extends AnatomicalStructure {
  ...
  public interface Builder extends AnatomicalStructure.Builder {
    ...
    /** Add a value to property biomechnicalClass. */
    Builder addBiomechnicalClass(Text value);

    /** Add a value to property biomechnicalClass. */
    Builder addBiomechnicalClass(String value);
    ...
    /** Add a value to property functionalClass. */
    Builder addFunctionalClass(Text value);

    /** Add a value to property functionalClass. */
    Builder addFunctionalClass(String value);
    ...
    /** Add a value to property structuralClass. */
    Builder addStructuralClass(Text value);

    /** Add a value to property structuralClass. */
    Builder addStructuralClass(String value);
    ...
    /** Build a {@link Joint} object. */
    Joint build();
  }

  /**
   * Returns the value list of property biomechnicalClass. Empty list is returned if the property
   * not set in current object.
   */
  ImmutableList<SchemaOrgType> getBiomechnicalClassList();

  /**
   * Returns the value list of property functionalClass. Empty list is returned if the property not
   * set in current object.
   */
  ImmutableList<SchemaOrgType> getFunctionalClassList();

  /**
   * Returns the value list of property structuralClass. Empty list is returned if the property not
   * set in current object.
   */
  ImmutableList<SchemaOrgType> getStructuralClassList();
}
