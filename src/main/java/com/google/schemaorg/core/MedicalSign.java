...
public interface MedicalSign extends MedicalSignOrSymptom {
  ...
  public interface Builder extends MedicalSignOrSymptom.Builder {
    ...
    /** Add a value to property identifyingExam. */
    Builder addIdentifyingExam(PhysicalExam value);

    /** Add a value to property identifyingExam. */
    Builder addIdentifyingExam(String value);

    /** Add a value to property identifyingTest. */
    Builder addIdentifyingTest(MedicalTest value);

    /** Add a value to property identifyingTest. */
    Builder addIdentifyingTest(MedicalTest.Builder value);

    /** Add a value to property identifyingTest. */
    Builder addIdentifyingTest(String value);
    ...
    /** Build a {@link MedicalSign} object. */
    MedicalSign build();
  }

  /**
   * Returns the value list of property identifyingExam. Empty list is returned if the property not
   * set in current object.
   */
  ImmutableList<SchemaOrgType> getIdentifyingExamList();

  /**
   * Returns the value list of property identifyingTest. Empty list is returned if the property not
   * set in current object.
   */
  ImmutableList<SchemaOrgType> getIdentifyingTestList();
}
