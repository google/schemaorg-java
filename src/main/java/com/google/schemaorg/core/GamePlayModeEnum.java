...
/*
 * Enum values of <a href="http://schema.org/GamePlayMode">http://schema.org/GamePlayMode</a>.
 */
public enum GamePlayModeEnum implements GamePlayMode {
  CO_OP(CoreConstants.NAMESPACE + "CoOp"),

  MULTI_PLAYER(CoreConstants.NAMESPACE + "MultiPlayer"),

  SINGLE_PLAYER(CoreConstants.NAMESPACE + "SinglePlayer");
  ...
  public String getFullTypeName() {
    return CoreConstants.TYPE_GAME_PLAY_MODE;
  }
