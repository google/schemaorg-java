...
public interface Periodical extends CreativeWorkSeries {
  ...
  public interface Builder extends CreativeWorkSeries.Builder {
    ...
    /** Add a value to property issn. */
    Builder addIssn(Text value);

    /** Add a value to property issn. */
    Builder addIssn(String value);
    ...
    /** Build a {@link Periodical} object. */
    Periodical build();
  }

  /**
   * Returns the value list of property issn. Empty list is returned if the property not set in
   * current object.
   */
  ImmutableList<SchemaOrgType> getIssnList();
}
