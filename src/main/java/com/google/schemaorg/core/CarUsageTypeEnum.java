...
/*
 * Enum values of <a href="http://schema.org/CarUsageType">http://schema.org/CarUsageType</a>.
 */
public enum CarUsageTypeEnum implements CarUsageType {
  DRIVING_SCHOOL_VEHICLE_USAGE(CoreConstants.NAMESPACE + "DrivingSchoolVehicleUsage"),

  RENTAL_VEHICLE_USAGE(CoreConstants.NAMESPACE + "RentalVehicleUsage"),

  TAXI_VEHICLE_USAGE(CoreConstants.NAMESPACE + "TaxiVehicleUsage");
  ...
  public String getFullTypeName() {
    return CoreConstants.TYPE_CAR_USAGE_TYPE;
  }
