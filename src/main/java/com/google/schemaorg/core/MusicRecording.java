...
public interface MusicRecording extends CreativeWork {
  ...
  public interface Builder extends CreativeWork.Builder {
    ...
    /** Add a value to property inAlbum. */
    Builder addInAlbum(MusicAlbum value);

    /** Add a value to property inAlbum. */
    Builder addInAlbum(MusicAlbum.Builder value);

    /** Add a value to property inAlbum. */
    Builder addInAlbum(String value);
    ...
    /** Add a value to property inPlaylist. */
    Builder addInPlaylist(MusicPlaylist value);

    /** Add a value to property inPlaylist. */
    Builder addInPlaylist(MusicPlaylist.Builder value);

    /** Add a value to property inPlaylist. */
    Builder addInPlaylist(String value);
    ...
    /** Add a value to property isrcCode. */
    Builder addIsrcCode(Text value);

    /** Add a value to property isrcCode. */
    Builder addIsrcCode(String value);
    ...
    /** Add a value to property recordingOf. */
    Builder addRecordingOf(MusicComposition value);

    /** Add a value to property recordingOf. */
    Builder addRecordingOf(MusicComposition.Builder value);

    /** Add a value to property recordingOf. */
    Builder addRecordingOf(String value);
    ...
    /** Build a {@link MusicRecording} object. */
    MusicRecording build();
  }
  ...
  /**
   * Returns the value list of property inAlbum. Empty list is returned if the property not set in
   * current object.
   */
  ImmutableList<SchemaOrgType> getInAlbumList();

  /**
   * Returns the value list of property inPlaylist. Empty list is returned if the property not set
   * in current object.
   */
  ImmutableList<SchemaOrgType> getInPlaylistList();

  /**
   * Returns the value list of property isrcCode. Empty list is returned if the property not set in
   * current object.
   */
  ImmutableList<SchemaOrgType> getIsrcCodeList();

  /**
   * Returns the value list of property recordingOf. Empty list is returned if the property not set
   * in current object.
   */
  ImmutableList<SchemaOrgType> getRecordingOfList();
}
