...
/** Interface of <a href="http://schema.org/DataCatalog">http://schema.org/DataCatalog</a>. */
public interface DataCatalog extends CreativeWork {

  /**
   * Builder interface of <a
   * href="http://schema.org/DataCatalog">http://schema.org/DataCatalog</a>.
   */
  public interface Builder extends CreativeWork.Builder {
    ...
    /** Add a value to property dataset. */
    Builder addDataset(Dataset value);

    /** Add a value to property dataset. */
    Builder addDataset(Dataset.Builder value);

    /** Add a value to property dataset. */
    Builder addDataset(String value);
    ...
    /** Build a {@link DataCatalog} object. */
    DataCatalog build();
  }

  /**
   * Returns the value list of property dataset. Empty list is returned if the property not set in
   * current object.
   */
  ImmutableList<SchemaOrgType> getDatasetList();
}
