...
/*
 * Enum values of <a href="http://schema.org/MapCategoryType">http://schema.org/MapCategoryType</a>.
 */
public enum MapCategoryTypeEnum implements MapCategoryType {
  PARKING_MAP(CoreConstants.NAMESPACE + "ParkingMap"),

  SEATING_MAP(CoreConstants.NAMESPACE + "SeatingMap"),

  TRANSIT_MAP(CoreConstants.NAMESPACE + "TransitMap"),

  VENUE_MAP(CoreConstants.NAMESPACE + "VenueMap");
  ...
  public String getFullTypeName() {
    return CoreConstants.TYPE_MAP_CATEGORY_TYPE;
  }
