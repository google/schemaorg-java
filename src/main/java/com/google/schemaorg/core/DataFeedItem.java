...
public interface DataFeedItem extends Intangible {
  ...
  public interface Builder extends Intangible.Builder {
    ...
    /** Add a value to property dateDeleted. */
    Builder addDateDeleted(DateTime value);

    /** Add a value to property dateDeleted. */
    Builder addDateDeleted(String value);
    ...
    /** Build a {@link DataFeedItem} object. */
    DataFeedItem build();
  }
  ...
  /**
   * Returns the value list of property dateDeleted. Empty list is returned if the property not set
   * in current object.
   */
  ImmutableList<SchemaOrgType> getDateDeletedList();
