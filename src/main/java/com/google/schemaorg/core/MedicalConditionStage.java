...
/**
 * Interface of <a
 * href="http://schema.org/MedicalConditionStage">http://schema.org/MedicalConditionStage</a>.
 */
public interface MedicalConditionStage extends MedicalIntangible {
  ...
  public interface Builder extends MedicalIntangible.Builder {
    ...
    /** Add a value to property stageAsNumber. */
    Builder addStageAsNumber(Number value);

    /** Add a value to property stageAsNumber. */
    Builder addStageAsNumber(String value);
    ...
    /** Add a value to property subStageSuffix. */
    Builder addSubStageSuffix(Text value);

    /** Add a value to property subStageSuffix. */
    Builder addSubStageSuffix(String value);
    ...
    /** Build a {@link MedicalConditionStage} object. */
    MedicalConditionStage build();
  }

  /**
   * Returns the value list of property stageAsNumber. Empty list is returned if the property not
   * set in current object.
   */
  ImmutableList<SchemaOrgType> getStageAsNumberList();

  /**
   * Returns the value list of property subStageSuffix. Empty list is returned if the property not
   * set in current object.
   */
  ImmutableList<SchemaOrgType> getSubStageSuffixList();
}
