...
public interface EducationalAudience extends Audience {
  ...
  public interface Builder extends Audience.Builder {
    ...
    /** Add a value to property educationalRole. */
    Builder addEducationalRole(Text value);

    /** Add a value to property educationalRole. */
    Builder addEducationalRole(String value);
    ...
    /** Build a {@link EducationalAudience} object. */
    EducationalAudience build();
  }

  /**
   * Returns the value list of property educationalRole. Empty list is returned if the property not
   * set in current object.
   */
  ImmutableList<SchemaOrgType> getEducationalRoleList();
}
