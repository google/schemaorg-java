...
public interface Diet extends CreativeWork, LifestyleModification {
  ...
  public interface Builder extends CreativeWork.Builder, LifestyleModification.Builder {
    ...
    /** Add a value to property dietFeatures. */
    Builder addDietFeatures(Text value);

    /** Add a value to property dietFeatures. */
    Builder addDietFeatures(String value);
    ...
    /** Add a value to property endorsers. */
    Builder addEndorsers(Organization value);

    /** Add a value to property endorsers. */
    Builder addEndorsers(Organization.Builder value);

    /** Add a value to property endorsers. */
    Builder addEndorsers(Person value);

    /** Add a value to property endorsers. */
    Builder addEndorsers(Person.Builder value);

    /** Add a value to property endorsers. */
    Builder addEndorsers(String value);
    ...
    /** Add a value to property expertConsiderations. */
    Builder addExpertConsiderations(Text value);

    /** Add a value to property expertConsiderations. */
    Builder addExpertConsiderations(String value);
    ...
    /** Add a value to property overview. */
    Builder addOverview(Text value);

    /** Add a value to property overview. */
    Builder addOverview(String value);

    /** Add a value to property physiologicalBenefits. */
    Builder addPhysiologicalBenefits(Text value);

    /** Add a value to property physiologicalBenefits. */
    Builder addPhysiologicalBenefits(String value);
    ...
    /** Add a value to property proprietaryName. */
    Builder addProprietaryName(Text value);

    /** Add a value to property proprietaryName. */
    Builder addProprietaryName(String value);
    ...
    /** Add a value to property risks. */
    Builder addRisks(Text value);

    /** Add a value to property risks. */
    Builder addRisks(String value);
    ...
    /** Build a {@link Diet} object. */
    Diet build();
  }

  /**
   * Returns the value list of property dietFeatures. Empty list is returned if the property not set
   * in current object.
   */
  ImmutableList<SchemaOrgType> getDietFeaturesList();

  /**
   * Returns the value list of property endorsers. Empty list is returned if the property not set in
   * current object.
   */
  ImmutableList<SchemaOrgType> getEndorsersList();

  /**
   * Returns the value list of property expertConsiderations. Empty list is returned if the property
   * not set in current object.
   */
  ImmutableList<SchemaOrgType> getExpertConsiderationsList();

  /**
   * Returns the value list of property overview. Empty list is returned if the property not set in
   * current object.
   */
  ImmutableList<SchemaOrgType> getOverviewList();

  /**
   * Returns the value list of property physiologicalBenefits. Empty list is returned if the
   * property not set in current object.
   */
  ImmutableList<SchemaOrgType> getPhysiologicalBenefitsList();

  /**
   * Returns the value list of property proprietaryName. Empty list is returned if the property not
   * set in current object.
   */
  ImmutableList<SchemaOrgType> getProprietaryNameList();

  /**
   * Returns the value list of property risks. Empty list is returned if the property not set in
   * current object.
   */
  ImmutableList<SchemaOrgType> getRisksList();
}
