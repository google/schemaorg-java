...
/** Interface of <a href="http://schema.org/ReviewAction">http://schema.org/ReviewAction</a>. */
public interface ReviewAction extends AssessAction {

  /**
   * Builder interface of <a
   * href="http://schema.org/ReviewAction">http://schema.org/ReviewAction</a>.
   */
  public interface Builder extends AssessAction.Builder {
    ...
    /** Add a value to property resultReview. */
    Builder addResultReview(Review value);

    /** Add a value to property resultReview. */
    Builder addResultReview(Review.Builder value);

    /** Add a value to property resultReview. */
    Builder addResultReview(String value);
    ...
    /** Build a {@link ReviewAction} object. */
    ReviewAction build();
  }

  /**
   * Returns the value list of property resultReview. Empty list is returned if the property not set
   * in current object.
   */
  ImmutableList<SchemaOrgType> getResultReviewList();
}
