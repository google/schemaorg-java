...
public interface LymphaticVessel extends Vessel {
  ...
  public interface Builder extends Vessel.Builder {
    ...
    /** Add a value to property originatesFrom. */
    Builder addOriginatesFrom(Vessel value);

    /** Add a value to property originatesFrom. */
    Builder addOriginatesFrom(Vessel.Builder value);

    /** Add a value to property originatesFrom. */
    Builder addOriginatesFrom(String value);
    ...
    /** Add a value to property runsTo. */
    Builder addRunsTo(Vessel value);

    /** Add a value to property runsTo. */
    Builder addRunsTo(Vessel.Builder value);

    /** Add a value to property runsTo. */
    Builder addRunsTo(String value);
    ...
    /** Build a {@link LymphaticVessel} object. */
    LymphaticVessel build();
  }

  /**
   * Returns the value list of property originatesFrom. Empty list is returned if the property not
  ...
  /**
   * Returns the value list of property runsTo. Empty list is returned if the property not set in
   * current object.
   */
  ImmutableList<SchemaOrgType> getRunsToList();
}
