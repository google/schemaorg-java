...
/** Interface of <a href="http://schema.org/SellAction">http://schema.org/SellAction</a>. */
public interface SellAction extends TradeAction {

  /**
   * Builder interface of <a href="http://schema.org/SellAction">http://schema.org/SellAction</a>.
   */
  public interface Builder extends TradeAction.Builder {
    ...
    /** Add a value to property buyer. */
    Builder addBuyer(Person value);

    /** Add a value to property buyer. */
    Builder addBuyer(Person.Builder value);

    /** Add a value to property buyer. */
    Builder addBuyer(String value);
    ...
    /** Build a {@link SellAction} object. */
    SellAction build();
  }

  /**
   * Returns the value list of property buyer. Empty list is returned if the property not set in
   * current object.
   */
  ImmutableList<SchemaOrgType> getBuyerList();
