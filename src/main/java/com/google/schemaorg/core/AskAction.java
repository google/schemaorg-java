...
/** Interface of <a href="http://schema.org/AskAction">http://schema.org/AskAction</a>. */
public interface AskAction extends CommunicateAction {

  /**
   * Builder interface of <a href="http://schema.org/AskAction">http://schema.org/AskAction</a>.
   */
  public interface Builder extends CommunicateAction.Builder {
    ...
    /** Add a value to property question. */
    Builder addQuestion(Question value);

    /** Add a value to property question. */
    Builder addQuestion(Question.Builder value);

    /** Add a value to property question. */
    Builder addQuestion(String value);
    ...
    /** Build a {@link AskAction} object. */
    AskAction build();
  }

  /**
   * Returns the value list of property question. Empty list is returned if the property not set in
   * current object.
   */
  ImmutableList<SchemaOrgType> getQuestionList();
}
