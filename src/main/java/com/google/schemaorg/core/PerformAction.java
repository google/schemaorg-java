...
public interface PerformAction extends PlayAction {
  ...
  public interface Builder extends PlayAction.Builder {
    ...
    /** Add a value to property entertainmentBusiness. */
    Builder addEntertainmentBusiness(EntertainmentBusiness value);

    /** Add a value to property entertainmentBusiness. */
    Builder addEntertainmentBusiness(EntertainmentBusiness.Builder value);

    /** Add a value to property entertainmentBusiness. */
    Builder addEntertainmentBusiness(String value);
    ...
    /** Build a {@link PerformAction} object. */
    PerformAction build();
  }

  /**
   * Returns the value list of property entertainmentBusiness. Empty list is returned if the
   * property not set in current object.
   */
  ImmutableList<SchemaOrgType> getEntertainmentBusinessList();
}
