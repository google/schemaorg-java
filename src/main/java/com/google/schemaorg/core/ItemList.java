...
public interface ItemList extends Intangible {
  ...
  public interface Builder extends Intangible.Builder {
    ...
    /** Add a value to property itemListElement. */
    ...
    /** Add a value to property itemListOrder. */
    ...
    /** Add a value to property numberOfItems. */
    ...
    /** Build a {@link ItemList} object. */
    ItemList build();
  }

  /**
   * Returns the value list of property itemListElement. Empty list is returned if the property not
   * set in current object.
   */
  ImmutableList<SchemaOrgType> getItemListElementList();

  /**
   * Returns the value list of property itemListOrder. Empty list is returned if the property not
   * set in current object.
   */
  ImmutableList<SchemaOrgType> getItemListOrderList();

  /**
   * Returns the value list of property numberOfItems. Empty list is returned if the property not
   * set in current object.
   */
  ImmutableList<SchemaOrgType> getNumberOfItemsList();
}
