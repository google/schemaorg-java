...
public interface Clip extends CreativeWork {
  ...
  public interface Builder extends CreativeWork.Builder {
    ...
    /** Add a value to property clipNumber. */
    Builder addClipNumber(Integer value);

    /** Add a value to property clipNumber. */
    Builder addClipNumber(Text value);

    /** Add a value to property clipNumber. */
    Builder addClipNumber(String value);
    ...
    /** Add a value to property partOfEpisode. */
    Builder addPartOfEpisode(Episode value);

    /** Add a value to property partOfEpisode. */
    Builder addPartOfEpisode(Episode.Builder value);

    /** Add a value to property partOfEpisode. */
    Builder addPartOfEpisode(String value);
  ...
  /**
   * Returns the value list of property clipNumber. Empty list is returned if the property not set
   * in current object.
   */
  ImmutableList<SchemaOrgType> getClipNumberList();
  ...
  /**
   * Returns the value list of property partOfEpisode. Empty list is returned if the property not
   * set in current object.
   */
  ImmutableList<SchemaOrgType> getPartOfEpisodeList();

  /**
   * Returns the value list of property partOfSeason. Empty list is returned if the property not set
   * in current object.
   */
  ImmutableList<SchemaOrgType> getPartOfSeasonList();

  /**
   * Returns the value list of property partOfSeries. Empty list is returned if the property not set
   * in current object.
   */
  ImmutableList<SchemaOrgType> getPartOfSeriesList();
}
