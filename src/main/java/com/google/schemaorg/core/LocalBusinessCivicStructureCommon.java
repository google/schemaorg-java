...
/**
 * Interface of <a
 * href="http://schema.org/LocalBusinessCivicStructureCommon">http://schema.org/LocalBusinessCivicStructureCommon</a>.
 */
public interface LocalBusinessCivicStructureCommon extends Place {
  ...
  public interface Builder extends Place.Builder {
    ...
    /** Build a {@link LocalBusinessCivicStructureCommon} object. */
    LocalBusinessCivicStructureCommon build();
  }

  /**
   * Returns the value list of property openingHours. Empty list is returned if the property not set
   * in current object.
   */
  ImmutableList<SchemaOrgType> getOpeningHoursList();
}
