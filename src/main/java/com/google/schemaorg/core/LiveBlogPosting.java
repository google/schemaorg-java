...
public interface LiveBlogPosting extends BlogPosting {
  ...
  public interface Builder extends BlogPosting.Builder {
    ...
    /** Add a value to property coverageEndTime. */
    Builder addCoverageEndTime(DateTime value);

    /** Add a value to property coverageEndTime. */
    Builder addCoverageEndTime(String value);

    /** Add a value to property coverageStartTime. */
    Builder addCoverageStartTime(DateTime value);

    /** Add a value to property coverageStartTime. */
    Builder addCoverageStartTime(String value);
    ...
    /** Add a value to property liveBlogUpdate. */
    Builder addLiveBlogUpdate(BlogPosting value);

    /** Add a value to property liveBlogUpdate. */
    Builder addLiveBlogUpdate(BlogPosting.Builder value);

    /** Add a value to property liveBlogUpdate. */
    Builder addLiveBlogUpdate(String value);
    ...
    /** Add a value to property sharedContent. */
    Builder addSharedContent(CreativeWork value);

    /** Add a value to property sharedContent. */
    Builder addSharedContent(CreativeWork.Builder value);

    /** Add a value to property sharedContent. */
    Builder addSharedContent(String value);
    ...
    /** Build a {@link LiveBlogPosting} object. */
    LiveBlogPosting build();
  }

  /**
   * Returns the value list of property coverageEndTime. Empty list is returned if the property not
   * set in current object.
   */
  ImmutableList<SchemaOrgType> getCoverageEndTimeList();

  /**
   * Returns the value list of property coverageStartTime. Empty list is returned if the property
   * not set in current object.
   */
  ImmutableList<SchemaOrgType> getCoverageStartTimeList();

  /**
   * Returns the value list of property liveBlogUpdate. Empty list is returned if the property not
   * set in current object.
   */
  ImmutableList<SchemaOrgType> getLiveBlogUpdateList();
}
