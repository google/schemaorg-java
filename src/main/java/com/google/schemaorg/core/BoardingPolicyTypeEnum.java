...
/*
 * Enum values of <a href="http://schema.org/BoardingPolicyType">http://schema.org/BoardingPolicyType</a>.
 */
public enum BoardingPolicyTypeEnum implements BoardingPolicyType {
  GROUP_BOARDING_POLICY(CoreConstants.NAMESPACE + "GroupBoardingPolicy"),

  ZONE_BOARDING_POLICY(CoreConstants.NAMESPACE + "ZoneBoardingPolicy");
  ...
  public String getFullTypeName() {
    return CoreConstants.TYPE_BOARDING_POLICY_TYPE;
  }
