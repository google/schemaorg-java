...
public interface MediaObject extends CreativeWork {
  ...
  public interface Builder extends CreativeWork.Builder {
    ...
    /** Add a value to property associatedArticle. */
    Builder addAssociatedArticle(NewsArticle value);

    /** Add a value to property associatedArticle. */
    Builder addAssociatedArticle(NewsArticle.Builder value);

    /** Add a value to property associatedArticle. */
    Builder addAssociatedArticle(String value);
    ...
    /** Add a value to property bitrate. */
    Builder addBitrate(Text value);

    /** Add a value to property bitrate. */
    Builder addBitrate(String value);
    ...
    /** Add a value to property contentSize. */
    Builder addContentSize(Text value);

    /** Add a value to property contentSize. */
    Builder addContentSize(String value);

    /** Add a value to property contentUrl. */
    Builder addContentUrl(URL value);

    /** Add a value to property contentUrl. */
    Builder addContentUrl(String value);
    ...
    /** Add a value to property embedUrl. */
    Builder addEmbedUrl(URL value);

    /** Add a value to property embedUrl. */
    Builder addEmbedUrl(String value);

    /** Add a value to property encodesCreativeWork. */
    Builder addEncodesCreativeWork(CreativeWork value);

    /** Add a value to property encodesCreativeWork. */
    Builder addEncodesCreativeWork(CreativeWork.Builder value);

    /** Add a value to property encodesCreativeWork. */
    Builder addEncodesCreativeWork(String value);
    ...
    /** Add a value to property encodingFormat. */
    Builder addEncodingFormat(Text value);

    /** Add a value to property encodingFormat. */
    Builder addEncodingFormat(String value);
    ...
    /** Add a value to property expires. */
    Builder addExpires(Date value);

    /** Add a value to property expires. */
    Builder addExpires(String value);
    ...
    /** Add a value to property playerType. */
    Builder addPlayerType(Text value);

    /** Add a value to property playerType. */
    Builder addPlayerType(String value);
    ...
    /** Add a value to property regionsAllowed. */
    Builder addRegionsAllowed(Place value);

    /** Add a value to property regionsAllowed. */
    Builder addRegionsAllowed(Place.Builder value);

    /** Add a value to property regionsAllowed. */
    Builder addRegionsAllowed(String value);
    ...
    /** Add a value to property requiresSubscription. */
    Builder addRequiresSubscription(Boolean value);

    /** Add a value to property requiresSubscription. */
    Builder addRequiresSubscription(String value);
    ...
    /** Add a value to property uploadDate. */
    Builder addUploadDate(Date value);

    /** Add a value to property uploadDate. */
    Builder addUploadDate(String value);
    ...
    /** Build a {@link MediaObject} object. */
    MediaObject build();
  }

  /**
   * Returns the value list of property associatedArticle. Empty list is returned if the property
   * not set in current object.
   */
  ImmutableList<SchemaOrgType> getAssociatedArticleList();

  /**
   * Returns the value list of property bitrate. Empty list is returned if the property not set in
   * current object.
   */
  ImmutableList<SchemaOrgType> getBitrateList();

  /**
   * Returns the value list of property contentSize. Empty list is returned if the property not set
   * in current object.
   */
  ImmutableList<SchemaOrgType> getContentSizeList();

  /**
   * Returns the value list of property contentUrl. Empty list is returned if the property not set
   * in current object.
   */
  ImmutableList<SchemaOrgType> getContentUrlList();

  /**
   * Returns the value list of property duration. Empty list is returned if the property not set in
   * current object.
   */
  ImmutableList<SchemaOrgType> getDurationList();

  /**
   * Returns the value list of property embedUrl. Empty list is returned if the property not set in
   * current object.
   */
  ImmutableList<SchemaOrgType> getEmbedUrlList();

  /**
   * Returns the value list of property encodesCreativeWork. Empty list is returned if the property
   * not set in current object.
   */
  ImmutableList<SchemaOrgType> getEncodesCreativeWorkList();

  /**
   * Returns the value list of property encodingFormat. Empty list is returned if the property not
   * set in current object.
   */
  ImmutableList<SchemaOrgType> getEncodingFormatList();

  /**
   * Returns the value list of property expires. Empty list is returned if the property not set in
   * current object.
   */
  ImmutableList<SchemaOrgType> getExpiresList();
  ...
  /**
   * Returns the value list of property playerType. Empty list is returned if the property not set
   * in current object.
   */
  ImmutableList<SchemaOrgType> getPlayerTypeList();
  ...
  /**
   * Returns the value list of property regionsAllowed. Empty list is returned if the property not
   * set in current object.
   */
  ImmutableList<SchemaOrgType> getRegionsAllowedList();

  /**
   * Returns the value list of property requiresSubscription. Empty list is returned if the property
   * not set in current object.
   */
  ImmutableList<SchemaOrgType> getRequiresSubscriptionList();

  /**
   * Returns the value list of property uploadDate. Empty list is returned if the property not set
   * in current object.
   */
  ImmutableList<SchemaOrgType> getUploadDateList();
