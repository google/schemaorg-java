...
/*
 * Enum values of <a href="http://schema.org/MedicineSystem">http://schema.org/MedicineSystem</a>.
 */
public enum MedicineSystemEnum implements MedicineSystem {
  AYURVEDIC(CoreConstants.NAMESPACE + "Ayurvedic"),

  CHIROPRACTIC(CoreConstants.NAMESPACE + "Chiropractic"),

  HOMEOPATHIC(CoreConstants.NAMESPACE + "Homeopathic"),

  OSTEOPATHIC(CoreConstants.NAMESPACE + "Osteopathic"),

  TRADITIONAL_CHINESE(CoreConstants.NAMESPACE + "TraditionalChinese"),

  WESTERN_CONVENTIONAL(CoreConstants.NAMESPACE + "WesternConventional");
  ...
  public String getFullTypeName() {
    return CoreConstants.TYPE_MEDICINE_SYSTEM;
  }
