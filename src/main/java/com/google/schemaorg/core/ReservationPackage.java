...
/**
 * Interface of <a
 * href="http://schema.org/ReservationPackage">http://schema.org/ReservationPackage</a>.
 */
public interface ReservationPackage extends Reservation {
  ...
  public interface Builder extends Reservation.Builder {
    ...
    /** Add a value to property subReservation. */
    Builder addSubReservation(Reservation value);

    /** Add a value to property subReservation. */
    Builder addSubReservation(Reservation.Builder value);

    /** Add a value to property subReservation. */
    Builder addSubReservation(String value);
    ...
    /** Build a {@link ReservationPackage} object. */
    ReservationPackage build();
  }

  /**
   * Returns the value list of property subReservation. Empty list is returned if the property not
   * set in current object.
   */
  ImmutableList<SchemaOrgType> getSubReservationList();
}
