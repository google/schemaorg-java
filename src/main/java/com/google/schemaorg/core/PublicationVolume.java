...
/**
 * Interface of <a
 * href="http://schema.org/PublicationVolume">http://schema.org/PublicationVolume</a>.
 */
public interface PublicationVolume extends CreativeWork {
  ...
  public interface Builder extends CreativeWork.Builder {
    ...
    /** Add a value to property volumeNumber. */
    Builder addVolumeNumber(Integer value);

    /** Add a value to property volumeNumber. */
    Builder addVolumeNumber(Text value);

    /** Add a value to property volumeNumber. */
    Builder addVolumeNumber(String value);
    ...
    /** Build a {@link PublicationVolume} object. */
    PublicationVolume build();
  }
  ...
  /**
   * Returns the value list of property volumeNumber. Empty list is returned if the property not set
   * in current object.
   */
  ImmutableList<SchemaOrgType> getVolumeNumberList();
}
