...
/** Interface of <a href="http://schema.org/AutoDealer">http://schema.org/AutoDealer</a>. */
public interface AutoDealer extends AutomotiveBusiness {

  /**
   * Builder interface of <a href="http://schema.org/AutoDealer">http://schema.org/AutoDealer</a>.
   */
  public interface Builder extends AutomotiveBusiness.Builder {
    ...
    /** Build a {@link AutoDealer} object. */
    AutoDealer build();
  }
}
