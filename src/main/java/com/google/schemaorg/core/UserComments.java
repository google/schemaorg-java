...
public interface UserComments extends UserInteraction {
  ...
  public interface Builder extends UserInteraction.Builder {
    ...
    /** Add a value to property commentText. */
    Builder addCommentText(Text value);

    /** Add a value to property commentText. */
    Builder addCommentText(String value);

    /** Add a value to property commentTime. */
    Builder addCommentTime(Date value);

    /** Add a value to property commentTime. */
    Builder addCommentTime(String value);
    ...
    /** Add a value to property discusses. */
    Builder addDiscusses(CreativeWork value);

    /** Add a value to property discusses. */
    Builder addDiscusses(CreativeWork.Builder value);

    /** Add a value to property discusses. */
    Builder addDiscusses(String value);
    ...
    /** Add a value to property replyToUrl. */
    Builder addReplyToUrl(URL value);

    /** Add a value to property replyToUrl. */
    Builder addReplyToUrl(String value);
    ...
    /** Build a {@link UserComments} object. */
    UserComments build();
  }

  /**
   * Returns the value list of property commentText. Empty list is returned if the property not set
   * in current object.
   */
  ImmutableList<SchemaOrgType> getCommentTextList();

  /**
   * Returns the value list of property commentTime. Empty list is returned if the property not set
   * in current object.
   */
  ImmutableList<SchemaOrgType> getCommentTimeList();
  ...
  /**
   * Returns the value list of property discusses. Empty list is returned if the property not set in
   * current object.
   */
  ImmutableList<SchemaOrgType> getDiscussesList();

  /**
   * Returns the value list of property replyToUrl. Empty list is returned if the property not set
   * in current object.
   */
  ImmutableList<SchemaOrgType> getReplyToUrlList();
}
