...
/** Interface of <a href="http://schema.org/EndorseAction">http://schema.org/EndorseAction</a>. */
public interface EndorseAction extends ReactAction {

  /**
   * Builder interface of <a
   * href="http://schema.org/EndorseAction">http://schema.org/EndorseAction</a>.
   */
  public interface Builder extends ReactAction.Builder {
    ...
    /** Add a value to property endorsee. */
    Builder addEndorsee(Organization value);

    /** Add a value to property endorsee. */
    Builder addEndorsee(Organization.Builder value);

    /** Add a value to property endorsee. */
    Builder addEndorsee(Person value);

    /** Add a value to property endorsee. */
    Builder addEndorsee(Person.Builder value);

    /** Add a value to property endorsee. */
    Builder addEndorsee(String value);
    ...
    /** Build a {@link EndorseAction} object. */
    EndorseAction build();
  }

  /**
   * Returns the value list of property endorsee. Empty list is returned if the property not set in
   * current object.
   */
  ImmutableList<SchemaOrgType> getEndorseeList();
}
