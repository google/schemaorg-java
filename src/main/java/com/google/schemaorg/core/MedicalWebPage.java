...
/**
 * Interface of <a href="http://schema.org/MedicalWebPage">http://schema.org/MedicalWebPage</a>.
 */
public interface MedicalWebPage extends WebPage {

  /**
   * Builder interface of <a
   * href="http://schema.org/MedicalWebPage">http://schema.org/MedicalWebPage</a>.
   */
  public interface Builder extends WebPage.Builder {
    ...
    /** Add a value to property aspect. */
    Builder addAspect(Text value);

    /** Add a value to property aspect. */
    Builder addAspect(String value);
    ...
    /** Build a {@link MedicalWebPage} object. */
    MedicalWebPage build();
  }

  /**
   * Returns the value list of property aspect. Empty list is returned if the property not set in
   * current object.
   */
  ImmutableList<SchemaOrgType> getAspectList();
}
