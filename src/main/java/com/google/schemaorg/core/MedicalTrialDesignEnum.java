...
/*
 * Enum values of <a href="http://schema.org/MedicalTrialDesign">http://schema.org/MedicalTrialDesign</a>.
 */
public enum MedicalTrialDesignEnum implements MedicalTrialDesign {
  DOUBLE_BLINDED_TRIAL(CoreConstants.NAMESPACE + "DoubleBlindedTrial"),

  INTERNATIONAL_TRIAL(CoreConstants.NAMESPACE + "InternationalTrial"),

  MULTI_CENTER_TRIAL(CoreConstants.NAMESPACE + "MultiCenterTrial"),

  OPEN_TRIAL(CoreConstants.NAMESPACE + "OpenTrial"),

  PLACEBO_CONTROLLED_TRIAL(CoreConstants.NAMESPACE + "PlaceboControlledTrial"),

  RANDOMIZED_TRIAL(CoreConstants.NAMESPACE + "RandomizedTrial"),

  SINGLE_BLINDED_TRIAL(CoreConstants.NAMESPACE + "SingleBlindedTrial"),

  SINGLE_CENTER_TRIAL(CoreConstants.NAMESPACE + "SingleCenterTrial"),

  TRIPLE_BLINDED_TRIAL(CoreConstants.NAMESPACE + "TripleBlindedTrial");
  ...
  public String getFullTypeName() {
    return CoreConstants.TYPE_MEDICAL_TRIAL_DESIGN;
  }
