...
public interface PerformanceRole extends Role {
  ...
  public interface Builder extends Role.Builder {
    ...
    /** Add a value to property characterName. */
    Builder addCharacterName(Text value);

    /** Add a value to property characterName. */
    Builder addCharacterName(String value);
    ...
    /** Build a {@link PerformanceRole} object. */
    PerformanceRole build();
  }

  /**
   * Returns the value list of property characterName. Empty list is returned if the property not
   * set in current object.
   */
  ImmutableList<SchemaOrgType> getCharacterNameList();
}
