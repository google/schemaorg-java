...
/**
 * Interface of <a
 * href="http://schema.org/AnatomicalStructure">http://schema.org/AnatomicalStructure</a>.
 */
public interface AnatomicalStructure extends MedicalEntity {
  ...
  public interface Builder extends MedicalEntity.Builder {
    ...
    /** Build a {@link AnatomicalStructure} object. */
    AnatomicalStructure build();
  }

  /**
   * Returns the value list of property associatedPathophysiology. Empty list is returned if the
   * property not set in current object.
   */
  ImmutableList<SchemaOrgType> getAssociatedPathophysiologyList();

  /**
   * Returns the value list of property bodyLocation. Empty list is returned if the property not set
   * in current object.
   */
  ImmutableList<SchemaOrgType> getBodyLocationList();

  /**
   * Returns the value list of property connectedTo. Empty list is returned if the property not set
   * in current object.
   */
  ImmutableList<SchemaOrgType> getConnectedToList();

  /**
   * Returns the value list of property diagram. Empty list is returned if the property not set in
   * current object.
   */
  ImmutableList<SchemaOrgType> getDiagramList();

  /**
   * Returns the value list of property function. Empty list is returned if the property not set in
   * current object.
   */
  ImmutableList<SchemaOrgType> getFunctionList();

  /**
   * Returns the value list of property partOfSystem. Empty list is returned if the property not set
   * in current object.
   */
  ImmutableList<SchemaOrgType> getPartOfSystemList();

  /**
   * Returns the value list of property relatedCondition. Empty list is returned if the property not
   * set in current object.
   */
  ImmutableList<SchemaOrgType> getRelatedConditionList();

  /**
   * Returns the value list of property relatedTherapy. Empty list is returned if the property not
   * set in current object.
   */
  ImmutableList<SchemaOrgType> getRelatedTherapyList();

  /**
   * Returns the value list of property subStructure. Empty list is returned if the property not set
   * in current object.
   */
  ImmutableList<SchemaOrgType> getSubStructureList();
}
