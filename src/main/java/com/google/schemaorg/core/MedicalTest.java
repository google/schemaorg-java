...
/** Interface of <a href="http://schema.org/MedicalTest">http://schema.org/MedicalTest</a>. */
public interface MedicalTest extends MedicalEntity {

  /**
   * Builder interface of <a
   * href="http://schema.org/MedicalTest">http://schema.org/MedicalTest</a>.
   */
  public interface Builder extends MedicalEntity.Builder {
    ...
    /** Build a {@link MedicalTest} object. */
    MedicalTest build();
  }

  /**
   * Returns the value list of property affectedBy. Empty list is returned if the property not set
   * in current object.
   */
  ImmutableList<SchemaOrgType> getAffectedByList();

  /**
   * Returns the value list of property normalRange. Empty list is returned if the property not set
   * in current object.
   */
  ImmutableList<SchemaOrgType> getNormalRangeList();

  /**
   * Returns the value list of property signDetected. Empty list is returned if the property not set
   * in current object.
   */
  ImmutableList<SchemaOrgType> getSignDetectedList();

  /**
   * Returns the value list of property usedToDiagnose. Empty list is returned if the property not
   * set in current object.
   */
  ImmutableList<SchemaOrgType> getUsedToDiagnoseList();

  /**
   * Returns the value list of property usesDevice. Empty list is returned if the property not set
   * in current object.
   */
  ImmutableList<SchemaOrgType> getUsesDeviceList();
}
