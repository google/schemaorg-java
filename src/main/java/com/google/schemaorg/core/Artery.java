...
/** Interface of <a href="http://schema.org/Artery">http://schema.org/Artery</a>. */
public interface Artery extends Vessel {

  /** Builder interface of <a href="http://schema.org/Artery">http://schema.org/Artery</a>. */
  public interface Builder extends Vessel.Builder {
    ...
    /** Add a value to property arterialBranch. */
    Builder addArterialBranch(AnatomicalStructure value);

    /** Add a value to property arterialBranch. */
    Builder addArterialBranch(AnatomicalStructure.Builder value);

    /** Add a value to property arterialBranch. */
    Builder addArterialBranch(String value);
    ...
    /** Add a value to property source. */
    Builder addSource(AnatomicalStructure value);

    /** Add a value to property source. */
    Builder addSource(AnatomicalStructure.Builder value);

    /** Add a value to property source. */
    Builder addSource(String value);
    ...
    /** Add a value to property supplyTo. */
    Builder addSupplyTo(AnatomicalStructure value);

    /** Add a value to property supplyTo. */
    Builder addSupplyTo(AnatomicalStructure.Builder value);

    /** Add a value to property supplyTo. */
    Builder addSupplyTo(String value);
    ...
    /** Build a {@link Artery} object. */
    Artery build();
  }

  /**
   * Returns the value list of property arterialBranch. Empty list is returned if the property not
   * set in current object.
   */
  ImmutableList<SchemaOrgType> getArterialBranchList();

  /**
   * Returns the value list of property source. Empty list is returned if the property not set in
   * current object.
   */
  ImmutableList<SchemaOrgType> getSourceList();

  /**
   * Returns the value list of property supplyTo. Empty list is returned if the property not set in
   * current object.
   */
  ImmutableList<SchemaOrgType> getSupplyToList();
}
