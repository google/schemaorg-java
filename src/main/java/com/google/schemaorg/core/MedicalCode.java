...
public interface MedicalCode extends MedicalIntangible {
  ...
  public interface Builder extends MedicalIntangible.Builder {
    ...
    /** Add a value to property codeValue. */
    Builder addCodeValue(Text value);

    /** Add a value to property codeValue. */
    Builder addCodeValue(String value);

    /** Add a value to property codingSystem. */
    Builder addCodingSystem(Text value);

    /** Add a value to property codingSystem. */
    Builder addCodingSystem(String value);
    ...
    /** Build a {@link MedicalCode} object. */
    MedicalCode build();
  }

  /**
   * Returns the value list of property codeValue. Empty list is returned if the property not set in
   * current object.
   */
  ImmutableList<SchemaOrgType> getCodeValueList();

  /**
   * Returns the value list of property codingSystem. Empty list is returned if the property not set
   * in current object.
   */
  ImmutableList<SchemaOrgType> getCodingSystemList();
}
