...
/** Interface of <a href="http://schema.org/MusicGroup">http://schema.org/MusicGroup</a>. */
public interface MusicGroup extends PerformingGroup {

  /**
   * Builder interface of <a href="http://schema.org/MusicGroup">http://schema.org/MusicGroup</a>.
   */
  public interface Builder extends PerformingGroup.Builder {
    ...
    /** Add a value to property album. */
    Builder addAlbum(MusicAlbum value);

    /** Add a value to property album. */
    Builder addAlbum(MusicAlbum.Builder value);

    /** Add a value to property album. */
    Builder addAlbum(String value);

    /** Add a value to property albums. */
    Builder addAlbums(MusicAlbum value);

    /** Add a value to property albums. */
    Builder addAlbums(MusicAlbum.Builder value);

    /** Add a value to property albums. */
    Builder addAlbums(String value);
    ...
    /** Add a value to property musicGroupMember. */
    Builder addMusicGroupMember(Person value);

    /** Add a value to property musicGroupMember. */
    Builder addMusicGroupMember(Person.Builder value);

    /** Add a value to property musicGroupMember. */
    Builder addMusicGroupMember(String value);
    ...
    /** Build a {@link MusicGroup} object. */
    MusicGroup build();
  }

  /**
   * Returns the value list of property album. Empty list is returned if the property not set in
   * current object.
   */
  ImmutableList<SchemaOrgType> getAlbumList();

  /**
   * Returns the value list of property albums. Empty list is returned if the property not set in
   * current object.
   */
  ImmutableList<SchemaOrgType> getAlbumsList();
  ...
  /**
   * Returns the value list of property musicGroupMember. Empty list is returned if the property not
   * set in current object.
   */
  ImmutableList<SchemaOrgType> getMusicGroupMemberList();

  /**
   * Returns the value list of property track. Empty list is returned if the property not set in
   * current object.
   */
  ImmutableList<SchemaOrgType> getTrackList();

  /**
   * Returns the value list of property tracks. Empty list is returned if the property not set in
   * current object.
   */
  ImmutableList<SchemaOrgType> getTracksList();
}
