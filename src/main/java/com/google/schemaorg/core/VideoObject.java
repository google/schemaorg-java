...
/** Interface of <a href="http://schema.org/VideoObject">http://schema.org/VideoObject</a>. */
public interface VideoObject extends MediaObject {

  /**
   * Builder interface of <a
   * href="http://schema.org/VideoObject">http://schema.org/VideoObject</a>.
   */
  public interface Builder extends MediaObject.Builder {
    ...
    /** Add a value to property caption. */
    Builder addCaption(Text value);

    /** Add a value to property caption. */
    Builder addCaption(String value);
    ...
    /** Add a value to property thumbnail. */
    Builder addThumbnail(ImageObject value);

    /** Add a value to property thumbnail. */
    Builder addThumbnail(ImageObject.Builder value);

    /** Add a value to property thumbnail. */
    Builder addThumbnail(String value);
    ...
    /** Add a value to property transcript. */
    Builder addTranscript(Text value);

    /** Add a value to property transcript. */
    Builder addTranscript(String value);
    ...
    /** Add a value to property videoFrameSize. */
    Builder addVideoFrameSize(Text value);

    /** Add a value to property videoFrameSize. */
    Builder addVideoFrameSize(String value);

    /** Add a value to property videoQuality. */
    Builder addVideoQuality(Text value);

    /** Add a value to property videoQuality. */
    Builder addVideoQuality(String value);
    ...
    /** Build a {@link VideoObject} object. */
    VideoObject build();
  }
  ...
  /**
   * Returns the value list of property caption. Empty list is returned if the property not set in
   * current object.
   */
  ImmutableList<SchemaOrgType> getCaptionList();
  ...
  /**
   * Returns the value list of property thumbnail. Empty list is returned if the property not set in
   * current object.
   */
  ImmutableList<SchemaOrgType> getThumbnailList();

  /**
   * Returns the value list of property transcript. Empty list is returned if the property not set
   * in current object.
   */
  ImmutableList<SchemaOrgType> getTranscriptList();

  /**
   * Returns the value list of property videoFrameSize. Empty list is returned if the property not
   * set in current object.
   */
  ImmutableList<SchemaOrgType> getVideoFrameSizeList();

  /**
   * Returns the value list of property videoQuality. Empty list is returned if the property not set
   * in current object.
   */
  ImmutableList<SchemaOrgType> getVideoQualityList();
}
