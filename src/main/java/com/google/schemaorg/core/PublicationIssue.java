...
/**
 * Interface of <a
 * href="http://schema.org/PublicationIssue">http://schema.org/PublicationIssue</a>.
 */
public interface PublicationIssue extends CreativeWork {
  ...
  public interface Builder extends CreativeWork.Builder {
    ...
    /** Add a value to property issueNumber. */
    Builder addIssueNumber(Integer value);

    /** Add a value to property issueNumber. */
    Builder addIssueNumber(Text value);

    /** Add a value to property issueNumber. */
    Builder addIssueNumber(String value);
    ...
    /** Build a {@link PublicationIssue} object. */
    PublicationIssue build();
  }

  /**
   * Returns the value list of property issueNumber. Empty list is returned if the property not set
   * in current object.
   */
  ImmutableList<SchemaOrgType> getIssueNumberList();
