...
/** Interface of <a href="http://schema.org/APIReference">http://schema.org/APIReference</a>. */
public interface APIReference extends TechArticle {

  /**
   * Builder interface of <a
   * href="http://schema.org/APIReference">http://schema.org/APIReference</a>.
   */
  public interface Builder extends TechArticle.Builder {
    ...
    /** Add a value to property articleBody. */
    Builder addArticleBody(Text value);

    /** Add a value to property articleBody. */
    Builder addArticleBody(String value);

    /** Add a value to property articleSection. */
    Builder addArticleSection(Text value);

    /** Add a value to property articleSection. */
    Builder addArticleSection(String value);

    /** Add a value to property assembly. */
    Builder addAssembly(Text value);

    /** Add a value to property assembly. */
    Builder addAssembly(String value);

    /** Add a value to property assemblyVersion. */
    Builder addAssemblyVersion(Text value);

    /** Add a value to property assemblyVersion. */
    Builder addAssemblyVersion(String value);
    ...
    /** Add a value to property dependencies. */
    Builder addDependencies(Text value);

    /** Add a value to property dependencies. */
    Builder addDependencies(String value);
    ...
    /** Add a value to property executableLibraryName. */
    Builder addExecutableLibraryName(Text value);

    /** Add a value to property executableLibraryName. */
    Builder addExecutableLibraryName(String value);
    ...
    /** Add a value to property pageEnd. */
    Builder addPageEnd(Integer value);

    /** Add a value to property pageEnd. */
    Builder addPageEnd(Text value);

    /** Add a value to property pageEnd. */
    Builder addPageEnd(String value);

    /** Add a value to property pageStart. */
    Builder addPageStart(Integer value);

    /** Add a value to property pageStart. */
    Builder addPageStart(Text value);

    /** Add a value to property pageStart. */
    Builder addPageStart(String value);

    /** Add a value to property pagination. */
    Builder addPagination(Text value);

    /** Add a value to property pagination. */
    Builder addPagination(String value);
    ...
    /** Add a value to property proficiencyLevel. */
    Builder addProficiencyLevel(Text value);

    /** Add a value to property proficiencyLevel. */
    Builder addProficiencyLevel(String value);

    /** Add a value to property programmingModel. */
    Builder addProgrammingModel(Text value);

    /** Add a value to property programmingModel. */
    Builder addProgrammingModel(String value);
    ...
    /** Add a value to property targetPlatform. */
    Builder addTargetPlatform(Text value);

    /** Add a value to property targetPlatform. */
    Builder addTargetPlatform(String value);
    ...
    /** Add a value to property wordCount. */
    Builder addWordCount(Integer value);

    /** Add a value to property wordCount. */
    Builder addWordCount(String value);
    ...
    /** Build a {@link APIReference} object. */
    APIReference build();
  }

  /**
   * Returns the value list of property assembly. Empty list is returned if the property not set in
   * current object.
   */
  ImmutableList<SchemaOrgType> getAssemblyList();

  /**
   * Returns the value list of property assemblyVersion. Empty list is returned if the property not
   * set in current object.
   */
  ImmutableList<SchemaOrgType> getAssemblyVersionList();

  /**
   * Returns the value list of property executableLibraryName. Empty list is returned if the
   * property not set in current object.
   */
  ImmutableList<SchemaOrgType> getExecutableLibraryNameList();

  /**
   * Returns the value list of property programmingModel. Empty list is returned if the property not
   * set in current object.
   */
  ImmutableList<SchemaOrgType> getProgrammingModelList();

  /**
   * Returns the value list of property targetPlatform. Empty list is returned if the property not
   * set in current object.
   */
  ImmutableList<SchemaOrgType> getTargetPlatformList();
}
