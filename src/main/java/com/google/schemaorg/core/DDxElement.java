...
/** Interface of <a href="http://schema.org/DDxElement">http://schema.org/DDxElement</a>. */
public interface DDxElement extends MedicalIntangible {

  /**
   * Builder interface of <a href="http://schema.org/DDxElement">http://schema.org/DDxElement</a>.
   */
  public interface Builder extends MedicalIntangible.Builder {
    ...
    /** Add a value to property diagnosis. */
    Builder addDiagnosis(MedicalCondition value);

    /** Add a value to property diagnosis. */
    Builder addDiagnosis(MedicalCondition.Builder value);

    /** Add a value to property diagnosis. */
    Builder addDiagnosis(String value);

    /** Add a value to property distinguishingSign. */
    Builder addDistinguishingSign(MedicalSignOrSymptom value);

    /** Add a value to property distinguishingSign. */
    Builder addDistinguishingSign(MedicalSignOrSymptom.Builder value);

    /** Add a value to property distinguishingSign. */
    Builder addDistinguishingSign(String value);
    ...
    /** Build a {@link DDxElement} object. */
    DDxElement build();
  }

  /**
   * Returns the value list of property diagnosis. Empty list is returned if the property not set in
   * current object.
   */
  ImmutableList<SchemaOrgType> getDiagnosisList();

  /**
   * Returns the value list of property distinguishingSign. Empty list is returned if the property
   * not set in current object.
   */
  ImmutableList<SchemaOrgType> getDistinguishingSignList();
}
