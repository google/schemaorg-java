...
/** Interface of <a href="http://schema.org/SportsTeam">http://schema.org/SportsTeam</a>. */
public interface SportsTeam extends SportsOrganization {

  /**
   * Builder interface of <a href="http://schema.org/SportsTeam">http://schema.org/SportsTeam</a>.
   */
  public interface Builder extends SportsOrganization.Builder {
    ...
    /** Add a value to property athlete. */
    Builder addAthlete(Person value);

    /** Add a value to property athlete. */
    Builder addAthlete(Person.Builder value);

    /** Add a value to property athlete. */
    Builder addAthlete(String value);
    ...
    /** Add a value to property coach. */
    Builder addCoach(Person value);

    /** Add a value to property coach. */
    Builder addCoach(Person.Builder value);

    /** Add a value to property coach. */
    Builder addCoach(String value);
    ...
    /** Add a value to property sport. */
    Builder addSport(Text value);

    /** Add a value to property sport. */
    Builder addSport(URL value);

    /** Add a value to property sport. */
    Builder addSport(String value);
    ...
    /** Build a {@link SportsTeam} object. */
    SportsTeam build();
  }

  /**
   * Returns the value list of property athlete. Empty list is returned if the property not set in
   * current object.
   */
  ImmutableList<SchemaOrgType> getAthleteList();

  /**
   * Returns the value list of property coach. Empty list is returned if the property not set in
   * current object.
   */
  ImmutableList<SchemaOrgType> getCoachList();
}
