...
/** Interface of <a href="http://schema.org/RentAction">http://schema.org/RentAction</a>. */
public interface RentAction extends TradeAction {

  /**
   * Builder interface of <a href="http://schema.org/RentAction">http://schema.org/RentAction</a>.
   */
  public interface Builder extends TradeAction.Builder {
    ...
    /** Add a value to property landlord. */
    Builder addLandlord(Organization value);

    /** Add a value to property landlord. */
    Builder addLandlord(Organization.Builder value);

    /** Add a value to property landlord. */
    Builder addLandlord(Person value);

    /** Add a value to property landlord. */
    Builder addLandlord(Person.Builder value);

    /** Add a value to property landlord. */
    Builder addLandlord(String value);
    ...
    /** Add a value to property realEstateAgent. */
    Builder addRealEstateAgent(RealEstateAgent value);

    /** Add a value to property realEstateAgent. */
    Builder addRealEstateAgent(RealEstateAgent.Builder value);

    /** Add a value to property realEstateAgent. */
    Builder addRealEstateAgent(String value);
    ...
    /** Build a {@link RentAction} object. */
    RentAction build();
  }

  /**
   * Returns the value list of property landlord. Empty list is returned if the property not set in
   * current object.
   */
  ImmutableList<SchemaOrgType> getLandlordList();

  /**
   * Returns the value list of property realEstateAgent. Empty list is returned if the property not
   * set in current object.
   */
  ImmutableList<SchemaOrgType> getRealEstateAgentList();
}
