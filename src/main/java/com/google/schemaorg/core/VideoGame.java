...
public interface VideoGame extends Game, SoftwareApplication {
  ...
  public interface Builder extends Game.Builder, SoftwareApplication.Builder {
    ...
    /** Add a value to property gameServer. */
    Builder addGameServer(GameServer value);

    /** Add a value to property gameServer. */
    Builder addGameServer(GameServer.Builder value);

    /** Add a value to property gameServer. */
    Builder addGameServer(String value);

    /** Add a value to property gameTip. */
    Builder addGameTip(CreativeWork value);

    /** Add a value to property gameTip. */
    Builder addGameTip(CreativeWork.Builder value);

    /** Add a value to property gameTip. */
    Builder addGameTip(String value);
  ...
  /**
   * Returns the value list of property gameServer. Empty list is returned if the property not set
   * in current object.
   */
  ImmutableList<SchemaOrgType> getGameServerList();

  /**
   * Returns the value list of property gameTip. Empty list is returned if the property not set in
   * current object.
   */
  ImmutableList<SchemaOrgType> getGameTipList();
