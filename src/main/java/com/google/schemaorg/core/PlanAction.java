...
/** Interface of <a href="http://schema.org/PlanAction">http://schema.org/PlanAction</a>. */
public interface PlanAction extends OrganizeAction {

  /**
   * Builder interface of <a href="http://schema.org/PlanAction">http://schema.org/PlanAction</a>.
   */
  public interface Builder extends OrganizeAction.Builder {
    ...
    /** Add a value to property scheduledTime. */
    Builder addScheduledTime(DateTime value);

    /** Add a value to property scheduledTime. */
    Builder addScheduledTime(String value);
    ...
    /** Build a {@link PlanAction} object. */
    PlanAction build();
  }

  /**
   * Returns the value list of property scheduledTime. Empty list is returned if the property not
   * set in current object.
   */
  ImmutableList<SchemaOrgType> getScheduledTimeList();
}
