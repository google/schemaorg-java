...
/** Interface of <a href="http://schema.org/Event">http://schema.org/Event</a>. */
public interface Event extends Thing {

  /** Builder interface of <a href="http://schema.org/Event">http://schema.org/Event</a>. */
  ...
  /**
   * Returns the value list of property attendee. Empty list is returned if the property not set in
   * current object.
   */
  ImmutableList<SchemaOrgType> getAttendeeList();

  /**
   * Returns the value list of property attendees. Empty list is returned if the property not set in
   * current object.
   */
  ImmutableList<SchemaOrgType> getAttendeesList();

  /**
   * Returns the value list of property doorTime. Empty list is returned if the property not set in
   * current object.
   */
  ...
  /**
   * Returns the value list of property eventStatus. Empty list is returned if the property not set
   * in current object.
   */
  ...
  /**
   * Returns the value list of property organizer. Empty list is returned if the property not set in
   * current object.
   */
  ImmutableList<SchemaOrgType> getOrganizerList();

  /**
   * Returns the value list of property performer. Empty list is returned if the property not set in
   * current object.
   */
  ImmutableList<SchemaOrgType> getPerformerList();

  /**
   * Returns the value list of property performers. Empty list is returned if the property not set
   * in current object.
   */
  ImmutableList<SchemaOrgType> getPerformersList();

  /**
   * Returns the value list of property previousStartDate. Empty list is returned if the property
   * not set in current object.
   */
  ImmutableList<SchemaOrgType> getPreviousStartDateList();

  /**
   * Returns the value list of property recordedIn. Empty list is returned if the property not set
   * in current object.
   */
  ...
  /**
   * Returns the value list of property subEvent. Empty list is returned if the property not set in
   * current object.
   */
  ImmutableList<SchemaOrgType> getSubEventList();

  /**
   * Returns the value list of property subEvents. Empty list is returned if the property not set in
   * current object.
   */
  ImmutableList<SchemaOrgType> getSubEventsList();

  /**
   * Returns the value list of property superEvent. Empty list is returned if the property not set
   * in current object.
   */
  ...
  /**
   * Returns the value list of property workFeatured. Empty list is returned if the property not set
   * in current object.
   */
  ImmutableList<SchemaOrgType> getWorkFeaturedList();

  /**
   * Returns the value list of property workPerformed. Empty list is returned if the property not
   * set in current object.
   */
