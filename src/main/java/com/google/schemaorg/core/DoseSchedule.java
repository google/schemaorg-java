...
public interface DoseSchedule extends MedicalIntangible {
  ...
  public interface Builder extends MedicalIntangible.Builder {
    ...
    /** Add a value to property doseUnit. */
    Builder addDoseUnit(Text value);

    /** Add a value to property doseUnit. */
    Builder addDoseUnit(String value);

    /** Add a value to property doseValue. */
    Builder addDoseValue(Number value);

    /** Add a value to property doseValue. */
    Builder addDoseValue(String value);

    /** Add a value to property frequency. */
    Builder addFrequency(Text value);

    /** Add a value to property frequency. */
    Builder addFrequency(String value);
    ...
    /** Build a {@link DoseSchedule} object. */
    DoseSchedule build();
  }

  /**
   * Returns the value list of property doseUnit. Empty list is returned if the property not set in
   * current object.
   */
  ImmutableList<SchemaOrgType> getDoseUnitList();

  /**
   * Returns the value list of property doseValue. Empty list is returned if the property not set in
   * current object.
   */
  ImmutableList<SchemaOrgType> getDoseValueList();

  /**
   * Returns the value list of property frequency. Empty list is returned if the property not set in
   * current object.
   */
  ImmutableList<SchemaOrgType> getFrequencyList();
