...
/** Interface of <a href="http://schema.org/Article">http://schema.org/Article</a>. */
public interface Article extends CreativeWork {

  /** Builder interface of <a href="http://schema.org/Article">http://schema.org/Article</a>. */
  public interface Builder extends CreativeWork.Builder {
    ...
    /** Build a {@link Article} object. */
    Article build();
  }

  /**
   * Returns the value list of property articleBody. Empty list is returned if the property not set
   * in current object.
   */
  ImmutableList<SchemaOrgType> getArticleBodyList();

  /**
   * Returns the value list of property articleSection. Empty list is returned if the property not
   * set in current object.
   */
  ImmutableList<SchemaOrgType> getArticleSectionList();

  /**
   * Returns the value list of property pageEnd. Empty list is returned if the property not set in
   * current object.
   */
  ImmutableList<SchemaOrgType> getPageEndList();

  /**
   * Returns the value list of property pageStart. Empty list is returned if the property not set in
   * current object.
   */
  ImmutableList<SchemaOrgType> getPageStartList();

  /**
   * Returns the value list of property pagination. Empty list is returned if the property not set
   * in current object.
   */
  ImmutableList<SchemaOrgType> getPaginationList();

  /**
   * Returns the value list of property wordCount. Empty list is returned if the property not set in
   * current object.
   */
  ImmutableList<SchemaOrgType> getWordCountList();
}
