...
/*
 * Enum values of <a href="http://schema.org/MusicAlbumReleaseType">http://schema.org/MusicAlbumReleaseType</a>.
 */
public enum MusicAlbumReleaseTypeEnum implements MusicAlbumReleaseType {
  ALBUM_RELEASE(CoreConstants.NAMESPACE + "AlbumRelease"),

  BROADCAST_RELEASE(CoreConstants.NAMESPACE + "BroadcastRelease"),

  EP_RELEASE(CoreConstants.NAMESPACE + "EPRelease"),

  SINGLE_RELEASE(CoreConstants.NAMESPACE + "SingleRelease");
  ...
  public String getFullTypeName() {
    return CoreConstants.TYPE_MUSIC_ALBUM_RELEASE_TYPE;
  }
