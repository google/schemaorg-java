...
public interface UnitPriceSpecification extends PriceSpecification {
  ...
  public interface Builder extends PriceSpecification.Builder {
    ...
    /** Add a value to property billingIncrement. */
    Builder addBillingIncrement(Number value);

    /** Add a value to property billingIncrement. */
    Builder addBillingIncrement(String value);
    ...
    /** Add a value to property priceType. */
    Builder addPriceType(Text value);

    /** Add a value to property priceType. */
    Builder addPriceType(String value);
    ...
    /** Build a {@link UnitPriceSpecification} object. */
    UnitPriceSpecification build();
  }

  /**
   * Returns the value list of property billingIncrement. Empty list is returned if the property not
   * set in current object.
   */
  ImmutableList<SchemaOrgType> getBillingIncrementList();

  /**
   * Returns the value list of property priceType. Empty list is returned if the property not set in
   * current object.
   */
