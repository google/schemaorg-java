...
/**
 * Interface of <a
 * href="http://schema.org/MedicalRiskEstimator">http://schema.org/MedicalRiskEstimator</a>.
 */
public interface MedicalRiskEstimator extends MedicalEntity {
  ...
  public interface Builder extends MedicalEntity.Builder {
    ...
    /** Add a value to property estimatesRiskOf. */
    Builder addEstimatesRiskOf(MedicalEntity value);

    /** Add a value to property estimatesRiskOf. */
    Builder addEstimatesRiskOf(MedicalEntity.Builder value);

    /** Add a value to property estimatesRiskOf. */
    Builder addEstimatesRiskOf(String value);
    ...
    /** Add a value to property includedRiskFactor. */
    Builder addIncludedRiskFactor(MedicalRiskFactor value);

    /** Add a value to property includedRiskFactor. */
    Builder addIncludedRiskFactor(MedicalRiskFactor.Builder value);

    /** Add a value to property includedRiskFactor. */
    Builder addIncludedRiskFactor(String value);
    ...
    /** Build a {@link MedicalRiskEstimator} object. */
    MedicalRiskEstimator build();
  }

  /**
   * Returns the value list of property estimatesRiskOf. Empty list is returned if the property not
   * set in current object.
   */
  ImmutableList<SchemaOrgType> getEstimatesRiskOfList();

  /**
   * Returns the value list of property includedRiskFactor. Empty list is returned if the property
   * not set in current object.
   */
  ImmutableList<SchemaOrgType> getIncludedRiskFactorList();
}
