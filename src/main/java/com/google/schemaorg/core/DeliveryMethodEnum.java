...
/*
 * Enum values of <a href="http://schema.org/DeliveryMethod">http://schema.org/DeliveryMethod</a>.
 */
public enum DeliveryMethodEnum implements DeliveryMethod {
  ON_SITE_PICKUP(CoreConstants.NAMESPACE + "OnSitePickup");
  ...
  public String getFullTypeName() {
    return CoreConstants.TYPE_DELIVERY_METHOD;
  }
