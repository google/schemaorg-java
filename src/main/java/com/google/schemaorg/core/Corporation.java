...
/** Interface of <a href="http://schema.org/Corporation">http://schema.org/Corporation</a>. */
public interface Corporation extends Organization {

  /**
   * Builder interface of <a
   * href="http://schema.org/Corporation">http://schema.org/Corporation</a>.
   */
  public interface Builder extends Organization.Builder {
    ...
    /** Add a value to property tickerSymbol. */
    Builder addTickerSymbol(Text value);

    /** Add a value to property tickerSymbol. */
    Builder addTickerSymbol(String value);
    ...
    /** Build a {@link Corporation} object. */
    Corporation build();
  }

  /**
   * Returns the value list of property tickerSymbol. Empty list is returned if the property not set
   * in current object.
   */
  ImmutableList<SchemaOrgType> getTickerSymbolList();
}
