...
/** Interface of <a href="http://schema.org/CommentAction">http://schema.org/CommentAction</a>. */
public interface CommentAction extends CommunicateAction {

  /**
   * Builder interface of <a
   * href="http://schema.org/CommentAction">http://schema.org/CommentAction</a>.
   */
  public interface Builder extends CommunicateAction.Builder {
    ...
    /** Add a value to property resultComment. */
    Builder addResultComment(Comment value);

    /** Add a value to property resultComment. */
    Builder addResultComment(Comment.Builder value);

    /** Add a value to property resultComment. */
    Builder addResultComment(String value);
    ...
    /** Build a {@link CommentAction} object. */
    CommentAction build();
  }

  /**
   * Returns the value list of property resultComment. Empty list is returned if the property not
   * set in current object.
   */
  ImmutableList<SchemaOrgType> getResultCommentList();
}
