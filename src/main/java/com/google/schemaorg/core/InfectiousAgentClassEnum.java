...
/*
 * Enum values of <a href="http://schema.org/InfectiousAgentClass">http://schema.org/InfectiousAgentClass</a>.
 */
public enum InfectiousAgentClassEnum implements InfectiousAgentClass {
  BACTERIA(CoreConstants.NAMESPACE + "Bacteria"),

  FUNGUS(CoreConstants.NAMESPACE + "Fungus"),

  MULTICELLULAR_PARASITE(CoreConstants.NAMESPACE + "MulticellularParasite"),

  PRION(CoreConstants.NAMESPACE + "Prion"),

  PROTOZOA(CoreConstants.NAMESPACE + "Protozoa"),

  VIRUS(CoreConstants.NAMESPACE + "Virus");
  ...
  public String getFullTypeName() {
    return CoreConstants.TYPE_INFECTIOUS_AGENT_CLASS;
  }
