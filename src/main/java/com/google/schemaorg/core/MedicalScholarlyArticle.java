...
/**
 * Interface of <a
 * href="http://schema.org/MedicalScholarlyArticle">http://schema.org/MedicalScholarlyArticle</a>.
 */
public interface MedicalScholarlyArticle extends ScholarlyArticle {
   ...
   * href="http://schema.org/MedicalScholarlyArticle">http://schema.org/MedicalScholarlyArticle</a>.
   */
  public interface Builder extends ScholarlyArticle.Builder {
    ...
    /** Add a value to property publicationType. */
    Builder addPublicationType(Text value);

    /** Add a value to property publicationType. */
    Builder addPublicationType(String value);
    ...
    /** Build a {@link MedicalScholarlyArticle} object. */
    MedicalScholarlyArticle build();
  }

  /**
   * Returns the value list of property publicationType. Empty list is returned if the property not
   * set in current object.
   */
  ImmutableList<SchemaOrgType> getPublicationTypeList();
}
