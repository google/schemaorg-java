...
/** Interface of <a href="http://schema.org/LendAction">http://schema.org/LendAction</a>. */
public interface LendAction extends TransferAction {

  /**
   * Builder interface of <a href="http://schema.org/LendAction">http://schema.org/LendAction</a>.
   */
  public interface Builder extends TransferAction.Builder {
    ...
    /** Add a value to property borrower. */
    Builder addBorrower(Person value);

    /** Add a value to property borrower. */
    Builder addBorrower(Person.Builder value);

    /** Add a value to property borrower. */
    Builder addBorrower(String value);
    ...
    /** Build a {@link LendAction} object. */
    LendAction build();
  }

  /**
   * Returns the value list of property borrower. Empty list is returned if the property not set in
   * current object.
   */
  ImmutableList<SchemaOrgType> getBorrowerList();
}
