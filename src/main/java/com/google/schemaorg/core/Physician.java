...
/** Interface of <a href="http://schema.org/Physician">http://schema.org/Physician</a>. */
public interface Physician extends MedicalOrganization {

  /**
   * Builder interface of <a href="http://schema.org/Physician">http://schema.org/Physician</a>.
   */
  public interface Builder extends MedicalOrganization.Builder {
    ...
    /** Add a value to property availableService. */
    Builder addAvailableService(MedicalProcedure value);

    /** Add a value to property availableService. */
    Builder addAvailableService(MedicalProcedure.Builder value);

    /** Add a value to property availableService. */
    Builder addAvailableService(MedicalTest value);

    /** Add a value to property availableService. */
    Builder addAvailableService(MedicalTest.Builder value);

    /** Add a value to property availableService. */
    Builder addAvailableService(MedicalTherapy value);

    /** Add a value to property availableService. */
    Builder addAvailableService(MedicalTherapy.Builder value);

    /** Add a value to property availableService. */
    Builder addAvailableService(String value);
    ...
    /** Add a value to property hospitalAffiliation. */
    Builder addHospitalAffiliation(Hospital value);

    /** Add a value to property hospitalAffiliation. */
    Builder addHospitalAffiliation(Hospital.Builder value);

    /** Add a value to property hospitalAffiliation. */
    Builder addHospitalAffiliation(String value);
    ...
    /** Add a value to property medicalSpecialty. */
    Builder addMedicalSpecialty(MedicalSpecialty value);

    /** Add a value to property medicalSpecialty. */
    Builder addMedicalSpecialty(String value);
    ...
    /** Build a {@link Physician} object. */
    Physician build();
  }

  /**
   * Returns the value list of property availableService. Empty list is returned if the property not
   * set in current object.
   */
  ImmutableList<SchemaOrgType> getAvailableServiceList();

  /**
   * Returns the value list of property hospitalAffiliation. Empty list is returned if the property
   * not set in current object.
   */
  ImmutableList<SchemaOrgType> getHospitalAffiliationList();

  /**
   * Returns the value list of property medicalSpecialty. Empty list is returned if the property not
   * set in current object.
   */
  ImmutableList<SchemaOrgType> getMedicalSpecialtyList();
}
