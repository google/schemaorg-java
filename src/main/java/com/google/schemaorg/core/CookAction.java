...
public interface CookAction extends CreateAction {
  ...
  public interface Builder extends CreateAction.Builder {
    ...
    /** Add a value to property foodEstablishment. */
    Builder addFoodEstablishment(FoodEstablishment value);

    /** Add a value to property foodEstablishment. */
    Builder addFoodEstablishment(FoodEstablishment.Builder value);

    /** Add a value to property foodEstablishment. */
    Builder addFoodEstablishment(Place value);

    /** Add a value to property foodEstablishment. */
    Builder addFoodEstablishment(Place.Builder value);

    /** Add a value to property foodEstablishment. */
    Builder addFoodEstablishment(String value);

    /** Add a value to property foodEvent. */
    Builder addFoodEvent(FoodEvent value);

    /** Add a value to property foodEvent. */
    Builder addFoodEvent(FoodEvent.Builder value);

    /** Add a value to property foodEvent. */
    Builder addFoodEvent(String value);
    ...
    /** Add a value to property recipe. */
    Builder addRecipe(Recipe value);

    /** Add a value to property recipe. */
    Builder addRecipe(Recipe.Builder value);

    /** Add a value to property recipe. */
    Builder addRecipe(String value);
    ...
    /** Build a {@link CookAction} object. */
    CookAction build();
  }

  /**
   * Returns the value list of property foodEstablishment. Empty list is returned if the property
   * not set in current object.
   */
  ImmutableList<SchemaOrgType> getFoodEstablishmentList();

  /**
   * Returns the value list of property foodEvent. Empty list is returned if the property not set in
   * current object.
   */
  ImmutableList<SchemaOrgType> getFoodEventList();

  /**
   * Returns the value list of property recipe. Empty list is returned if the property not set in
   * current object.
   */
  ImmutableList<SchemaOrgType> getRecipeList();
}
