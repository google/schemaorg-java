...
/** Interface of <a href="http://schema.org/ImagingTest">http://schema.org/ImagingTest</a>. */
public interface ImagingTest extends MedicalTest {

  /**
   * Builder interface of <a
   * href="http://schema.org/ImagingTest">http://schema.org/ImagingTest</a>.
   */
  public interface Builder extends MedicalTest.Builder {
    ...
    /** Add a value to property imagingTechnique. */
    Builder addImagingTechnique(MedicalImagingTechnique value);

    /** Add a value to property imagingTechnique. */
    Builder addImagingTechnique(String value);
    ...
    /** Build a {@link ImagingTest} object. */
    ImagingTest build();
  }

  /**
   * Returns the value list of property imagingTechnique. Empty list is returned if the property not
   * set in current object.
   */
  ImmutableList<SchemaOrgType> getImagingTechniqueList();
}
