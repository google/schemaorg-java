...
/** Interface of <a href="http://schema.org/ImageObject">http://schema.org/ImageObject</a>. */
public interface ImageObject extends MediaObject {

  /**
   * Builder interface of <a
   * href="http://schema.org/ImageObject">http://schema.org/ImageObject</a>.
   */
  public interface Builder extends MediaObject.Builder {
    ...
    /** Add a value to property exifData. */
    Builder addExifData(PropertyValue value);

    /** Add a value to property exifData. */
    Builder addExifData(PropertyValue.Builder value);

    /** Add a value to property exifData. */
    Builder addExifData(Text value);

    /** Add a value to property exifData. */
    Builder addExifData(String value);
    ...
    /** Add a value to property representativeOfPage. */
    Builder addRepresentativeOfPage(Boolean value);

    /** Add a value to property representativeOfPage. */
    Builder addRepresentativeOfPage(String value);
    ...
    /** Build a {@link ImageObject} object. */
    ImageObject build();
  }
  ...
  /**
   * Returns the value list of property exifData. Empty list is returned if the property not set in
   * current object.
   */
  ImmutableList<SchemaOrgType> getExifDataList();

  /**
   * Returns the value list of property representativeOfPage. Empty list is returned if the property
   * not set in current object.
   */
  ImmutableList<SchemaOrgType> getRepresentativeOfPageList();
