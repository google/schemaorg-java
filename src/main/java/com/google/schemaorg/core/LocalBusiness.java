...
public interface LocalBusiness extends LocalBusinessCivicStructureCommon, Organization {
  ...
  public interface Builder extends LocalBusinessCivicStructureCommon.Builder, Organization.Builder {
    ...
    /** Build a {@link LocalBusiness} object. */
    LocalBusiness build();
  }
  ...
  /**
   * Returns the value list of property branchOf. Empty list is returned if the property not set in
   * current object.
   */
  ImmutableList<SchemaOrgType> getBranchOfList();

  /**
   * Returns the value list of property currenciesAccepted. Empty list is returned if the property
   * not set in current object.
   */
  ImmutableList<SchemaOrgType> getCurrenciesAcceptedList();

  /**
   * Returns the value list of property paymentAccepted. Empty list is returned if the property not
   * set in current object.
   */
  ImmutableList<SchemaOrgType> getPaymentAcceptedList();

  /**
   * Returns the value list of property priceRange. Empty list is returned if the property not set
   * in current object.
   */
