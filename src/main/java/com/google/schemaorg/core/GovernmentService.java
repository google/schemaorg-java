...
public interface GovernmentService extends Service {
  ...
  public interface Builder extends Service.Builder {
    ...
    /** Add a value to property serviceOperator. */
    Builder addServiceOperator(Organization value);

    /** Add a value to property serviceOperator. */
    Builder addServiceOperator(Organization.Builder value);

    /** Add a value to property serviceOperator. */
    Builder addServiceOperator(String value);
    ...
    /** Build a {@link GovernmentService} object. */
    GovernmentService build();
  }

  /**
   * Returns the value list of property serviceOperator. Empty list is returned if the property not
   * set in current object.
   */
  ImmutableList<SchemaOrgType> getServiceOperatorList();
}
