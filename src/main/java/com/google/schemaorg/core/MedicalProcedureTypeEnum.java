...
/*
 * Enum values of <a href="http://schema.org/MedicalProcedureType">http://schema.org/MedicalProcedureType</a>.
 */
public enum MedicalProcedureTypeEnum implements MedicalProcedureType {
  NONINVASIVE_PROCEDURE(CoreConstants.NAMESPACE + "NoninvasiveProcedure"),

  PERCUTANEOUS_PROCEDURE(CoreConstants.NAMESPACE + "PercutaneousProcedure"),

  SURGICAL_PROCEDURE(CoreConstants.NAMESPACE + "SurgicalProcedure");
  ...
  public String getFullTypeName() {
    return CoreConstants.TYPE_MEDICAL_PROCEDURE_TYPE;
  }
