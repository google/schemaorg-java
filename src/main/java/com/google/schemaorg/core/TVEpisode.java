...
public interface TVEpisode extends Episode {
  ...
  public interface Builder extends Episode.Builder {
    ...
    /** Add a value to property countryOfOrigin. */
    Builder addCountryOfOrigin(Country value);

    /** Add a value to property countryOfOrigin. */
    Builder addCountryOfOrigin(Country.Builder value);

    /** Add a value to property countryOfOrigin. */
    Builder addCountryOfOrigin(String value);
    ...
    Builder addEpisodeNumber(Integer value);

    /** Add a value to property episodeNumber. */
    Builder addEpisodeNumber(Text value);

    /** Add a value to property episodeNumber. */
    Builder addEpisodeNumber(String value);
    ...
    /** Add a value to property partOfSeason. */
    Builder addPartOfSeason(CreativeWorkSeason value);

    /** Add a value to property partOfSeason. */
    Builder addPartOfSeason(CreativeWorkSeason.Builder value);

    /** Add a value to property partOfSeason. */
    Builder addPartOfSeason(String value);

    /** Add a value to property partOfSeries. */
    Builder addPartOfSeries(CreativeWorkSeries value);

    /** Add a value to property partOfSeries. */
    Builder addPartOfSeries(CreativeWorkSeries.Builder value);

    /** Add a value to property partOfSeries. */
    Builder addPartOfSeries(String value);

    /** Add a value to property partOfTVSeries. */
    Builder addPartOfTVSeries(TVSeries value);

    /** Add a value to property partOfTVSeries. */
    Builder addPartOfTVSeries(TVSeries.Builder value);

    /** Add a value to property partOfTVSeries. */
    Builder addPartOfTVSeries(String value);
    ...
    /** Add a value to property subtitleLanguage. */
    Builder addSubtitleLanguage(Language value);

    /** Add a value to property subtitleLanguage. */
    Builder addSubtitleLanguage(Language.Builder value);

    /** Add a value to property subtitleLanguage. */
    Builder addSubtitleLanguage(Text value);

    /** Add a value to property subtitleLanguage. */
    Builder addSubtitleLanguage(String value);
    ...
    /** Build a {@link TVEpisode} object. */
    TVEpisode build();
  }

  /**
   * Returns the value list of property countryOfOrigin. Empty list is returned if the property not
   * set in current object.
   */
  ImmutableList<SchemaOrgType> getCountryOfOriginList();

  /**
   * Returns the value list of property partOfTVSeries. Empty list is returned if the property not
   * set in current object.
   */
  ImmutableList<SchemaOrgType> getPartOfTVSeriesList();

  /**
   * Returns the value list of property subtitleLanguage. Empty list is returned if the property not
   * set in current object.
   */
  ImmutableList<SchemaOrgType> getSubtitleLanguageList();
}
