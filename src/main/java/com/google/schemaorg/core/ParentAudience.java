...
public interface ParentAudience extends PeopleAudience {
  ...
  public interface Builder extends PeopleAudience.Builder {
    ...
    /** Add a value to property childMaxAge. */
    Builder addChildMaxAge(Number value);

    /** Add a value to property childMaxAge. */
    Builder addChildMaxAge(String value);

    /** Add a value to property childMinAge. */
    Builder addChildMinAge(Number value);

    /** Add a value to property childMinAge. */
    Builder addChildMinAge(String value);
    ...
    /** Build a {@link ParentAudience} object. */
    ParentAudience build();
  }

  /**
   * Returns the value list of property childMaxAge. Empty list is returned if the property not set
   * in current object.
   */
  ImmutableList<SchemaOrgType> getChildMaxAgeList();

  /**
   * Returns the value list of property childMinAge. Empty list is returned if the property not set
   * in current object.
   */
  ImmutableList<SchemaOrgType> getChildMinAgeList();
}
