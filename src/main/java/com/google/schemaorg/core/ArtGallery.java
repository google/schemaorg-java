...
/** Interface of <a href="http://schema.org/ArtGallery">http://schema.org/ArtGallery</a>. */
public interface ArtGallery extends EntertainmentBusiness {

  /**
   * Builder interface of <a href="http://schema.org/ArtGallery">http://schema.org/ArtGallery</a>.
   */
  public interface Builder extends EntertainmentBusiness.Builder {
    ...
    /** Build a {@link ArtGallery} object. */
    ArtGallery build();
  }
}
