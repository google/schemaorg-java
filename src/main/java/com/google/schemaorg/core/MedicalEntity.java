...
/** Interface of <a href="http://schema.org/MedicalEntity">http://schema.org/MedicalEntity</a>. */
public interface MedicalEntity extends Thing {

  /**
   * Builder interface of <a
   * href="http://schema.org/MedicalEntity">http://schema.org/MedicalEntity</a>.
   */
  public interface Builder extends Thing.Builder {
    ...
    /** Build a {@link MedicalEntity} object. */
    MedicalEntity build();
  }

  /**
   * Returns the value list of property code. Empty list is returned if the property not set in
   * current object.
   */
  ImmutableList<SchemaOrgType> getCodeList();

  /**
   * Returns the value list of property guideline. Empty list is returned if the property not set in
   * current object.
   */
  ImmutableList<SchemaOrgType> getGuidelineList();

  /**
   * Returns the value list of property medicineSystem. Empty list is returned if the property not
   * set in current object.
   */
  ImmutableList<SchemaOrgType> getMedicineSystemList();

  /**
   * Returns the value list of property recognizingAuthority. Empty list is returned if the property
   * not set in current object.
   */
  ImmutableList<SchemaOrgType> getRecognizingAuthorityList();

  /**
   * Returns the value list of property relevantSpecialty. Empty list is returned if the property
   * not set in current object.
   */
  ImmutableList<SchemaOrgType> getRelevantSpecialtyList();

  /**
   * Returns the value list of property study. Empty list is returned if the property not set in
   * current object.
   */
  ImmutableList<SchemaOrgType> getStudyList();
}
