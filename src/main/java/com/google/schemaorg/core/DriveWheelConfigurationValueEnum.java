...
/*
 * Enum values of <a href="http://schema.org/DriveWheelConfigurationValue">http://schema.org/DriveWheelConfigurationValue</a>.
 */
public enum DriveWheelConfigurationValueEnum implements DriveWheelConfigurationValue {
  ALL_WHEEL_DRIVE_CONFIGURATION(CoreConstants.NAMESPACE + "AllWheelDriveConfiguration"),

  FOUR_WHEEL_DRIVE_CONFIGURATION(CoreConstants.NAMESPACE + "FourWheelDriveConfiguration"),

  FRONT_WHEEL_DRIVE_CONFIGURATION(CoreConstants.NAMESPACE + "FrontWheelDriveConfiguration"),

  REAR_WHEEL_DRIVE_CONFIGURATION(CoreConstants.NAMESPACE + "RearWheelDriveConfiguration");
  ...
  public String getFullTypeName() {
    return CoreConstants.TYPE_DRIVE_WHEEL_CONFIGURATION_VALUE;
  }
