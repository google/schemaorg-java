...
public interface PublicationEvent extends Event {
  ...
  public interface Builder extends Event.Builder {
    ...
    /** Build a {@link PublicationEvent} object. */
    PublicationEvent build();
  }

  /**
   * Returns the value list of property free. Empty list is returned if the property not set in
   * current object.
   */
  ImmutableList<SchemaOrgType> getFreeList();

  /**
   * Returns the value list of property isAccessibleForFree. Empty list is returned if the property
   * not set in current object.
   */
  ImmutableList<SchemaOrgType> getIsAccessibleForFreeList();

  /**
   * Returns the value list of property publishedOn. Empty list is returned if the property not set
   * in current object.
   */
  ImmutableList<SchemaOrgType> getPublishedOnList();
}
