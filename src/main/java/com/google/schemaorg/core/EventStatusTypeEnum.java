...
/*
 * Enum values of <a href="http://schema.org/EventStatusType">http://schema.org/EventStatusType</a>.
 */
public enum EventStatusTypeEnum implements EventStatusType {
  EVENT_CANCELLED(CoreConstants.NAMESPACE + "EventCancelled"),

  EVENT_POSTPONED(CoreConstants.NAMESPACE + "EventPostponed"),

  EVENT_RESCHEDULED(CoreConstants.NAMESPACE + "EventRescheduled"),

  EVENT_SCHEDULED(CoreConstants.NAMESPACE + "EventScheduled");
  ...
  public String getFullTypeName() {
    return CoreConstants.TYPE_EVENT_STATUS_TYPE;
  }
