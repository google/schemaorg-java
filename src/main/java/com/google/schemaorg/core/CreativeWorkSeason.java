...
public interface CreativeWorkSeason extends CreativeWork {
  ...
  public interface Builder extends CreativeWork.Builder {
    ...
    /** Build a {@link CreativeWorkSeason} object. */
    CreativeWorkSeason build();
  }
  ...
  /**
   * Returns the value list of property seasonNumber. Empty list is returned if the property not set
   * in current object.
   */
  ImmutableList<SchemaOrgType> getSeasonNumberList();
