...
public interface DeliveryEvent extends Event {
  ...
  public interface Builder extends Event.Builder {
    ...
    /** Add a value to property accessCode. */
    Builder addAccessCode(Text value);

    /** Add a value to property accessCode. */
    Builder addAccessCode(String value);
    ...
    /** Add a value to property availableFrom. */
    Builder addAvailableFrom(DateTime value);

    /** Add a value to property availableFrom. */
    Builder addAvailableFrom(String value);

    /** Add a value to property availableThrough. */
    Builder addAvailableThrough(DateTime value);

    /** Add a value to property availableThrough. */
    Builder addAvailableThrough(String value);
    ...
    /** Build a {@link DeliveryEvent} object. */
    DeliveryEvent build();
  }

  /**
   * Returns the value list of property accessCode. Empty list is returned if the property not set
   * in current object.
   */
  ImmutableList<SchemaOrgType> getAccessCodeList();

  /**
   * Returns the value list of property availableFrom. Empty list is returned if the property not
   * set in current object.
   */
  ImmutableList<SchemaOrgType> getAvailableFromList();

  /**
   * Returns the value list of property availableThrough. Empty list is returned if the property not
   * set in current object.
   */
  ImmutableList<SchemaOrgType> getAvailableThroughList();
