...
/**
 * Interface of <a
 * href="http://schema.org/OrganizationRole">http://schema.org/OrganizationRole</a>.
 */
public interface OrganizationRole extends Role {
  ...
  public interface Builder extends Role.Builder {
    ...
    /** Build a {@link OrganizationRole} object. */
    OrganizationRole build();
  }

  /**
   * Returns the value list of property numberedPosition. Empty list is returned if the property not
   * set in current object.
   */
  ImmutableList<SchemaOrgType> getNumberedPositionList();
}
