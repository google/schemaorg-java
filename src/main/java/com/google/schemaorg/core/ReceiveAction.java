...
/** Interface of <a href="http://schema.org/ReceiveAction">http://schema.org/ReceiveAction</a>. */
public interface ReceiveAction extends TransferAction {

  /**
   * Builder interface of <a
   * href="http://schema.org/ReceiveAction">http://schema.org/ReceiveAction</a>.
   */
  public interface Builder extends TransferAction.Builder {
    ...
    /** Add a value to property deliveryMethod. */
    Builder addDeliveryMethod(DeliveryMethod value);

    /** Add a value to property deliveryMethod. */
    Builder addDeliveryMethod(String value);
    ...
    /** Add a value to property sender. */
    Builder addSender(Audience value);

    /** Add a value to property sender. */
    Builder addSender(Audience.Builder value);

    /** Add a value to property sender. */
    Builder addSender(Organization value);

    /** Add a value to property sender. */
    Builder addSender(Organization.Builder value);

    /** Add a value to property sender. */
    Builder addSender(Person value);

    /** Add a value to property sender. */
    Builder addSender(Person.Builder value);

    /** Add a value to property sender. */
    Builder addSender(String value);
    ...
    /** Build a {@link ReceiveAction} object. */
    ReceiveAction build();
  }

  /**
   * Returns the value list of property deliveryMethod. Empty list is returned if the property not
   * set in current object.
   */
  ImmutableList<SchemaOrgType> getDeliveryMethodList();

  /**
   * Returns the value list of property sender. Empty list is returned if the property not set in
   * current object.
   */
  ImmutableList<SchemaOrgType> getSenderList();
}
