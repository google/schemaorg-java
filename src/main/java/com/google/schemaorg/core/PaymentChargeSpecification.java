...
/**
 * Interface of <a
 * href="http://schema.org/PaymentChargeSpecification">http://schema.org/PaymentChargeSpecification</a>.
 */
public interface PaymentChargeSpecification extends PriceSpecification {
  ...
  public interface Builder extends PriceSpecification.Builder {
    ...
    /** Add a value to property appliesToPaymentMethod. */
    Builder addAppliesToPaymentMethod(PaymentMethod value);

    /** Add a value to property appliesToPaymentMethod. */
    Builder addAppliesToPaymentMethod(String value);
    ...
    /** Build a {@link PaymentChargeSpecification} object. */
    PaymentChargeSpecification build();
  }
  ...
  /**
   * Returns the value list of property appliesToPaymentMethod. Empty list is returned if the
   * property not set in current object.
   */
  ImmutableList<SchemaOrgType> getAppliesToPaymentMethodList();
}
