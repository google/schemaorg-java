...
/*
 * Enum values of <a href="http://schema.org/OfferItemCondition">http://schema.org/OfferItemCondition</a>.
 */
public enum OfferItemConditionEnum implements OfferItemCondition {
  DAMAGED_CONDITION(CoreConstants.NAMESPACE + "DamagedCondition"),

  NEW_CONDITION(CoreConstants.NAMESPACE + "NewCondition"),

  REFURBISHED_CONDITION(CoreConstants.NAMESPACE + "RefurbishedCondition"),

  USED_CONDITION(CoreConstants.NAMESPACE + "UsedCondition");
  ...
  public String getFullTypeName() {
    return CoreConstants.TYPE_OFFER_ITEM_CONDITION;
  }
