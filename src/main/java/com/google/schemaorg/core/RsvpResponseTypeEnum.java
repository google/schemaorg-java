...
/*
 * Enum values of <a href="http://schema.org/RsvpResponseType">http://schema.org/RsvpResponseType</a>.
 */
public enum RsvpResponseTypeEnum implements RsvpResponseType {
  RSVP_RESPONSE_MAYBE(CoreConstants.NAMESPACE + "RsvpResponseMaybe"),

  RSVP_RESPONSE_NO(CoreConstants.NAMESPACE + "RsvpResponseNo"),

  RSVP_RESPONSE_YES(CoreConstants.NAMESPACE + "RsvpResponseYes");
  ...
  public String getFullTypeName() {
    return CoreConstants.TYPE_RSVP_RESPONSE_TYPE;
  }
