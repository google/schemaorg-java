...
/*
 * Enum values of <a href="http://schema.org/PhysicalActivityCategory">http://schema.org/PhysicalActivityCategory</a>.
 */
public enum PhysicalActivityCategoryEnum implements PhysicalActivityCategory {
  AEROBIC_ACTIVITY(CoreConstants.NAMESPACE + "AerobicActivity"),

  ANAEROBIC_ACTIVITY(CoreConstants.NAMESPACE + "AnaerobicActivity"),

  BALANCE(CoreConstants.NAMESPACE + "Balance"),

  FLEXIBILITY(CoreConstants.NAMESPACE + "Flexibility"),

  LEISURE_TIME_ACTIVITY(CoreConstants.NAMESPACE + "LeisureTimeActivity"),

  OCCUPATIONAL_ACTIVITY(CoreConstants.NAMESPACE + "OccupationalActivity"),

  STRENGTH_TRAINING(CoreConstants.NAMESPACE + "StrengthTraining");
  ...
  public String getFullTypeName() {
    return CoreConstants.TYPE_PHYSICAL_ACTIVITY_CATEGORY;
  }
