...
/*
 * Enum values of <a href="http://schema.org/MedicalEvidenceLevel">http://schema.org/MedicalEvidenceLevel</a>.
 */
public enum MedicalEvidenceLevelEnum implements MedicalEvidenceLevel {
  EVIDENCE_LEVEL_A(CoreConstants.NAMESPACE + "EvidenceLevelA"),

  EVIDENCE_LEVEL_B(CoreConstants.NAMESPACE + "EvidenceLevelB"),

  EVIDENCE_LEVEL_C(CoreConstants.NAMESPACE + "EvidenceLevelC");
  ...
  public String getFullTypeName() {
    return CoreConstants.TYPE_MEDICAL_EVIDENCE_LEVEL;
  }
