...
/** Interface of <a href="http://schema.org/ReplaceAction">http://schema.org/ReplaceAction</a>. */
public interface ReplaceAction extends UpdateAction {

  /**
   * Builder interface of <a
   * href="http://schema.org/ReplaceAction">http://schema.org/ReplaceAction</a>.
   */
  public interface Builder extends UpdateAction.Builder {
    ...
    /** Add a value to property collection. */
    Builder addCollection(Thing value);

    /** Add a value to property collection. */
    Builder addCollection(Thing.Builder value);

    /** Add a value to property collection. */
    Builder addCollection(String value);
    ...
    /** Add a value to property replacee. */
    Builder addReplacee(Thing value);

    /** Add a value to property replacee. */
    Builder addReplacee(Thing.Builder value);

    /** Add a value to property replacee. */
    Builder addReplacee(String value);

    /** Add a value to property replacer. */
    Builder addReplacer(Thing value);

    /** Add a value to property replacer. */
    Builder addReplacer(Thing.Builder value);

    /** Add a value to property replacer. */
    Builder addReplacer(String value);
    ...
    /** Add a value to property targetCollection. */
    Builder addTargetCollection(Thing value);

    /** Add a value to property targetCollection. */
    Builder addTargetCollection(Thing.Builder value);

    /** Add a value to property targetCollection. */
    Builder addTargetCollection(String value);
    ...
    /** Build a {@link ReplaceAction} object. */
    ReplaceAction build();
  }

  /**
   * Returns the value list of property replacee. Empty list is returned if the property not set in
   * current object.
   */
  ImmutableList<SchemaOrgType> getReplaceeList();

  /**
   * Returns the value list of property replacer. Empty list is returned if the property not set in
   * current object.
   */
  ImmutableList<SchemaOrgType> getReplacerList();
}
