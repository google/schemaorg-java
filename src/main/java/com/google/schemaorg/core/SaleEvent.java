...
/** Interface of <a href="http://schema.org/SaleEvent}">http://schema.org/SaleEvent}</a>. */
public interface SaleEvent extends Event {

  /**
   * Builder interface of <a href="http://schema.org/SaleEvent}">http://schema.org/SaleEvent}</a>.
   */
