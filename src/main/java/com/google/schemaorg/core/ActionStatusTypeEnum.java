...
/*
 * Enum values of <a href="http://schema.org/ActionStatusType">http://schema.org/ActionStatusType</a>.
 */
public enum ActionStatusTypeEnum implements ActionStatusType {
  ACTIVE_ACTION_STATUS(CoreConstants.NAMESPACE + "ActiveActionStatus"),

  COMPLETED_ACTION_STATUS(CoreConstants.NAMESPACE + "CompletedActionStatus"),

  FAILED_ACTION_STATUS(CoreConstants.NAMESPACE + "FailedActionStatus"),

  POTENTIAL_ACTION_STATUS(CoreConstants.NAMESPACE + "PotentialActionStatus");
  ...
  public String getFullTypeName() {
    return CoreConstants.TYPE_ACTION_STATUS_TYPE;
  }
