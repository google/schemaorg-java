...
/**
 * Interface of <a href="http://schema.org/TaxiReservation">http://schema.org/TaxiReservation</a>.
 */
public interface TaxiReservation extends Reservation {

  /**
   * Builder interface of <a
   * href="http://schema.org/TaxiReservation">http://schema.org/TaxiReservation</a>.
   */
  public interface Builder extends Reservation.Builder {
    ...
    /** Add a value to property partySize. */
    Builder addPartySize(Integer value);

    /** Add a value to property partySize. */
    Builder addPartySize(QuantitativeValue value);

    /** Add a value to property partySize. */
    Builder addPartySize(QuantitativeValue.Builder value);

    /** Add a value to property partySize. */
    Builder addPartySize(String value);
    ...
    /** Build a {@link TaxiReservation} object. */
    TaxiReservation build();
  }

  /**
   * Returns the value list of property partySize. Empty list is returned if the property not set in
   * current object.
   */
  ImmutableList<SchemaOrgType> getPartySizeList();
