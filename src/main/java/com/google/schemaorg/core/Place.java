...
public interface Place extends PlaceOrganizationCommon {
  ...
  /**
   * Returns the value list of property branchCode. Empty list is returned if the property not set
   * in current object.
   */
  ImmutableList<SchemaOrgType> getBranchCodeList();

  /**
   * Returns the value list of property containedIn. Empty list is returned if the property not set
   * in current object.
   */
  ImmutableList<SchemaOrgType> getContainedInList();

  /**
   * Returns the value list of property containedInPlace. Empty list is returned if the property not
   * set in current object.
   */
  ImmutableList<SchemaOrgType> getContainedInPlaceList();

  /**
   * Returns the value list of property containsPlace. Empty list is returned if the property not
   * set in current object.
   */
  ImmutableList<SchemaOrgType> getContainsPlaceList();

  /**
   * Returns the value list of property geo. Empty list is returned if the property not set in
   * current object.
   */
  ImmutableList<SchemaOrgType> getGeoList();

  /**
   * Returns the value list of property hasMap. Empty list is returned if the property not set in
   * current object.
   */
  ImmutableList<SchemaOrgType> getHasMapList();

  /**
   * Returns the value list of property map. Empty list is returned if the property not set in
   * current object.
   */
  ImmutableList<SchemaOrgType> getMapList();

  /**
   * Returns the value list of property maps. Empty list is returned if the property not set in
   * current object.
   */
  ImmutableList<SchemaOrgType> getMapsList();

  /**
   * Returns the value list of property openingHoursSpecification. Empty list is returned if the
   * property not set in current object.
   */
  ImmutableList<SchemaOrgType> getOpeningHoursSpecificationList();

  /**
   * Returns the value list of property photo. Empty list is returned if the property not set in
   * current object.
   */
  ImmutableList<SchemaOrgType> getPhotoList();

  /**
   * Returns the value list of property photos. Empty list is returned if the property not set in
   * current object.
   */
  ImmutableList<SchemaOrgType> getPhotosList();
}
