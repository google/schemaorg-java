...
/** Interface of <a href="http://schema.org/DiagnosticLab">http://schema.org/DiagnosticLab</a>. */
public interface DiagnosticLab extends MedicalOrganization {

  /**
   * Builder interface of <a
   * href="http://schema.org/DiagnosticLab">http://schema.org/DiagnosticLab</a>.
   */
  public interface Builder extends MedicalOrganization.Builder {
    ...
    /** Add a value to property availableTest. */
    Builder addAvailableTest(MedicalTest value);

    /** Add a value to property availableTest. */
    Builder addAvailableTest(MedicalTest.Builder value);

    /** Add a value to property availableTest. */
    Builder addAvailableTest(String value);
    ...
    /** Build a {@link DiagnosticLab} object. */
    DiagnosticLab build();
  }

  /**
   * Returns the value list of property availableTest. Empty list is returned if the property not
   * set in current object.
   */
  ImmutableList<SchemaOrgType> getAvailableTestList();
}
