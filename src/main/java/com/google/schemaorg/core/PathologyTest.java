...
/** Interface of <a href="http://schema.org/PathologyTest">http://schema.org/PathologyTest</a>. */
public interface PathologyTest extends MedicalTest {

  /**
   * Builder interface of <a
   * href="http://schema.org/PathologyTest">http://schema.org/PathologyTest</a>.
   */
  public interface Builder extends MedicalTest.Builder {
    ...
    /** Add a value to property tissueSample. */
    Builder addTissueSample(Text value);

    /** Add a value to property tissueSample. */
    Builder addTissueSample(String value);
    ...
    /** Build a {@link PathologyTest} object. */
    PathologyTest build();
  }

  /**
   * Returns the value list of property tissueSample. Empty list is returned if the property not set
   * in current object.
   */
  ImmutableList<SchemaOrgType> getTissueSampleList();
}
