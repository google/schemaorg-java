...
/** Interface of <a href="http://schema.org/Muscle">http://schema.org/Muscle</a>. */
public interface Muscle extends AnatomicalStructure {

  /** Builder interface of <a href="http://schema.org/Muscle">http://schema.org/Muscle</a>. */
  public interface Builder extends AnatomicalStructure.Builder {
    ...
    /** Add a value to property action. */
    Builder addAction(Text value);

    /** Add a value to property action. */
    Builder addAction(String value);
    ...
    /** Add a value to property antagonist. */
    Builder addAntagonist(Muscle value);

    /** Add a value to property antagonist. */
    Builder addAntagonist(Muscle.Builder value);

    /** Add a value to property antagonist. */
    Builder addAntagonist(String value);
    ...
    /** Add a value to property bloodSupply. */
    Builder addBloodSupply(Vessel value);

    /** Add a value to property bloodSupply. */
    Builder addBloodSupply(Vessel.Builder value);

    /** Add a value to property bloodSupply. */
    Builder addBloodSupply(String value);
    ...
    /** Add a value to property insertion. */
    Builder addInsertion(AnatomicalStructure value);

    /** Add a value to property insertion. */
    Builder addInsertion(AnatomicalStructure.Builder value);

    /** Add a value to property insertion. */
    Builder addInsertion(String value);
    ...
    /** Add a value to property muscleAction. */
    Builder addMuscleAction(Text value);

    /** Add a value to property muscleAction. */
    Builder addMuscleAction(String value);
    ...
    /** Add a value to property nerve. */
    Builder addNerve(Nerve value);

    /** Add a value to property nerve. */
    Builder addNerve(Nerve.Builder value);

    /** Add a value to property nerve. */
    Builder addNerve(String value);

    /** Add a value to property origin. */
    Builder addOrigin(AnatomicalStructure value);

    /** Add a value to property origin. */
    Builder addOrigin(AnatomicalStructure.Builder value);

    /** Add a value to property origin. */
    Builder addOrigin(String value);
    ...
    /** Build a {@link Muscle} object. */
    Muscle build();
  }

  /**
   * Returns the value list of property action. Empty list is returned if the property not set in
   * current object.
   */
  ImmutableList<SchemaOrgType> getActionList();

  /**
   * Returns the value list of property antagonist. Empty list is returned if the property not set
   * in current object.
   */
  ImmutableList<SchemaOrgType> getAntagonistList();

  /**
   * Returns the value list of property bloodSupply. Empty list is returned if the property not set
   * in current object.
   */
  ImmutableList<SchemaOrgType> getBloodSupplyList();

  /**
   * Returns the value list of property insertion. Empty list is returned if the property not set in
   * current object.
   */
  ImmutableList<SchemaOrgType> getInsertionList();

  /**
   * Returns the value list of property muscleAction. Empty list is returned if the property not set
   * in current object.
   */
  ImmutableList<SchemaOrgType> getMuscleActionList();

  /**
   * Returns the value list of property nerve. Empty list is returned if the property not set in
   * current object.
   */
  ImmutableList<SchemaOrgType> getNerveList();

  /**
   * Returns the value list of property origin. Empty list is returned if the property not set in
   * current object.
   */
  ImmutableList<SchemaOrgType> getOriginList();
}
