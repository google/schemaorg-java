...
public interface VisualArtwork extends CreativeWork {
  ...
  public interface Builder extends CreativeWork.Builder {
    ...
    /** Add a value to property artEdition. */
    Builder addArtEdition(Integer value);

    /** Add a value to property artEdition. */
    Builder addArtEdition(Text value);

    /** Add a value to property artEdition. */
    Builder addArtEdition(String value);

    /** Add a value to property artform. */
    Builder addArtform(Text value);

    /** Add a value to property artform. */
    Builder addArtform(URL value);

    /** Add a value to property artform. */
    Builder addArtform(String value);

    /** Add a value to property artMedium. */
    Builder addArtMedium(Text value);

    /** Add a value to property artMedium. */
    Builder addArtMedium(URL value);

    /** Add a value to property artMedium. */
    Builder addArtMedium(String value);

    /** Add a value to property artworkSurface. */
    Builder addArtworkSurface(Text value);

    /** Add a value to property artworkSurface. */
    Builder addArtworkSurface(URL value);

    /** Add a value to property artworkSurface. */
    Builder addArtworkSurface(String value);
    ...
    /** Add a value to property material. */
    Builder addMaterial(Text value);

    /** Add a value to property material. */
    Builder addMaterial(URL value);

    /** Add a value to property material. */
    Builder addMaterial(String value);
    ...
    /** Add a value to property surface. */
    Builder addSurface(Text value);

    /** Add a value to property surface. */
    Builder addSurface(URL value);

    /** Add a value to property surface. */
    Builder addSurface(String value);
    ...
    /** Build a {@link VisualArtwork} object. */
    VisualArtwork build();
  }

  /**
   * Returns the value list of property artEdition. Empty list is returned if the property not set
   * in current object.
   */
  ImmutableList<SchemaOrgType> getArtEditionList();

  /**
   * Returns the value list of property artform. Empty list is returned if the property not set in
   * current object.
   */
  ImmutableList<SchemaOrgType> getArtformList();

  /**
   * Returns the value list of property artMedium. Empty list is returned if the property not set in
   * current object.
   */
  ImmutableList<SchemaOrgType> getArtMediumList();

  /**
   * Returns the value list of property artworkSurface. Empty list is returned if the property not
   * set in current object.
   */
  ImmutableList<SchemaOrgType> getArtworkSurfaceList();
  ...
  /**
   * Returns the value list of property material. Empty list is returned if the property not set in
   * current object.
   */
  ImmutableList<SchemaOrgType> getMaterialList();

  /**
   * Returns the value list of property surface. Empty list is returned if the property not set in
   * current object.
   */
  ImmutableList<SchemaOrgType> getSurfaceList();
