...
/** Interface of <a href="http://schema.org/ExercisePlan">http://schema.org/ExercisePlan</a>. */
public interface ExercisePlan extends CreativeWork, PhysicalActivity {

  /**
   * Builder interface of <a
   * href="http://schema.org/ExercisePlan">http://schema.org/ExercisePlan</a>.
   */
  public interface Builder extends CreativeWork.Builder, PhysicalActivity.Builder {
    ...
    /** Add a value to property activityDuration. */
    Builder addActivityDuration(Duration value);

    /** Add a value to property activityDuration. */
    Builder addActivityDuration(Duration.Builder value);

    /** Add a value to property activityDuration. */
    Builder addActivityDuration(String value);

    /** Add a value to property activityFrequency. */
    Builder addActivityFrequency(Text value);

    /** Add a value to property activityFrequency. */
    Builder addActivityFrequency(String value);
    ...
    /** Add a value to property additionalVariable. */
    Builder addAdditionalVariable(Text value);

    /** Add a value to property additionalVariable. */
    Builder addAdditionalVariable(String value);
    ...
    /** Add a value to property intensity. */
    Builder addIntensity(Text value);

    /** Add a value to property intensity. */
    Builder addIntensity(String value);
    ...
    /** Add a value to property repetitions. */
    Builder addRepetitions(Number value);

    /** Add a value to property repetitions. */
    Builder addRepetitions(String value);

    /** Add a value to property restPeriods. */
    Builder addRestPeriods(Text value);

    /** Add a value to property restPeriods. */
    Builder addRestPeriods(String value);
    ...
    /** Add a value to property workload. */
    Builder addWorkload(Energy value);

    /** Add a value to property workload. */
    Builder addWorkload(Energy.Builder value);

    /** Add a value to property workload. */
    Builder addWorkload(String value);
    ...
    /** Build a {@link ExercisePlan} object. */
    ExercisePlan build();
  }

  /**
   * Returns the value list of property activityDuration. Empty list is returned if the property not
   * set in current object.
   */
  ImmutableList<SchemaOrgType> getActivityDurationList();

  /**
   * Returns the value list of property activityFrequency. Empty list is returned if the property
   * not set in current object.
   */
  ImmutableList<SchemaOrgType> getActivityFrequencyList();

  /**
   * Returns the value list of property additionalVariable. Empty list is returned if the property
   * not set in current object.
   */
  ImmutableList<SchemaOrgType> getAdditionalVariableList();
  ...
  /**
   * Returns the value list of property intensity. Empty list is returned if the property not set in
   * current object.
   */
  ImmutableList<SchemaOrgType> getIntensityList();

  /**
   * Returns the value list of property repetitions. Empty list is returned if the property not set
   * in current object.
   */
  ImmutableList<SchemaOrgType> getRepetitionsList();

  /**
   * Returns the value list of property restPeriods. Empty list is returned if the property not set
   * in current object.
   */
  ImmutableList<SchemaOrgType> getRestPeriodsList();

  /**
   * Returns the value list of property workload. Empty list is returned if the property not set in
   * current object.
   */
  ImmutableList<SchemaOrgType> getWorkloadList();
}
