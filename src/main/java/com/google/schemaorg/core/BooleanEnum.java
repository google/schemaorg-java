...
/*
 * Enum values of <a href="http://schema.org/Boolean">http://schema.org/Boolean</a>.
 */
public enum BooleanEnum implements Boolean {
  FALSE(CoreConstants.NAMESPACE + "False"),

  TRUE(CoreConstants.NAMESPACE + "True");

  private final String enumValue;

  BooleanEnum(String enumValue) {
  ...
  public String getFullTypeName() {
    return CoreConstants.TYPE_BOOLEAN;
  }
