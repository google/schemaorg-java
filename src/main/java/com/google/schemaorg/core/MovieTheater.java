...
/** Interface of <a href="http://schema.org/MovieTheater">http://schema.org/MovieTheater</a>. */
public interface MovieTheater extends CivicStructure, EntertainmentBusiness {

  /**
   * Builder interface of <a
   * href="http://schema.org/MovieTheater">http://schema.org/MovieTheater</a>.
   */
  public interface Builder extends CivicStructure.Builder, EntertainmentBusiness.Builder {
    ...
    /** Add a value to property screenCount. */
    Builder addScreenCount(Number value);

    /** Add a value to property screenCount. */
    Builder addScreenCount(String value);
    ...
    /** Build a {@link MovieTheater} object. */
    MovieTheater build();
  }

  /**
   * Returns the value list of property screenCount. Empty list is returned if the property not set
   * in current object.
   */
  ImmutableList<SchemaOrgType> getScreenCountList();
}
