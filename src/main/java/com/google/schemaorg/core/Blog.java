...
/** Interface of <a href="http://schema.org/Blog">http://schema.org/Blog</a>. */
public interface Blog extends CreativeWork {

  /** Builder interface of <a href="http://schema.org/Blog">http://schema.org/Blog</a>. */
  public interface Builder extends CreativeWork.Builder {
    ...
    /** Add a value to property blogPost. */
    Builder addBlogPost(BlogPosting value);

    /** Add a value to property blogPost. */
    Builder addBlogPost(BlogPosting.Builder value);

    /** Add a value to property blogPost. */
    Builder addBlogPost(String value);

    /** Add a value to property blogPosts. */
    Builder addBlogPosts(BlogPosting value);

    /** Add a value to property blogPosts. */
    Builder addBlogPosts(BlogPosting.Builder value);

    /** Add a value to property blogPosts. */
    Builder addBlogPosts(String value);
    ...
    /** Build a {@link Blog} object. */
    Blog build();
  }

  /**
   * Returns the value list of property blogPost. Empty list is returned if the property not set in
   * current object.
   */
  ImmutableList<SchemaOrgType> getBlogPostList();

  /**
   * Returns the value list of property blogPosts. Empty list is returned if the property not set in
   * current object.
   */
  ImmutableList<SchemaOrgType> getBlogPostsList();
}
