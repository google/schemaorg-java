...
/** Interface of <a href="http://schema.org/PropertyValue">http://schema.org/PropertyValue</a>. */
public interface PropertyValue extends StructuredValue {

  /**
   * Builder interface of <a
   * href="http://schema.org/PropertyValue">http://schema.org/PropertyValue</a>.
   */
  public interface Builder extends StructuredValue.Builder {
    ...
    /** Add a value to property propertyID. */
    Builder addPropertyID(Text value);

    /** Add a value to property propertyID. */
    Builder addPropertyID(URL value);

    /** Add a value to property propertyID. */
    Builder addPropertyID(String value);
    ...
    /** Build a {@link PropertyValue} object. */
    PropertyValue build();
  }
  ...
  /**
   * Returns the value list of property propertyID. Empty list is returned if the property not set
   * in current object.
   */
  ImmutableList<SchemaOrgType> getPropertyIDList();
