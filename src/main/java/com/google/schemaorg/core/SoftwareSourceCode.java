...
public interface SoftwareSourceCode extends CreativeWork {
  ...
  public interface Builder extends CreativeWork.Builder {
    ...
    /** Add a value to property codeRepository. */
    Builder addCodeRepository(URL value);

    /** Add a value to property codeRepository. */
    Builder addCodeRepository(String value);

    /** Add a value to property codeSampleType. */
    Builder addCodeSampleType(Text value);

    /** Add a value to property codeSampleType. */
    Builder addCodeSampleType(String value);
    ...
    /** Add a value to property programmingLanguage. */
    Builder addProgrammingLanguage(Language value);

    /** Add a value to property programmingLanguage. */
    Builder addProgrammingLanguage(Language.Builder value);

    /** Add a value to property programmingLanguage. */
    Builder addProgrammingLanguage(String value);
    ...
    /** Add a value to property runtime. */
    Builder addRuntime(Text value);

    /** Add a value to property runtime. */
    Builder addRuntime(String value);

    /** Add a value to property runtimePlatform. */
    Builder addRuntimePlatform(Text value);

    /** Add a value to property runtimePlatform. */
    Builder addRuntimePlatform(String value);
    ...
    /** Add a value to property sampleType. */
    Builder addSampleType(Text value);

    /** Add a value to property sampleType. */
    Builder addSampleType(String value);
    ...
    /** Add a value to property targetProduct. */
    Builder addTargetProduct(SoftwareApplication value);

    /** Add a value to property targetProduct. */
    Builder addTargetProduct(SoftwareApplication.Builder value);

    /** Add a value to property targetProduct. */
    Builder addTargetProduct(String value);
    ...
    /** Build a {@link SoftwareSourceCode} object. */
    SoftwareSourceCode build();
  }

  /**
   * Returns the value list of property codeRepository. Empty list is returned if the property not
   * set in current object.
   */
  ImmutableList<SchemaOrgType> getCodeRepositoryList();

  /**
   * Returns the value list of property codeSampleType. Empty list is returned if the property not
   * set in current object.
   */
  ImmutableList<SchemaOrgType> getCodeSampleTypeList();

  /**
   * Returns the value list of property programmingLanguage. Empty list is returned if the property
   * not set in current object.
   */
  ImmutableList<SchemaOrgType> getProgrammingLanguageList();

  /**
   * Returns the value list of property runtime. Empty list is returned if the property not set in
   * current object.
   */
  ImmutableList<SchemaOrgType> getRuntimeList();

  /**
   * Returns the value list of property runtimePlatform. Empty list is returned if the property not
   * set in current object.
   */
  ImmutableList<SchemaOrgType> getRuntimePlatformList();

  /**
   * Returns the value list of property sampleType. Empty list is returned if the property not set
   * in current object.
   */
  ImmutableList<SchemaOrgType> getSampleTypeList();

  /**
   * Returns the value list of property targetProduct. Empty list is returned if the property not
   * set in current object.
   */
  ImmutableList<SchemaOrgType> getTargetProductList();
}
