...
/** Interface of <a href="http://schema.org/Permit">http://schema.org/Permit</a>. */
public interface Permit extends Intangible {

  /** Builder interface of <a href="http://schema.org/Permit">http://schema.org/Permit</a>. */
  ...
  /**
   * Returns the value list of property issuedThrough. Empty list is returned if the property not
   * set in current object.
   */
  ImmutableList<SchemaOrgType> getIssuedThroughList();

  /**
   * Returns the value list of property permitAudience. Empty list is returned if the property not
   * set in current object.
   */
  ImmutableList<SchemaOrgType> getPermitAudienceList();

  /**
   * Returns the value list of property validFor. Empty list is returned if the property not set in
   * current object.
   */
  ImmutableList<SchemaOrgType> getValidForList();
  ...
  /**
   * Returns the value list of property validIn. Empty list is returned if the property not set in
   * current object.
   */
  ImmutableList<SchemaOrgType> getValidInList();

  /**
   * Returns the value list of property validUntil. Empty list is returned if the property not set
   * in current object.
   */
  ImmutableList<SchemaOrgType> getValidUntilList();
}
