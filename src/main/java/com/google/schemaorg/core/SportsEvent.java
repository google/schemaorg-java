...
public interface SportsEvent extends Event {
  ...
  public interface Builder extends Event.Builder {
    ...
    /** Add a value to property awayTeam. */
    Builder addAwayTeam(Person value);

    /** Add a value to property awayTeam. */
    Builder addAwayTeam(Person.Builder value);

    /** Add a value to property awayTeam. */
    Builder addAwayTeam(SportsTeam value);

    /** Add a value to property awayTeam. */
    Builder addAwayTeam(SportsTeam.Builder value);

    /** Add a value to property awayTeam. */
    Builder addAwayTeam(String value);

    /** Add a value to property competitor. */
    Builder addCompetitor(Person value);

    /** Add a value to property competitor. */
    Builder addCompetitor(Person.Builder value);

    /** Add a value to property competitor. */
    Builder addCompetitor(SportsTeam value);

    /** Add a value to property competitor. */
    Builder addCompetitor(SportsTeam.Builder value);

    /** Add a value to property competitor. */
    Builder addCompetitor(String value);
    ...
    /** Add a value to property homeTeam. */
    Builder addHomeTeam(Person value);

    /** Add a value to property homeTeam. */
    Builder addHomeTeam(Person.Builder value);

    /** Add a value to property homeTeam. */
    Builder addHomeTeam(SportsTeam value);

    /** Add a value to property homeTeam. */
    Builder addHomeTeam(SportsTeam.Builder value);

    /** Add a value to property homeTeam. */
    Builder addHomeTeam(String value);
    ...
    /** Build a {@link SportsEvent} object. */
    SportsEvent build();
  }

  /**
   * Returns the value list of property awayTeam. Empty list is returned if the property not set in
   * current object.
   */
  ImmutableList<SchemaOrgType> getAwayTeamList();

  /**
   * Returns the value list of property competitor. Empty list is returned if the property not set
   * in current object.
   */
  ImmutableList<SchemaOrgType> getCompetitorList();

  /**
   * Returns the value list of property homeTeam. Empty list is returned if the property not set in
   * current object.
   */
  ImmutableList<SchemaOrgType> getHomeTeamList();
}
