...
/**
 * Interface of <a
 * href="http://schema.org/CommunicateAction">http://schema.org/CommunicateAction</a>.
 */
public interface CommunicateAction extends InteractAction {
  ...
  public interface Builder extends InteractAction.Builder {
    ...
    /** Build a {@link CommunicateAction} object. */
    CommunicateAction build();
  }
  ...
  /**
   * Returns the value list of property language. Empty list is returned if the property not set in
   * current object.
   */
  ImmutableList<SchemaOrgType> getLanguageList();

  /**
   * Returns the value list of property recipient. Empty list is returned if the property not set in
   * current object.
   */
  ImmutableList<SchemaOrgType> getRecipientList();
}
