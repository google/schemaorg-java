...
public interface MobileApplication extends SoftwareApplication {
  ...
  public interface Builder extends SoftwareApplication.Builder {
    ...
    /** Add a value to property carrierRequirements. */
    Builder addCarrierRequirements(Text value);

    /** Add a value to property carrierRequirements. */
    Builder addCarrierRequirements(String value);
    ...
    /** Build a {@link MobileApplication} object. */
    MobileApplication build();
  }

  /**
   * Returns the value list of property carrierRequirements. Empty list is returned if the property
   * not set in current object.
   */
  ImmutableList<SchemaOrgType> getCarrierRequirementsList();
}
