...
/** Interface of <a href="http://schema.org/Comment">http://schema.org/Comment</a>. */
public interface Comment extends CreativeWork {

  /** Builder interface of <a href="http://schema.org/Comment">http://schema.org/Comment</a>. */
  public interface Builder extends CreativeWork.Builder {
    ...
    /** Add a value to property parentItem. */
    Builder addParentItem(Question value);

    /** Add a value to property parentItem. */
    Builder addParentItem(Question.Builder value);

    /** Add a value to property parentItem. */
    Builder addParentItem(String value);
  ...
  /**
   * Returns the value list of property parentItem. Empty list is returned if the property not set
   * in current object.
   */
  ImmutableList<SchemaOrgType> getParentItemList();
