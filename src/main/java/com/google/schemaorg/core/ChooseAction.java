...
public interface ChooseAction extends AssessAction {
  ...
  public interface Builder extends AssessAction.Builder {
    ...
    /** Build a {@link ChooseAction} object. */
    ChooseAction build();
  }

  /**
   * Returns the value list of property actionOption. Empty list is returned if the property not set
   * in current object.
   */
  ImmutableList<SchemaOrgType> getActionOptionList();

  /**
   * Returns the value list of property option. Empty list is returned if the property not set in
   * current object.
   */
  ImmutableList<SchemaOrgType> getOptionList();
}
