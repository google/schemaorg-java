...
/*
 * Enum values of <a href="http://schema.org/MedicalDevicePurpose">http://schema.org/MedicalDevicePurpose</a>.
 */
public enum MedicalDevicePurposeEnum implements MedicalDevicePurpose {
  DIAGNOSTIC(CoreConstants.NAMESPACE + "Diagnostic"),

  THERAPEUTIC(CoreConstants.NAMESPACE + "Therapeutic");
  ...
  public String getFullTypeName() {
    return CoreConstants.TYPE_MEDICAL_DEVICE_PURPOSE;
  }
