...
/**
 * Interface of <a
 * href="http://schema.org/SportsOrganization">http://schema.org/SportsOrganization</a>.
 */
public interface SportsOrganization extends Organization {
  ...
  public interface Builder extends Organization.Builder {
    ...
    /** Build a {@link SportsOrganization} object. */
    SportsOrganization build();
  }

  /**
   * Returns the value list of property sport. Empty list is returned if the property not set in
   * current object.
   */
  ImmutableList<SchemaOrgType> getSportList();
}
