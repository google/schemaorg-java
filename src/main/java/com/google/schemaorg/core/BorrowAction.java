...
/** Interface of <a href="http://schema.org/BorrowAction">http://schema.org/BorrowAction</a>. */
public interface BorrowAction extends TransferAction {

  /**
   * Builder interface of <a
   * href="http://schema.org/BorrowAction">http://schema.org/BorrowAction</a>.
   */
  public interface Builder extends TransferAction.Builder {
    ...
    /** Add a value to property lender. */
    Builder addLender(Person value);

    /** Add a value to property lender. */
    Builder addLender(Person.Builder value);

    /** Add a value to property lender. */
    Builder addLender(String value);
    ...
    /** Build a {@link BorrowAction} object. */
    BorrowAction build();
  }

  /**
   * Returns the value list of property lender. Empty list is returned if the property not set in
   * current object.
   */
  ImmutableList<SchemaOrgType> getLenderList();
}
