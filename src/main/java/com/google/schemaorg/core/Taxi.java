...
/** Interface of <a href="http://schema.org/Taxi}">http://schema.org/Taxi}</a>. */
public interface Taxi extends Service {

  /** Builder interface of <a href="http://schema.org/Taxi}">http://schema.org/Taxi}</a>. */
