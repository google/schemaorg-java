...
/** Interface of <a href="http://schema.org/Dataset">http://schema.org/Dataset</a>. */
public interface Dataset extends CreativeWork {

  /** Builder interface of <a href="http://schema.org/Dataset">http://schema.org/Dataset</a>. */
  public interface Builder extends CreativeWork.Builder {
    ...
    /** Add a value to property catalog. */
    Builder addCatalog(DataCatalog value);

    /** Add a value to property catalog. */
    Builder addCatalog(DataCatalog.Builder value);

    /** Add a value to property catalog. */
    Builder addCatalog(String value);
    ...
    /** Add a value to property datasetTimeInterval. */
    Builder addDatasetTimeInterval(DateTime value);

    /** Add a value to property datasetTimeInterval. */
    Builder addDatasetTimeInterval(String value);
    ...
    /** Add a value to property distribution. */
    Builder addDistribution(DataDownload value);

    /** Add a value to property distribution. */
    Builder addDistribution(DataDownload.Builder value);

    /** Add a value to property distribution. */
    Builder addDistribution(String value);
    ...
    /** Add a value to property includedDataCatalog. */
    Builder addIncludedDataCatalog(DataCatalog value);

    /** Add a value to property includedDataCatalog. */
    Builder addIncludedDataCatalog(DataCatalog.Builder value);

    /** Add a value to property includedDataCatalog. */
    Builder addIncludedDataCatalog(String value);
    ...
    /** Add a value to property spatial. */
    Builder addSpatial(Place value);

    /** Add a value to property spatial. */
    Builder addSpatial(Place.Builder value);

    /** Add a value to property spatial. */
    Builder addSpatial(String value);

    /** Add a value to property temporal. */
    Builder addTemporal(DateTime value);

    /** Add a value to property temporal. */
    Builder addTemporal(String value);
    ...
    /** Build a {@link Dataset} object. */
    Dataset build();
  }

  /**
   * Returns the value list of property catalog. Empty list is returned if the property not set in
   * current object.
   */
  ImmutableList<SchemaOrgType> getCatalogList();

  /**
   * Returns the value list of property datasetTimeInterval. Empty list is returned if the property
   * not set in current object.
   */
  ImmutableList<SchemaOrgType> getDatasetTimeIntervalList();

  /**
   * Returns the value list of property distribution. Empty list is returned if the property not set
   * in current object.
   */
  ImmutableList<SchemaOrgType> getDistributionList();

  /**
   * Returns the value list of property includedDataCatalog. Empty list is returned if the property
   * not set in current object.
   */
  ImmutableList<SchemaOrgType> getIncludedDataCatalogList();

  /**
   * Returns the value list of property spatial. Empty list is returned if the property not set in
   * current object.
   */
  ImmutableList<SchemaOrgType> getSpatialList();

  /**
   * Returns the value list of property temporal. Empty list is returned if the property not set in
   * current object.
   */
  ImmutableList<SchemaOrgType> getTemporalList();
}
