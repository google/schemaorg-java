...
public interface MusicPlaylist extends CreativeWork {
  ...
  public interface Builder extends CreativeWork.Builder {
    ...
    /** Build a {@link MusicPlaylist} object. */
    MusicPlaylist build();
  }

  /**
   * Returns the value list of property numTracks. Empty list is returned if the property not set in
   * current object.
   */
  ImmutableList<SchemaOrgType> getNumTracksList();
