...
/** Interface of <a href="http://schema.org/MusicAlbum">http://schema.org/MusicAlbum</a>. */
public interface MusicAlbum extends MusicPlaylist {

  /**
   * Builder interface of <a href="http://schema.org/MusicAlbum">http://schema.org/MusicAlbum</a>.
   */
  public interface Builder extends MusicPlaylist.Builder {
    ...
    /** Add a value to property albumProductionType. */
    Builder addAlbumProductionType(MusicAlbumProductionType value);

    /** Add a value to property albumProductionType. */
    Builder addAlbumProductionType(String value);

    /** Add a value to property albumRelease. */
    Builder addAlbumRelease(MusicRelease value);

    /** Add a value to property albumRelease. */
    Builder addAlbumRelease(MusicRelease.Builder value);

    /** Add a value to property albumRelease. */
    Builder addAlbumRelease(String value);

    /** Add a value to property albumReleaseType. */
    Builder addAlbumReleaseType(MusicAlbumReleaseType value);

    /** Add a value to property albumReleaseType. */
    Builder addAlbumReleaseType(String value);
    ...
    /** Add a value to property byArtist. */
    Builder addByArtist(MusicGroup value);

    /** Add a value to property byArtist. */
    Builder addByArtist(MusicGroup.Builder value);

    /** Add a value to property byArtist. */
    Builder addByArtist(String value);
    ...
    /** Build a {@link MusicAlbum} object. */
    MusicAlbum build();
  }

  /**
   * Returns the value list of property albumProductionType. Empty list is returned if the property
   * not set in current object.
   */
  ImmutableList<SchemaOrgType> getAlbumProductionTypeList();

  /**
   * Returns the value list of property albumRelease. Empty list is returned if the property not set
   * in current object.
   */
  ImmutableList<SchemaOrgType> getAlbumReleaseList();

  /**
   * Returns the value list of property albumReleaseType. Empty list is returned if the property not
   * set in current object.
   */
  ImmutableList<SchemaOrgType> getAlbumReleaseTypeList();

  /**
   * Returns the value list of property byArtist. Empty list is returned if the property not set in
   * current object.
   */
  ImmutableList<SchemaOrgType> getByArtistList();
}
