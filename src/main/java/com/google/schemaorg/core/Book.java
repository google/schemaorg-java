...
/** Interface of <a href="http://schema.org/Book">http://schema.org/Book</a>. */
public interface Book extends CreativeWork {

  /** Builder interface of <a href="http://schema.org/Book">http://schema.org/Book</a>. */
  public interface Builder extends CreativeWork.Builder {
    ...
    /** Add a value to property bookEdition. */
    Builder addBookEdition(Text value);

    /** Add a value to property bookEdition. */
    Builder addBookEdition(String value);

    /** Add a value to property bookFormat. */
    Builder addBookFormat(BookFormatType value);

    /** Add a value to property bookFormat. */
    Builder addBookFormat(String value);
    ...
    /** Add a value to property illustrator. */
    Builder addIllustrator(Person value);

    /** Add a value to property illustrator. */
    Builder addIllustrator(Person.Builder value);

    /** Add a value to property illustrator. */
    Builder addIllustrator(String value);
    ...
    /** Add a value to property isbn. */
    Builder addIsbn(Text value);

    /** Add a value to property isbn. */
    Builder addIsbn(String value);
    ...
    /** Add a value to property numberOfPages. */
    Builder addNumberOfPages(Integer value);

    /** Add a value to property numberOfPages. */
    Builder addNumberOfPages(String value);
    ...
    /** Build a {@link Book} object. */
    Book build();
  }

  /**
   * Returns the value list of property bookEdition. Empty list is returned if the property not set
   * in current object.
   */
  ImmutableList<SchemaOrgType> getBookEditionList();

  /**
   * Returns the value list of property bookFormat. Empty list is returned if the property not set
   * in current object.
   */
  ImmutableList<SchemaOrgType> getBookFormatList();

  /**
   * Returns the value list of property illustrator. Empty list is returned if the property not set
   * in current object.
   */
  ImmutableList<SchemaOrgType> getIllustratorList();

  /**
   * Returns the value list of property isbn. Empty list is returned if the property not set in
   * current object.
   */
  ImmutableList<SchemaOrgType> getIsbnList();

  /**
   * Returns the value list of property numberOfPages. Empty list is returned if the property not
   * set in current object.
   */
  ImmutableList<SchemaOrgType> getNumberOfPagesList();
}
