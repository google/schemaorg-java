...
/** Interface of <a href="http://schema.org/FollowAction">http://schema.org/FollowAction</a>. */
public interface FollowAction extends InteractAction {

  /**
   * Builder interface of <a
   * href="http://schema.org/FollowAction">http://schema.org/FollowAction</a>.
   */
  public interface Builder extends InteractAction.Builder {
    ...
    /** Add a value to property followee. */
    Builder addFollowee(Organization value);

    /** Add a value to property followee. */
    Builder addFollowee(Organization.Builder value);

    /** Add a value to property followee. */
    Builder addFollowee(Person value);

    /** Add a value to property followee. */
    Builder addFollowee(Person.Builder value);

    /** Add a value to property followee. */
    Builder addFollowee(String value);
    ...
    /** Build a {@link FollowAction} object. */
    FollowAction build();
  }

  /**
   * Returns the value list of property followee. Empty list is returned if the property not set in
   * current object.
   */
  ImmutableList<SchemaOrgType> getFolloweeList();
}
