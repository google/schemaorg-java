...
/*
 * Enum values of <a href="http://schema.org/MusicReleaseFormatType">http://schema.org/MusicReleaseFormatType</a>.
 */
public enum MusicReleaseFormatTypeEnum implements MusicReleaseFormatType {
  CD_FORMAT(CoreConstants.NAMESPACE + "CDFormat"),

  CASSETTE_FORMAT(CoreConstants.NAMESPACE + "CassetteFormat"),

  DVD_FORMAT(CoreConstants.NAMESPACE + "DVDFormat"),

  DIGITAL_AUDIO_TAPE_FORMAT(CoreConstants.NAMESPACE + "DigitalAudioTapeFormat"),

  DIGITAL_FORMAT(CoreConstants.NAMESPACE + "DigitalFormat"),

  LASER_DISC_FORMAT(CoreConstants.NAMESPACE + "LaserDiscFormat"),

  VINYL_FORMAT(CoreConstants.NAMESPACE + "VinylFormat");
  ...
  public String getFullTypeName() {
    return CoreConstants.TYPE_MUSIC_RELEASE_FORMAT_TYPE;
  }
