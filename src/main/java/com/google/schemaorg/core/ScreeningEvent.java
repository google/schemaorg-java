...
public interface ScreeningEvent extends Event {
  ...
  public interface Builder extends Event.Builder {
    ...
    /** Add a value to property workPresented. */
    Builder addWorkPresented(Movie value);

    /** Add a value to property workPresented. */
    Builder addWorkPresented(Movie.Builder value);

    /** Add a value to property workPresented. */
    Builder addWorkPresented(String value);
    ...
    /** Build a {@link ScreeningEvent} object. */
    ScreeningEvent build();
  }
  ...
  /**
   * Returns the value list of property workPresented. Empty list is returned if the property not
   * set in current object.
   */
  ImmutableList<SchemaOrgType> getWorkPresentedList();
}
