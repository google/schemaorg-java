...
/** Interface of <a href="http://schema.org/DataFeed">http://schema.org/DataFeed</a>. */
public interface DataFeed extends Dataset {

  /** Builder interface of <a href="http://schema.org/DataFeed">http://schema.org/DataFeed</a>. */
  public interface Builder extends Dataset.Builder {
    ...
    /** Add a value to property dataFeedElement. */
    Builder addDataFeedElement(DataFeedItem value);

    /** Add a value to property dataFeedElement. */
    Builder addDataFeedElement(DataFeedItem.Builder value);

    /** Add a value to property dataFeedElement. */
    Builder addDataFeedElement(Text value);

    /** Add a value to property dataFeedElement. */
    Builder addDataFeedElement(Thing value);

    /** Add a value to property dataFeedElement. */
    Builder addDataFeedElement(Thing.Builder value);

    /** Add a value to property dataFeedElement. */
    Builder addDataFeedElement(String value);
    ...
    /** Build a {@link DataFeed} object. */
    DataFeed build();
  }

  /**
   * Returns the value list of property dataFeedElement. Empty list is returned if the property not
   * set in current object.
   */
  ImmutableList<SchemaOrgType> getDataFeedElementList();
}
