...
/**
 * Interface of <a
 * href="http://schema.org/MedicalRiskFactor">http://schema.org/MedicalRiskFactor</a>.
 */
public interface MedicalRiskFactor extends MedicalEntity {
  ...
  public interface Builder extends MedicalEntity.Builder {
    ...
    /** Add a value to property increasesRiskOf. */
    Builder addIncreasesRiskOf(MedicalEntity value);

    /** Add a value to property increasesRiskOf. */
    Builder addIncreasesRiskOf(MedicalEntity.Builder value);

    /** Add a value to property increasesRiskOf. */
    Builder addIncreasesRiskOf(String value);
    ...
    /** Build a {@link MedicalRiskFactor} object. */
    MedicalRiskFactor build();
  }

  /**
   * Returns the value list of property increasesRiskOf. Empty list is returned if the property not
   * set in current object.
   */
  ImmutableList<SchemaOrgType> getIncreasesRiskOfList();
}
