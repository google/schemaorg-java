...
/** Interface of <a href="http://schema.org/Action">http://schema.org/Action</a>. */
public interface Action extends Thing {

  /** Builder interface of <a href="http://schema.org/Action">http://schema.org/Action</a>. */
  public interface Builder extends Thing.Builder {
    ...
    /** Build a {@link Action} object. */
    Action build();
  }

  /**
   * Returns the value list of property actionStatus. Empty list is returned if the property not set
   * in current object.
   */
  ImmutableList<SchemaOrgType> getActionStatusList();

  /**
   * Returns the value list of property agent. Empty list is returned if the property not set in
   * current object.
   */
  ImmutableList<SchemaOrgType> getAgentList();

  /**
   * Returns the value list of property endTime. Empty list is returned if the property not set in
   * current object.
   */
  ImmutableList<SchemaOrgType> getEndTimeList();

  /**
   * Returns the value list of property error. Empty list is returned if the property not set in
   * current object.
   */
  ImmutableList<SchemaOrgType> getErrorList();

  /**
   * Returns the value list of property instrument. Empty list is returned if the property not set
   * in current object.
   */
  ImmutableList<SchemaOrgType> getInstrumentList();
  ...
  /**
   * Returns the value list of property object. Empty list is returned if the property not set in
   * current object.
   */
  ImmutableList<SchemaOrgType> getObjectList();
   ...
   * current object.
   */
  ImmutableList<SchemaOrgType> getResultList();

  /**
   * Returns the value list of property startTime. Empty list is returned if the property not set in
   * current object.
   */
  ImmutableList<SchemaOrgType> getStartTimeList();

  /**
   * Returns the value list of property target. Empty list is returned if the property not set in
   * current object.
   */
  ImmutableList<SchemaOrgType> getTargetList();
}
