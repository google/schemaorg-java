...
/** Interface of <a href="http://schema.org/FindAction">http://schema.org/FindAction</a>. */
public interface FindAction extends Action {

  /**
   * Builder interface of <a href="http://schema.org/FindAction">http://schema.org/FindAction</a>.
   */
  public interface Builder extends Action.Builder {
    ...
    /** Build a {@link FindAction} object. */
    FindAction build();
  }
}
