...
public interface WinAction extends AchieveAction {
  ...
  public interface Builder extends AchieveAction.Builder {
    ...
    /** Add a value to property loser. */
    Builder addLoser(Person value);

    /** Add a value to property loser. */
    Builder addLoser(Person.Builder value);

    /** Add a value to property loser. */
    Builder addLoser(String value);
    ...
    /** Build a {@link WinAction} object. */
    WinAction build();
  }

  /**
   * Returns the value list of property loser. Empty list is returned if the property not set in
   * current object.
   */
  ImmutableList<SchemaOrgType> getLoserList();
}
