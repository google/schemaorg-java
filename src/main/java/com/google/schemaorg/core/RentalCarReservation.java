...
/**
 * Interface of <a
 * href="http://schema.org/RentalCarReservation">http://schema.org/RentalCarReservation</a>.
 */
public interface RentalCarReservation extends Reservation {
  ...
  public interface Builder extends Reservation.Builder {
    ...
    /** Add a value to property dropoffLocation. */
    Builder addDropoffLocation(Place value);

    /** Add a value to property dropoffLocation. */
    Builder addDropoffLocation(Place.Builder value);

    /** Add a value to property dropoffLocation. */
    Builder addDropoffLocation(String value);

    /** Add a value to property dropoffTime. */
    Builder addDropoffTime(DateTime value);

    /** Add a value to property dropoffTime. */
    Builder addDropoffTime(String value);
    ...
    /** Add a value to property pickupLocation. */
    Builder addPickupLocation(Place value);

    /** Add a value to property pickupLocation. */
    Builder addPickupLocation(Place.Builder value);

    /** Add a value to property pickupLocation. */
    Builder addPickupLocation(String value);

    /** Add a value to property pickupTime. */
    Builder addPickupTime(DateTime value);

    /** Add a value to property pickupTime. */
    Builder addPickupTime(String value);
    ...
    /** Build a {@link RentalCarReservation} object. */
    RentalCarReservation build();
  }

  /**
   * Returns the value list of property dropoffLocation. Empty list is returned if the property not
   * set in current object.
   */
  ImmutableList<SchemaOrgType> getDropoffLocationList();

  /**
   * Returns the value list of property dropoffTime. Empty list is returned if the property not set
   * in current object.
   */
  ImmutableList<SchemaOrgType> getDropoffTimeList();

  /**
   * Returns the value list of property pickupLocation. Empty list is returned if the property not
   * set in current object.
   */
  ImmutableList<SchemaOrgType> getPickupLocationList();

  /**
   * Returns the value list of property pickupTime. Empty list is returned if the property not set
   * in current object.
   */
  ImmutableList<SchemaOrgType> getPickupTimeList();
}
