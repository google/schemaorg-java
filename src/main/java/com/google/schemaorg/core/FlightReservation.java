...
/**
 * Interface of <a
 * href="http://schema.org/FlightReservation">http://schema.org/FlightReservation</a>.
 */
public interface FlightReservation extends Reservation {
  ...
  public interface Builder extends Reservation.Builder {
    ...
    /** Add a value to property boardingGroup. */
    Builder addBoardingGroup(Text value);

    /** Add a value to property boardingGroup. */
    Builder addBoardingGroup(String value);
    ...
    /** Add a value to property passengerPriorityStatus. */
    Builder addPassengerPriorityStatus(QualitativeValue value);

    /** Add a value to property passengerPriorityStatus. */
    Builder addPassengerPriorityStatus(Text value);

    /** Add a value to property passengerPriorityStatus. */
    Builder addPassengerPriorityStatus(String value);

    /** Add a value to property passengerSequenceNumber. */
    Builder addPassengerSequenceNumber(Text value);

    /** Add a value to property passengerSequenceNumber. */
    Builder addPassengerSequenceNumber(String value);
    ...
    /** Add a value to property securityScreening. */
    Builder addSecurityScreening(Text value);

    /** Add a value to property securityScreening. */
    Builder addSecurityScreening(String value);
    ...
    /** Build a {@link FlightReservation} object. */
    FlightReservation build();
  }

  /**
   * Returns the value list of property boardingGroup. Empty list is returned if the property not
   * set in current object.
   */
  ImmutableList<SchemaOrgType> getBoardingGroupList();

  /**
   * Returns the value list of property passengerPriorityStatus. Empty list is returned if the
   * property not set in current object.
   */
  ImmutableList<SchemaOrgType> getPassengerPriorityStatusList();

  /**
   * Returns the value list of property passengerSequenceNumber. Empty list is returned if the
   * property not set in current object.
   */
  ImmutableList<SchemaOrgType> getPassengerSequenceNumberList();

  /**
   * Returns the value list of property securityScreening. Empty list is returned if the property
   * not set in current object.
   */
  ImmutableList<SchemaOrgType> getSecurityScreeningList();
}
