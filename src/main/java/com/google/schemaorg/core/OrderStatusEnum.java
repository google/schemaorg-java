...
/*
 * Enum values of <a href="http://schema.org/OrderStatus">http://schema.org/OrderStatus</a>.
 */
public enum OrderStatusEnum implements OrderStatus {
  ORDER_CANCELLED(CoreConstants.NAMESPACE + "OrderCancelled"),

  ORDER_DELIVERED(CoreConstants.NAMESPACE + "OrderDelivered"),

  ORDER_IN_TRANSIT(CoreConstants.NAMESPACE + "OrderInTransit"),

  ORDER_PAYMENT_DUE(CoreConstants.NAMESPACE + "OrderPaymentDue"),

  ORDER_PICKUP_AVAILABLE(CoreConstants.NAMESPACE + "OrderPickupAvailable"),

  ORDER_PROBLEM(CoreConstants.NAMESPACE + "OrderProblem"),

  ORDER_PROCESSING(CoreConstants.NAMESPACE + "OrderProcessing"),

  ORDER_RETURNED(CoreConstants.NAMESPACE + "OrderReturned");
  ...
  public String getFullTypeName() {
    return CoreConstants.TYPE_ORDER_STATUS;
  }
