...
/**
 * Interface of <a href="http://schema.org/BroadcastEvent">http://schema.org/BroadcastEvent</a>.
 */
public interface BroadcastEvent extends PublicationEvent {

  /**
   * Builder interface of <a
   * href="http://schema.org/BroadcastEvent">http://schema.org/BroadcastEvent</a>.
   */
  public interface Builder extends PublicationEvent.Builder {
    ...
    /** Add a value to property broadcastOfEvent. */
    Builder addBroadcastOfEvent(Event value);

    /** Add a value to property broadcastOfEvent. */
    Builder addBroadcastOfEvent(Event.Builder value);

    /** Add a value to property broadcastOfEvent. */
    Builder addBroadcastOfEvent(String value);
    ...
    /** Add a value to property free. */
    Builder addFree(Boolean value);

    /** Add a value to property free. */
    Builder addFree(String value);
    ...
    /** Add a value to property isAccessibleForFree. */
    Builder addIsAccessibleForFree(Boolean value);

    /** Add a value to property isAccessibleForFree. */
    Builder addIsAccessibleForFree(String value);

    /** Add a value to property isLiveBroadcast. */
    Builder addIsLiveBroadcast(Boolean value);

    /** Add a value to property isLiveBroadcast. */
    Builder addIsLiveBroadcast(String value);
    ...
    /** Add a value to property publishedOn. */
    Builder addPublishedOn(BroadcastService value);

    /** Add a value to property publishedOn. */
    Builder addPublishedOn(BroadcastService.Builder value);

    /** Add a value to property publishedOn. */
    Builder addPublishedOn(String value);
    ...
    /** Build a {@link BroadcastEvent} object. */
    BroadcastEvent build();
  }

  /**
   * Returns the value list of property broadcastOfEvent. Empty list is returned if the property not
   * set in current object.
   */
  ImmutableList<SchemaOrgType> getBroadcastOfEventList();

  /**
   * Returns the value list of property isLiveBroadcast. Empty list is returned if the property not
   * set in current object.
   */
  ImmutableList<SchemaOrgType> getIsLiveBroadcastList();
