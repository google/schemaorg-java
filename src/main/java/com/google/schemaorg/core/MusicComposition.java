...
/**
 * Interface of <a
 * href="http://schema.org/MusicComposition">http://schema.org/MusicComposition</a>.
 */
public interface MusicComposition extends CreativeWork {
  ...
  public interface Builder extends CreativeWork.Builder {
    ...
    /** Add a value to property composer. */
    Builder addComposer(Organization value);

    /** Add a value to property composer. */
    Builder addComposer(Organization.Builder value);

    /** Add a value to property composer. */
    Builder addComposer(Person value);

    /** Add a value to property composer. */
    Builder addComposer(Person.Builder value);

    /** Add a value to property composer. */
    Builder addComposer(String value);
    ...
    /** Add a value to property firstPerformance. */
    Builder addFirstPerformance(Event value);

    /** Add a value to property firstPerformance. */
    Builder addFirstPerformance(Event.Builder value);

    /** Add a value to property firstPerformance. */
    Builder addFirstPerformance(String value);
    ...
    /** Add a value to property includedComposition. */
    Builder addIncludedComposition(MusicComposition value);

    /** Add a value to property includedComposition. */
    Builder addIncludedComposition(MusicComposition.Builder value);

    /** Add a value to property includedComposition. */
    Builder addIncludedComposition(String value);
    ...
    /** Add a value to property iswcCode. */
    Builder addIswcCode(Text value);

    /** Add a value to property iswcCode. */
    Builder addIswcCode(String value);
    ...
    /** Add a value to property lyricist. */
    Builder addLyricist(Person value);

    /** Add a value to property lyricist. */
    Builder addLyricist(Person.Builder value);

    /** Add a value to property lyricist. */
    Builder addLyricist(String value);

    /** Add a value to property lyrics. */
    Builder addLyrics(CreativeWork value);

    /** Add a value to property lyrics. */
    Builder addLyrics(CreativeWork.Builder value);

    /** Add a value to property lyrics. */
    Builder addLyrics(String value);
    ...
    /** Add a value to property musicalKey. */
    Builder addMusicalKey(Text value);

    /** Add a value to property musicalKey. */
    Builder addMusicalKey(String value);

    /** Add a value to property musicArrangement. */
    Builder addMusicArrangement(MusicComposition value);

    /** Add a value to property musicArrangement. */
    Builder addMusicArrangement(MusicComposition.Builder value);

    /** Add a value to property musicArrangement. */
    Builder addMusicArrangement(String value);

    /** Add a value to property musicCompositionForm. */
    Builder addMusicCompositionForm(Text value);

    /** Add a value to property musicCompositionForm. */
    Builder addMusicCompositionForm(String value);
    ...
    /** Add a value to property recordedAs. */
    Builder addRecordedAs(MusicRecording value);

    /** Add a value to property recordedAs. */
    Builder addRecordedAs(MusicRecording.Builder value);

    /** Add a value to property recordedAs. */
    Builder addRecordedAs(String value);
    ...
    /** Build a {@link MusicComposition} object. */
    MusicComposition build();
  }

  /**
   * Returns the value list of property composer. Empty list is returned if the property not set in
   * current object.
   */
  ImmutableList<SchemaOrgType> getComposerList();

  /**
   * Returns the value list of property firstPerformance. Empty list is returned if the property not
   * set in current object.
   */
  ImmutableList<SchemaOrgType> getFirstPerformanceList();

  /**
   * Returns the value list of property includedComposition. Empty list is returned if the property
   * not set in current object.
   */
  ImmutableList<SchemaOrgType> getIncludedCompositionList();

  /**
   * Returns the value list of property iswcCode. Empty list is returned if the property not set in
   * current object.
   */
  ImmutableList<SchemaOrgType> getIswcCodeList();

  /**
   * Returns the value list of property lyricist. Empty list is returned if the property not set in
   * current object.
   */
  ImmutableList<SchemaOrgType> getLyricistList();

  /**
   * Returns the value list of property lyrics. Empty list is returned if the property not set in
   * current object.
   */
  ImmutableList<SchemaOrgType> getLyricsList();

  /**
   * Returns the value list of property musicalKey. Empty list is returned if the property not set
   * in current object.
   */
  ImmutableList<SchemaOrgType> getMusicalKeyList();

  /**
   * Returns the value list of property musicArrangement. Empty list is returned if the property not
   * set in current object.
   */
  ImmutableList<SchemaOrgType> getMusicArrangementList();

  /**
   * Returns the value list of property musicCompositionForm. Empty list is returned if the property
   * not set in current object.
   */
  ImmutableList<SchemaOrgType> getMusicCompositionFormList();

  /**
   * Returns the value list of property recordedAs. Empty list is returned if the property not set
   * in current object.
   */
  ImmutableList<SchemaOrgType> getRecordedAsList();
}
