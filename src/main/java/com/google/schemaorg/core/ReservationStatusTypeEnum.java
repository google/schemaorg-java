...
/*
 * Enum values of <a href="http://schema.org/ReservationStatusType">http://schema.org/ReservationStatusType</a>.
 */
public enum ReservationStatusTypeEnum implements ReservationStatusType {
  RESERVATION_CANCELLED(CoreConstants.NAMESPACE + "ReservationCancelled"),

  RESERVATION_CONFIRMED(CoreConstants.NAMESPACE + "ReservationConfirmed"),

  RESERVATION_HOLD(CoreConstants.NAMESPACE + "ReservationHold"),

  RESERVATION_PENDING(CoreConstants.NAMESPACE + "ReservationPending");
  ...
  public String getFullTypeName() {
    return CoreConstants.TYPE_RESERVATION_STATUS_TYPE;
  }
