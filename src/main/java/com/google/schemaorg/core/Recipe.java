...
public interface Recipe extends CreativeWork {
  ...
  public interface Builder extends CreativeWork.Builder {
    ...
    /** Add a value to property cookingMethod. */
    Builder addCookingMethod(Text value);

    /** Add a value to property cookingMethod. */
    Builder addCookingMethod(String value);

    /** Add a value to property cookTime. */
    Builder addCookTime(Duration value);

    /** Add a value to property cookTime. */
    Builder addCookTime(Duration.Builder value);

    /** Add a value to property cookTime. */
    Builder addCookTime(String value);
    ...
    /** Add a value to property ingredients. */
    Builder addIngredients(Text value);

    /** Add a value to property ingredients. */
    Builder addIngredients(String value);
    ...
    /** Add a value to property nutrition. */
    Builder addNutrition(NutritionInformation value);

    /** Add a value to property nutrition. */
    Builder addNutrition(NutritionInformation.Builder value);

    /** Add a value to property nutrition. */
    Builder addNutrition(String value);
    ...
    /** Add a value to property prepTime. */
    Builder addPrepTime(Duration value);

    /** Add a value to property prepTime. */
    Builder addPrepTime(Duration.Builder value);

    /** Add a value to property prepTime. */
    Builder addPrepTime(String value);
    ...
    /** Add a value to property recipeCategory. */
    Builder addRecipeCategory(Text value);

    /** Add a value to property recipeCategory. */
    Builder addRecipeCategory(String value);

    /** Add a value to property recipeCuisine. */
    Builder addRecipeCuisine(Text value);

    /** Add a value to property recipeCuisine. */
    Builder addRecipeCuisine(String value);

    /** Add a value to property recipeIngredient. */
    Builder addRecipeIngredient(Text value);

    /** Add a value to property recipeIngredient. */
    Builder addRecipeIngredient(String value);

    /** Add a value to property recipeInstructions. */
    Builder addRecipeInstructions(ItemList value);

    /** Add a value to property recipeInstructions. */
    Builder addRecipeInstructions(ItemList.Builder value);

    /** Add a value to property recipeInstructions. */
    Builder addRecipeInstructions(Text value);

    /** Add a value to property recipeInstructions. */
    Builder addRecipeInstructions(String value);

    /** Add a value to property recipeYield. */
    Builder addRecipeYield(Text value);

    /** Add a value to property recipeYield. */
    Builder addRecipeYield(String value);
    ...
    /** Add a value to property totalTime. */
    Builder addTotalTime(Duration value);

    /** Add a value to property totalTime. */
    Builder addTotalTime(Duration.Builder value);

    /** Add a value to property totalTime. */
    Builder addTotalTime(String value);
    ...
    /** Build a {@link Recipe} object. */
    Recipe build();
  }

  /**
   * Returns the value list of property cookingMethod. Empty list is returned if the property not
   * set in current object.
   */
  ImmutableList<SchemaOrgType> getCookingMethodList();

  /**
   * Returns the value list of property cookTime. Empty list is returned if the property not set in
   * current object.
   */
  ImmutableList<SchemaOrgType> getCookTimeList();

  /**
   * Returns the value list of property ingredients. Empty list is returned if the property not set
   * in current object.
   */
  ImmutableList<SchemaOrgType> getIngredientsList();

  /**
   * Returns the value list of property nutrition. Empty list is returned if the property not set in
   * current object.
   */
  ImmutableList<SchemaOrgType> getNutritionList();

  /**
   * Returns the value list of property prepTime. Empty list is returned if the property not set in
   * current object.
   */
  ImmutableList<SchemaOrgType> getPrepTimeList();

  /**
   * Returns the value list of property recipeCategory. Empty list is returned if the property not
   * set in current object.
   */
  ImmutableList<SchemaOrgType> getRecipeCategoryList();

  /**
   * Returns the value list of property recipeCuisine. Empty list is returned if the property not
   * set in current object.
   */
  ImmutableList<SchemaOrgType> getRecipeCuisineList();

  /**
   * Returns the value list of property recipeIngredient. Empty list is returned if the property not
   * set in current object.
   */
  ImmutableList<SchemaOrgType> getRecipeIngredientList();

  /**
   * Returns the value list of property recipeInstructions. Empty list is returned if the property
   * not set in current object.
   */
  ImmutableList<SchemaOrgType> getRecipeInstructionsList();

  /**
   * Returns the value list of property recipeYield. Empty list is returned if the property not set
   * in current object.
   */
  ImmutableList<SchemaOrgType> getRecipeYieldList();

  /**
   * Returns the value list of property totalTime. Empty list is returned if the property not set in
   * current object.
   */
