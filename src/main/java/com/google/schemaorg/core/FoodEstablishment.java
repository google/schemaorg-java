...
/**
 * Interface of <a
 * href="http://schema.org/FoodEstablishment">http://schema.org/FoodEstablishment</a>.
 */
public interface FoodEstablishment extends LocalBusiness {
  ...
  public interface Builder extends LocalBusiness.Builder {
    ...
    /** Add a value to property acceptsReservations. */
    Builder addAcceptsReservations(Boolean value);

    /** Add a value to property acceptsReservations. */
    Builder addAcceptsReservations(Text value);

    /** Add a value to property acceptsReservations. */
    Builder addAcceptsReservations(URL value);

    /** Add a value to property acceptsReservations. */
    Builder addAcceptsReservations(String value);
    ...
    /** Add a value to property menu. */
    Builder addMenu(Text value);

    /** Add a value to property menu. */
    Builder addMenu(URL value);

    /** Add a value to property menu. */
    Builder addMenu(String value);
    ...
    /** Add a value to property servesCuisine. */
    Builder addServesCuisine(Text value);

    /** Add a value to property servesCuisine. */
    Builder addServesCuisine(String value);
    ...
    /** Build a {@link FoodEstablishment} object. */
    FoodEstablishment build();
  }

  /**
   * Returns the value list of property acceptsReservations. Empty list is returned if the property
   * not set in current object.
   */
  ImmutableList<SchemaOrgType> getAcceptsReservationsList();

  /**
   * Returns the value list of property menu. Empty list is returned if the property not set in
   * current object.
   */
  ImmutableList<SchemaOrgType> getMenuList();

  /**
   * Returns the value list of property servesCuisine. Empty list is returned if the property not
   * set in current object.
   */
  ImmutableList<SchemaOrgType> getServesCuisineList();
}
