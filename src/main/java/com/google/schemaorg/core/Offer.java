...
public interface Offer extends Intangible {
  ...
  /**
   * Returns the value list of property addOn. Empty list is returned if the property not set in
   * current object.
   */
  ImmutableList<SchemaOrgType> getAddOnList();
  ...
  /**
   * Returns the value list of property offeredBy. Empty list is returned if the property not set in
   * current object.
   */
  ImmutableList<SchemaOrgType> getOfferedByList();
  ...
  /**
   * Returns the value list of property priceValidUntil. Empty list is returned if the property not
   * set in current object.
   */
  ImmutableList<SchemaOrgType> getPriceValidUntilList();
