...
/** Interface of <a href="http://schema.org/Vehicle">http://schema.org/Vehicle</a>. */
public interface Vehicle extends Product {

  /** Builder interface of <a href="http://schema.org/Vehicle">http://schema.org/Vehicle</a>. */
  public interface Builder extends Product.Builder {
    ...
    /** Build a {@link Vehicle} object. */
    Vehicle build();
  }

  /**
   * Returns the value list of property cargoVolume. Empty list is returned if the property not set
   * in current object.
   */
  ImmutableList<SchemaOrgType> getCargoVolumeList();

  /**
   * Returns the value list of property dateVehicleFirstRegistered. Empty list is returned if the
   * property not set in current object.
   */
  ImmutableList<SchemaOrgType> getDateVehicleFirstRegisteredList();

  /**
   * Returns the value list of property driveWheelConfiguration. Empty list is returned if the
   * property not set in current object.
   */
  ImmutableList<SchemaOrgType> getDriveWheelConfigurationList();

  /**
   * Returns the value list of property fuelConsumption. Empty list is returned if the property not
   * set in current object.
   */
  ImmutableList<SchemaOrgType> getFuelConsumptionList();

  /**
   * Returns the value list of property fuelEfficiency. Empty list is returned if the property not
   * set in current object.
   */
  ImmutableList<SchemaOrgType> getFuelEfficiencyList();

  /**
   * Returns the value list of property fuelType. Empty list is returned if the property not set in
   * current object.
   */
  ImmutableList<SchemaOrgType> getFuelTypeList();

  /**
   * Returns the value list of property knownVehicleDamages. Empty list is returned if the property
   * not set in current object.
   */
  ImmutableList<SchemaOrgType> getKnownVehicleDamagesList();

  /**
   * Returns the value list of property mileageFromOdometer. Empty list is returned if the property
   * not set in current object.
   */
  ImmutableList<SchemaOrgType> getMileageFromOdometerList();

  /**
   * Returns the value list of property numberOfAirbags. Empty list is returned if the property not
   * set in current object.
   */
  ImmutableList<SchemaOrgType> getNumberOfAirbagsList();

  /**
   * Returns the value list of property numberOfAxles. Empty list is returned if the property not
   * set in current object.
   */
  ImmutableList<SchemaOrgType> getNumberOfAxlesList();

  /**
   * Returns the value list of property numberOfDoors. Empty list is returned if the property not
   * set in current object.
   */
  ImmutableList<SchemaOrgType> getNumberOfDoorsList();

  /**
   * Returns the value list of property numberOfForwardGears. Empty list is returned if the property
   * not set in current object.
   */
  ImmutableList<SchemaOrgType> getNumberOfForwardGearsList();

  /**
   * Returns the value list of property numberOfPreviousOwners. Empty list is returned if the
   * property not set in current object.
   */
  ImmutableList<SchemaOrgType> getNumberOfPreviousOwnersList();
  ...
  /**
   * Returns the value list of property steeringPosition. Empty list is returned if the property not
   * set in current object.
   */
  ImmutableList<SchemaOrgType> getSteeringPositionList();

  /**
   * Returns the value list of property vehicleConfiguration. Empty list is returned if the property
   * not set in current object.
   */
  ImmutableList<SchemaOrgType> getVehicleConfigurationList();

  /**
   * Returns the value list of property vehicleEngine. Empty list is returned if the property not
   * set in current object.
   */
  ImmutableList<SchemaOrgType> getVehicleEngineList();

  /**
   * Returns the value list of property vehicleIdentificationNumber. Empty list is returned if the
   * property not set in current object.
   */
  ImmutableList<SchemaOrgType> getVehicleIdentificationNumberList();

  /**
   * Returns the value list of property vehicleInteriorColor. Empty list is returned if the property
   * not set in current object.
   */
  ImmutableList<SchemaOrgType> getVehicleInteriorColorList();

  /**
   * Returns the value list of property vehicleInteriorType. Empty list is returned if the property
   * not set in current object.
   */
  ImmutableList<SchemaOrgType> getVehicleInteriorTypeList();

  /**
   * Returns the value list of property vehicleModelDate. Empty list is returned if the property not
   * set in current object.
   */
  ImmutableList<SchemaOrgType> getVehicleModelDateList();

  /**
   * Returns the value list of property vehicleSeatingCapacity. Empty list is returned if the
   * property not set in current object.
   */
  ImmutableList<SchemaOrgType> getVehicleSeatingCapacityList();

  /**
   * Returns the value list of property vehicleTransmission. Empty list is returned if the property
   * not set in current object.
   */
  ImmutableList<SchemaOrgType> getVehicleTransmissionList();
}
