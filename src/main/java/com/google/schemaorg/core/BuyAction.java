...
/** Interface of <a href="http://schema.org/BuyAction">http://schema.org/BuyAction</a>. */
public interface BuyAction extends TradeAction {

  /**
   * Builder interface of <a href="http://schema.org/BuyAction">http://schema.org/BuyAction</a>.
   */
  public interface Builder extends TradeAction.Builder {
    ...
    /** Add a value to property vendor. */
    Builder addVendor(Organization value);

    /** Add a value to property vendor. */
    Builder addVendor(Organization.Builder value);

    /** Add a value to property vendor. */
    Builder addVendor(Person value);

    /** Add a value to property vendor. */
    Builder addVendor(Person.Builder value);

    /** Add a value to property vendor. */
    Builder addVendor(String value);

    /** Add a value to property warrantyPromise. */
    Builder addWarrantyPromise(WarrantyPromise value);

    /** Add a value to property warrantyPromise. */
    Builder addWarrantyPromise(WarrantyPromise.Builder value);

    /** Add a value to property warrantyPromise. */
    Builder addWarrantyPromise(String value);
  ...
  /**
   * Returns the value list of property vendor. Empty list is returned if the property not set in
   * current object.
   */
  ImmutableList<SchemaOrgType> getVendorList();

  /**
   * Returns the value list of property warrantyPromise. Empty list is returned if the property not
   * set in current object.
   */
  ImmutableList<SchemaOrgType> getWarrantyPromiseList();
}
